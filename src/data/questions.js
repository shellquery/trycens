...
,
{
  ...
  zh:{q:'单条道路上有两个相反方向箭头（一上一下）的标志意味着什么？',opts:['只有单向交通','双向交通——车辆在此路上双向行驶','前方开始分隔公路','此路有单独的卡车上坡和下坡车道'],exp:'双向交通标志（显示两个相反方向的箭头）警告驾驶员离开单行道时将进入双向道路。驾驶员必须准备与对向交通共享道路。靠右行驶，注意迎面而来的车辆。'},
  zhTW:{q:'單條道路上有兩個相反方向箭頭（一上一下）的標誌意味著什麼？',opts:['只有單向交通','雙向交通——車輛在此路上雙向行駛','前方開始分隔公路','此路有單獨的卡車上坡和下坡車道'],exp:'雙向交通標誌（顯示兩個相反方向的箭頭）警告駕駛員離開單行道時將進入雙向道路。駕駛員必須準備與對向交通共享道路。靠右行駛，注意迎面而來的車輛。'},
  es:{q:'¿Qué significa un letrero con dos flechas apuntando en direcciones opuestas (una arriba, una abajo) en una sola carretera?',opts:['Solo tráfico de un sentido','Tráfico de dos sentidos — los vehículos viajan en ambas direcciones en esta carretera','Comienza autopista dividida adelante','Esta carretera tiene carriles separados de subida y bajada para camiones'],exp:'Un letrero de tráfico en dos sentidos (mostrando dos flechas en direcciones opuestas) advierte a los conductores que salen de una carretera de un solo sentido que están entrando a una carretera de dos sentidos. Los conductores deben estar preparados para compartir la carretera con el tráfico en sentido contrario. Manténgase en el carril derecho y observe los vehículos que se acercan.'},
  ans:1
},
{
  id:502, cat:'laws',
  en:{q:'In California, what is required before a vehicle can be legally sold or transferred?',opts:['Only a bill of sale is needed','The seller must complete a Notice of Transfer and Release of Liability (NRL) with the DMV within 5 days of the sale','The new owner has 60 days to register the vehicle with no penalty','The license plates automatically transfer to the new owner'],exp:'When you sell or transfer a vehicle in California, you must complete a Notice of Transfer and Release of Liability (NRL) with the DMV within 5 days. This protects you from liability if the new owner gets tickets or is involved in an accident before re-registering the vehicle. The NRL can be submitted online at the DMV website. Failure to file can result in you being held responsible for the vehicle\'s activities after the sale.'},
  zh:{q:'在加州，车辆合法出售或转让前需要什么？',opts:['只需要一张销售凭证','卖方必须在出售后5天内向DMV完成转让和责任解除通知（NRL）','新车主有60天时间注册车辆，无罚款','车牌自动转移给新车主'],exp:'在加州出售或转让车辆时，你必须在5天内向DMV提交转让和责任解除通知（NRL）。这可以保护你免于在新车主重新注册车辆前因其违规或事故而承担责任。NRL可在DMV网站在线提交。未能申报可能导致你在出售后仍对车辆的行为负责。'},
  zhTW:{q:'在加州，車輛合法出售或轉讓前需要什麼？',opts:['只需要一張銷售憑證','賣方必須在出售後5天內向DMV完成轉讓和責任解除通知（NRL）','新車主有60天時間註冊車輛，無罰款','車牌自動轉移給新車主'],exp:'在加州出售或轉讓車輛時，你必須在5天內向DMV提交轉讓和責任解除通知（NRL）。這可以保護你免於在新車主重新註冊車輛前因其違規或事故而承擔責任。NRL可在DMV網站在線提交。未能申報可能導致你在出售後仍對車輛的行為負責。'},
  es:{q:'En California, ¿qué se requiere antes de que un vehículo pueda ser vendido o transferido legalmente?',opts:['Solo se necesita un comprobante de venta','El vendedor debe completar un Aviso de Transferencia y Liberación de Responsabilidad (NRL) con el DMV dentro de 5 días de la venta','El nuevo propietario tiene 60 días para registrar el vehículo sin penalización','Las placas se transfieren automáticamente al nuevo propietario'],exp:'Cuando vende o transfiere un vehículo en California, debe completar un Aviso de Transferencia y Liberación de Responsabilidad (NRL) con el DMV dentro de 5 días. Esto lo protege de responsabilidad si el nuevo propietario recibe multas o está involucrado en un accidente antes de volver a registrar el vehículo.'},
  ans:1
},
{
  id:503, cat:'rightofway',
  en:{q:'A school bus with flashing red lights is stopped ahead of you on an undivided two-lane road. What must you do?',opts:['Slow to 15 mph and pass with caution','Stop and remain stopped until the red lights stop flashing and the bus moves or the driver signals you to pass','Stop only if children are visible outside the bus','Continue at normal speed if you are in the opposite lane'],exp:'On an undivided road, when a school bus stops with flashing red lights and an extended stop sign arm, ALL traffic from BOTH directions must stop. You must remain stopped until the red lights stop flashing and the stop arm is retracted. On a divided highway (with a raised median or barrier), only vehicles traveling in the same direction as the bus must stop; vehicles on the other side may proceed with caution.'},
  zh:{q:'在未分隔的两车道道路上，前方有一辆开着红色闪光灯停靠的校车。你必须怎么做？',opts:['减速至15英里/小时，小心通过','停车，并保持停车状态，直到红灯停止闪烁，校车移动，或驾驶员示意你通过','只有在校车外可见儿童时才停车','如果你在对面车道，可以正常速度继续行驶'],exp:'在未分隔道路上，当校车停下亮起红色闪光灯并伸出停车标志臂时，两个方向的所有交通都必须停车。你必须保持停车状态，直到红灯停止闪烁且停车臂收回。在分隔公路上（有中央分隔带或屏障），只有与校车同方向行驶的车辆必须停车；另一侧的车辆可以谨慎通行。'},
  zhTW:{q:'在未分隔的兩車道道路上，前方有一輛開著紅色閃光燈停靠的校車。你必須怎麼做？',opts:['減速至15英里/小時，小心通過','停車，並保持停車狀態，直到紅燈停止閃爍，校車移動，或駕駛員示意你通過','只有在校車外可見兒童時才停車','如果你在對面車道，可以正常速度繼續行駛'],exp:'在未分隔道路上，當校車停下亮起紅色閃光燈並伸出停車標誌臂時，兩個方向的所有交通都必須停車。你必須保持停車狀態，直到紅燈停止閃爍且停車臂收回。在分隔公路上（有中央分隔帶或屏障），只有與校車同方向行駛的車輛必須停車；另一側的車輛可以謹慎通行。'},
  es:{q:'Un autobús escolar con luces rojas intermitentes está detenido adelante de usted en una carretera de dos carriles no dividida. ¿Qué debe hacer?',opts:['Reducir a 15 mph y pasar con precaución','Detenerse y permanecer detenido hasta que las luces rojas dejen de parpadear y el autobús se mueva o el conductor le indique que pase','Detenerse solo si se ven niños fuera del autobús','Continuar a velocidad normal si está en el carril opuesto'],exp:'En una carretera no dividida, cuando un autobús escolar se detiene con luces rojas intermitentes y el brazo de señal de parada extendido, TODOS los vehículos de AMBAS direcciones deben detenerse. Debe permanecer detenido hasta que las luces rojas dejen de parpadear y el brazo se retraiga. En una autopista dividida, solo los vehículos que viajan en la misma dirección que el autobús deben detenerse.'},
  ans:1
},
{
  id:504, cat:'speed',
  en:{q:'What is the speed limit in a senior center or blind center zone in California?',opts:['15 mph','20 mph','25 mph','The same as the surrounding road'],exp:'The prima facie speed limit within 500 to 1,000 feet of a senior center or facility for the blind is 25 mph, when posted, during the hours the facility is in operation and the posted speed limit is less than 25 mph. Always watch for elderly pedestrians and people with visual impairments near these facilities, who may cross the road unexpectedly.'},
  zh:{q:'在加州老年中心或盲人中心区域的速度限制是多少？',opts:['15英里/小时','20英里/小时','25英里/小时','与周围道路相同'],exp:'在老年中心或盲人设施500至1,000英尺范围内，在设施运营时间内且限速低于25英里/小时时，法定速度限制为25英里/小时。在这些设施附近，始终注意老年行人和视力障碍人士，他们可能会意外穿越道路。'},
  zhTW:{q:'在加州老年中心或盲人中心區域的速度限制是多少？',opts:['15英里/小時','20英里/小時','25英里/小時','與周圍道路相同'],exp:'在老年中心或盲人設施500至1,000英尺範圍內，在設施運營時間內且限速低於25英里/小時時，法定速度限制為25英里/小時。在這些設施附近，始終注意老年行人和視力障礙人士，他們可能會意外穿越道路。'},
  es:{q:'¿Cuál es el límite de velocidad en una zona de centro para adultos mayores o centro para ciegos en California?',opts:['15 mph','20 mph','25 mph','El mismo que la carretera circundante'],exp:'El límite de velocidad prima facie dentro de 500 a 1,000 pies de un centro para adultos mayores o instalación para ciegos es 25 mph, cuando está publicado, durante las horas de operación de la instalación y el límite publicado es menor de 25 mph. Siempre esté atento a los peatones mayores y las personas con discapacidades visuales cerca de estas instalaciones.'},
  ans:2
},
{
  id:505, cat:'dui',
  en:{q:'What is the "zero tolerance" law for drivers under 21 in California?',opts:['Drivers under 21 cannot purchase alcohol','A driver under 21 with ANY measurable BAC (0.01% or more) can be cited and lose their license','Drivers under 21 cannot be passengers in a vehicle where alcohol is present','Drivers under 21 face zero tolerance for speeding tickets'],exp:'California\'s zero tolerance law makes it illegal for drivers under 21 to drive with a blood alcohol concentration (BAC) of 0.01% or higher — basically any detectable amount. A BAC of 0.01% can result from just one drink or even mouthwash containing alcohol. Violation results in a 1-year license suspension or delay in getting a license. This is stricter than the 0.08% limit for adults over 21.'},
  zh:{q:'加州对21岁以下驾驶员的"零容忍"法律是什么？',opts:['21岁以下驾驶员不能购买酒精','21岁以下的驾驶员如有任何可测量的BAC（0.01%或以上）可能被处罚并失去驾照','21岁以下驾驶员不能在有酒精的车辆中作乘客','21岁以下驾驶员在超速罚款方面面临零容忍'],exp:'加州的零容忍法律规定，21岁以下的驾驶员禁止以0.01%或更高的血液酒精浓度（BAC）驾驶——基本上是任何可检测到的量。0.01%的BAC可能来自一杯饮料甚至含酒精的漱口水。违规会导致驾照暂停1年或延迟获得驾照。这比21岁以上成年人的0.08%限制更严格。'},
  zhTW:{q:'加州對21歲以下駕駛員的"零容忍"法律是什麼？',opts:['21歲以下駕駛員不能購買酒精','21歲以下的駕駛員如有任何可測量的BAC（0.01%或以上）可能被處罰並失去駕照','21歲以下駕駛員不能在有酒精的車輛中作乘客','21歲以下駕駛員在超速罰款方面面臨零容忍'],exp:'加州的零容忍法律規定，21歲以下的駕駛員禁止以0.01%或更高的血液酒精濃度（BAC）駕駛——基本上是任何可檢測到的量。0.01%的BAC可能來自一杯飲料甚至含酒精的漱口水。違規會導致駕照暫停1年或延遲獲得駕照。這比21歲以上成年人的0.08%限制更嚴格。'},
  es:{q:'¿Cuál es la ley de "tolerancia cero" para conductores menores de 21 años en California?',opts:['Los conductores menores de 21 años no pueden comprar alcohol','Un conductor menor de 21 años con CUALQUIER BAC medible (0.01% o más) puede ser citado y perder su licencia','Los conductores menores de 21 años no pueden ser pasajeros en un vehículo donde haya alcohol','Los conductores menores de 21 años enfrentan cero tolerancia para multas por exceso de velocidad'],exp:'La ley de tolerancia cero de California hace ilegal que conductores menores de 21 años conduzcan con una concentración de alcohol en sangre (BAC) de 0.01% o más — básicamente cualquier cantidad detectable. Un BAC de 0.01% puede resultar de solo una bebida o incluso enjuague bucal que contenga alcohol. La violación resulta en una suspensión de licencia de 1 año.'},
  ans:1
},
{
  id:506, cat:'parking',
  en:{q:'What does a blue curb indicate?',opts:['Motorcycle parking only','Accessible parking for persons with disabilities — requires a valid Disabled Person placard or plates','Permit parking for residents only','Short-term parking — 15 minutes maximum'],exp:'Blue curbs mark accessible parking spaces designated for people with disabilities. To park in a blue curb area, your vehicle must display a valid Disabled Person (DP) placard hanging from the rearview mirror, or have disabled person license plates. The placard or plates belong to the disabled person, not the vehicle — so if you are not the disabled person and they are not in the car, parking there is illegal even if you have access to their placard.'},
  zh:{q:'蓝色路缘石表示什么？',opts:['仅限摩托车停车','为残疾人提供的无障碍停车位——需要有效的残疾人标牌或车牌','仅限居民许可停车','限时停车——最多15分钟'],exp:'蓝色路缘石标记为残疾人指定的无障碍停车位。在蓝色路缘石区域停车，你的车辆必须悬挂有效的残疾人（DP）标牌（挂在后视镜上）或有残疾人车牌。标牌或车牌属于残疾人，而不是车辆——所以如果你不是残疾人，且他们不在车上，即使你有权使用他们的标牌，在那里停车也是违法的。'},
  zhTW:{q:'藍色路緣石表示什麼？',opts:['僅限摩托車停車','為殘疾人提供的無障礙停車位——需要有效的殘疾人標牌或車牌','僅限居民許可停車','限時停車——最多15分鐘'],exp:'藍色路緣石標記為殘疾人指定的無障礙停車位。在藍色路緣石區域停車，你的車輛必須懸掛有效的殘疾人（DP）標牌（掛在後視鏡上）或有殘疾人車牌。標牌或車牌屬於殘疾人，而不是車輛——所以如果你不是殘疾人，且他們不在車上，即使你有權使用他們的標牌，在那裡停車也是違法的。'},
  es:{q:'¿Qué indica un bordillo azul?',opts:['Solo estacionamiento para motocicletas','Estacionamiento accesible para personas con discapacidades — requiere una placa de Persona Discapacitada (DP) válida o placas','Solo estacionamiento con permiso para residentes','Estacionamiento de corta duración — máximo 15 minutos'],exp:'Los bordillos azules marcan espacios de estacionamiento accesibles designados para personas con discapacidades. Para estacionar en un área de bordillo azul, su vehículo debe mostrar una placa de Persona Discapacitada (DP) válida colgando del espejo retrovisor, o tener placas de persona discapacitada. La placa pertenece a la persona discapacitada, no al vehículo.'},
  ans:1
},
{
  id:507, cat:'highway',
  en:{q:'When entering an interstate highway, what is the primary purpose of the acceleration lane?',opts:['To allow trucks to weigh their load before merging','To give drivers space to accelerate to match freeway traffic speed before merging','To serve as a stopping area for vehicles that changed their mind','A place where toll booths are located before freeway access'],exp:'The acceleration lane (also called the merging lane or on-ramp lane) is the paved extension at the end of an on-ramp that provides space to accelerate. Drivers should use this lane to build up speed to match the flow of freeway traffic before merging. Stopping or slowing to a very low speed in an acceleration lane is dangerous and often unnecessary — if gaps are not available, adjust your speed to find one.'},
  zh:{q:'进入州际高速公路时，加速车道的主要目的是什么？',opts:['让卡车在合并前称量载重','给驾驶员空间，在合并前加速以匹配高速公路交通速度','作为改变主意的车辆的停车区域','高速公路入口前收费站所在的地方'],exp:'加速车道（也称为合并车道或入口匝道车道）是入口匝道末端的铺装延伸，提供加速空间。驾驶员应使用此车道将速度提高到与高速公路交通流量匹配，然后再合并。在加速车道停车或减速至非常低的速度既危险又通常没有必要——如果没有可用的空隙，调整速度找到一个。'},
  zhTW:{q:'進入州際高速公路時，加速車道的主要目的是什麼？',opts:['讓卡車在合並前稱量載重','給駕駛員空間，在合並前加速以匹配高速公路交通速度','作為改變主意的車輛的停車區域','高速公路入口前收費站所在的地方'],exp:'加速車道（也稱為合並車道或入口匝道車道）是入口匝道末端的鋪裝延伸，提供加速空間。駕駛員應使用此車道將速度提高到與高速公路交通流量匹配，然後再合並。在加速車道停車或減速至非常低的速度既危險又通常沒有必要——如果沒有可用的空隙，調整速度找到一個。'},
  es:{q:'Al entrar a una autopista interestatal, ¿cuál es el propósito principal del carril de aceleración?',opts:['Permitir que los camiones pesen su carga antes de fusionarse','Dar a los conductores espacio para acelerar para igualar la velocidad del tráfico de la autopista antes de fusionarse','Servir como área de parada para vehículos que cambiaron de opinión','Un lugar donde se ubican las casetas de peaje antes del acceso a la autopista'],exp:'El carril de aceleración (también llamado carril de fusión o carril de rampa de entrada) es la extensión pavimentada al final de una rampa de entrada que proporciona espacio para acelerar. Los conductores deben usar este carril para aumentar la velocidad para igualar el flujo del tráfico de la autopista antes de fusionarse.'},
  ans:1
},
{
  id:508, cat:'safety',
  en:{q:'What is "defensive driving"?',opts:['Driving aggressively to protect your right-of-way','A driving strategy that involves anticipating potential hazards, maintaining awareness of other drivers, and being prepared to react safely to avoid accidents','Only driving in daylight hours to minimize risk','Driving below the speed limit at all times'],exp:'Defensive driving is a set of driving skills and strategies that help you avoid accidents and road conflicts by anticipating potential hazards before they become emergencies. Key elements include: maintaining a safe following distance, scanning the road ahead (at least 10–15 seconds), checking mirrors frequently, assuming other drivers may make errors, and planning escape routes. It means being proactive, not reactive.'},
  zh:{q:'什么是"防御性驾驶"？',opts:['积极地驾驶以保护自己的通行权','一种驾驶策略，包括预判潜在危险、保持对其他驾驶员的意识，并做好安全反应准备以避免事故','只在白天驾驶以降低风险','始终以低于限速的速度行驶'],exp:'防御性驾驶是一套通过在紧急情况发生前预判潜在危险来帮助你避免事故和道路冲突的驾驶技能和策略。关键要素包括：保持安全跟车距离、扫视前方道路（至少10-15秒）、频繁检查后视镜、假设其他驾驶员可能犯错，以及规划逃生路线。这意味着主动出击，而不是被动反应。'},
  zhTW:{q:'什麼是"防禦性駕駛"？',opts:['積極地駕駛以保護自己的通行權','一種駕駛策略，包括預判潛在危險、保持對其他駕駛員的意識，並做好安全反應準備以避免事故','只在白天駕駛以降低風險','始終以低於限速的速度行駛'],exp:'防禦性駕駛是一套通過在緊急情況發生前預判潛在危險來幫助你避免事故和道路衝突的駕駛技能和策略。關鍵要素包括：保持安全跟車距離、掃視前方道路（至少10-15秒）、頻繁檢查後視鏡、假設其他駕駛員可能犯錯，以及規劃逃生路線。這意味著主動出擊，而不是被動反應。'},
  es:{q:'¿Qué es la "conducción defensiva"?',opts:['Conducir agresivamente para proteger su derecho de paso','Una estrategia de conducción que implica anticipar peligros potenciales, mantener conciencia de otros conductores y estar preparado para reaccionar de forma segura para evitar accidentes','Solo conducir durante las horas de luz del día para minimizar el riesgo','Conducir siempre por debajo del límite de velocidad'],exp:'La conducción defensiva es un conjunto de habilidades y estrategias de conducción que ayudan a evitar accidentes y conflictos viales anticipando los peligros potenciales antes de que se conviertan en emergencias. Los elementos clave incluyen: mantener una distancia de seguimiento segura, escanear la carretera hacia adelante, revisar espejos con frecuencia, asumir que otros conductores pueden cometer errores y planificar rutas de escape.'},
  ans:1
},
{
  id:509, cat:'signs',
  en:{q:'What does a white rectangular sign with black letters "ONE WAY" mean?',opts:['You may only drive in one direction — the direction the sign points','This road has only one through lane','This is a one-lane road with no shoulder','This road was recently changed from two-way to one-way'],exp:'A "ONE WAY" sign (white rectangle with black text and an arrow) indicates that traffic on that road travels only in the direction the arrow points. Do not enter from the opposite direction. Watch for one-way streets when turning at intersections. Wrong-way entry onto a one-way street is extremely dangerous and can result in a head-on collision.'},
  zh:{q:'黑字白色矩形标志"ONE WAY"（单行道）意味着什么？',opts:['你只能朝标志指向的方向行驶','这条路只有一个直行车道','这是一条没有路肩的单车道道路','这条路最近从双向改为单向'],exp:'"ONE WAY"标志（带箭头的黑字白色矩形）表示该道路上的交通仅朝箭头指向的方向行驶。不得从相反方向进入。在路口转弯时注意单行道。错误进入单行道极其危险，可能导致迎头碰撞。'},
  zhTW:{q:'黑字白色矩形標誌"ONE WAY"（單行道）意味著什麼？',opts:['你只能朝標誌指向的方向行駛','這條路只有一個直行車道','這是一條沒有路肩的單車道道路','這條路最近從雙向改為單向'],exp:'"ONE WAY"標誌（帶箭頭的黑字白色矩形）表示該道路上的交通僅朝箭頭指向的方向行駛。不得從相反方向進入。在路口轉彎時注意單行道。錯誤進入單行道極其危險，可能導致迎頭碰撞。'},
  es:{q:'¿Qué significa un letrero rectangular blanco con letras negras "ONE WAY" (Un solo sentido)?',opts:['Solo puede conducir en una dirección — la dirección que señala el letrero','Esta carretera tiene solo un carril de paso','Esta es una carretera de un carril sin hombro','Esta carretera fue cambiada recientemente de dos sentidos a un sentido'],exp:'Un letrero "ONE WAY" (rectángulo blanco con texto negro y flecha) indica que el tráfico en esa carretera viaja solo en la dirección que señala la flecha. No entre desde la dirección opuesta. Tenga cuidado con las calles de un solo sentido al girar en las intersecciones. La entrada incorrecta en una calle de un solo sentido es extremadamente peligrosa.'},
  ans:0
},
{
  id:510, cat:'laws',
  en:{q:'In California, what must you do if you are involved in a collision and there is no other party present (e.g., you hit an unattended parked car)?',opts:['Drive away if the damage is minor','Leave a note with your name, address, and phone number on the damaged vehicle, and report the collision to the police if required','Take a photo of the damage and drive away','Wait at the scene for at least 10 minutes'],exp:'If you collide with an unattended vehicle or property, you must stop immediately and locate the owner if possible. If you cannot find the owner, leave a written note with your name, address, and vehicle registration number in a conspicuous place on the damaged vehicle. You should also notify the local police department. Failing to leave a note and leaving the scene is a hit-and-run violation.'},
  zh:{q:'在加州，如果你卷入碰撞事故且没有其他当事人在场（例如，你撞了一辆无人看管的停靠车辆），你必须怎么做？',opts:['如果损失轻微，直接开走','在受损车辆上留下有你姓名、地址和电话号码的便条，并根据需要向警方报告碰撞','拍下损伤照片然后开走','在现场等待至少10分钟'],exp:'如果你与无人看管的车辆或财产相撞，必须立即停车，并尽可能找到车主。如果找不到车主，需在受损车辆显眼处留下写有你姓名、地址和车辆注册号码的便条。你还应通知当地警察局。不留便条并逃离现场是肇事逃逸违规。'},
  zhTW:{q:'在加州，如果你捲入碰撞事故且沒有其他當事人在場（例如，你撞了一輛無人看管的停靠車輛），你必須怎麼做？',opts:['如果損失輕微，直接開走','在受損車輛上留下有你姓名、地址和電話號碼的便條，並根據需要向警方報告碰撞','拍下損傷照片然後開走','在現場等待至少10分鐘'],exp:'如果你與無人看管的車輛或財產相撞，必須立即停車，並盡可能找到車主。如果找不到車主，需在受損車輛顯眼處留下寫有你姓名、地址和車輛注冊號碼的便條。你還應通知當地警察局。不留便條並逃離現場是肇事逃逸違規。'},
...
,
{
  ...
  zh:{q:'现代驾驶安全专家推荐的方向盘手部位置是什么？',opts:['10点和2点位置','9点和3点位置','8点和4点位置','两手都在12点位置'],exp:'现代驾驶安全专家和NHTSA现在推荐9点和3点位置（或8点和4点）。这给予最大的转向控制，使手臂远离气囊展开区域（如果气囊展开时手臂在10-2位置可能造成伤害），并减少驾驶员疲劳。传统的10点和2点位置早于现代气囊的出现，现在被认为不那么安全。'},
  zhTW:{q:'現代駕駛安全專家推薦的方向盤手部位置是什麼？',opts:['10點和2點位置','9點和3點位置','8點和4點位置','兩手都在12點位置'],exp:'現代駕駛安全專家和NHTSA現在推薦9點和3點位置（或8點和4點）。這給予最大的轉向控制，使手臂遠離氣囊展開區域（如果氣囊展開時手臂在10-2位置可能造成傷害），並減少駕駛員疲勞。傳統的10點和2點位置早於現代氣囊的出現，現在被認為不那麼安全。'},
  es:{q:'¿Cuál es la posición correcta de las manos en el volante recomendada por los expertos modernos en seguridad vial?',opts:['10 y 2 en punto','9 y 3 en punto','8 y 4 en punto','Ambas manos a las 12 en punto'],exp:'Los expertos modernos en seguridad vial y la NHTSA ahora recomiendan la posición de 9 y 3 (o 8 y 4). Esto proporciona el máximo control de dirección, mantiene los brazos fuera de la zona de despliegue de la bolsa de aire (que puede causar lesiones si los brazos están en la posición 10-2 durante el despliegue) y reduce la fatiga del conductor.'},
  ans:1
},
{
  id:512, cat:'signs',
  en:{q:'What does a diamond-shaped yellow sign with an "X" and the letters "RXR" mean?',opts:['No right turn ahead','Railroad crossing ahead — be alert for trains','School crossing — yield to children','Road under construction'],exp:'A yellow diamond sign with an "X" and "RXR" is an advance warning sign for a railroad crossing. It means a railroad crossing is ahead; slow down, look and listen in both directions, and be prepared to stop. The advance warning sign appears before the actual crossing. At the crossing itself you will also see the round black-and-yellow "RR" sign and the crossbuck (X) sign.'},
  zh:{q:'带有"X"和字母"RXR"的黄色菱形标志意味着什么？',opts:['前方禁止右转','前方铁路道口——注意火车','学校路口——让行儿童','道路施工中'],exp:'带有"X"和"RXR"的黄色菱形标志是铁路道口的预警标志。表示前方有铁路道口；减速、两个方向观察和聆听，并准备停车。预警标志出现在实际道口之前。在实际道口处，你还会看到圆形黑黄"RR"标志和交叉路标（X形标志）。'},
  zhTW:{q:'帶有"X"和字母"RXR"的黃色菱形標誌意味著什麼？',opts:['前方禁止右轉','前方鐵路道口——注意火車','學校路口——讓行兒童','道路施工中'],exp:'帶有"X"和"RXR"的黃色菱形標誌是鐵路道口的預警標誌。表示前方有鐵路道口；減速、兩個方向觀察和聆聽，並準備停車。預警標誌出現在實際道口之前。在實際道口處，你還會看到圓形黑黃"RR"標誌和交叉路標（X形標誌）。'},
  es:{q:'¿Qué significa un letrero amarillo en forma de diamante con una "X" y las letras "RXR"?',opts:['No girar a la derecha adelante','Cruce de ferrocarril adelante — esté alerta por trenes','Cruce escolar — ceda el paso a los niños','Carretera en construcción'],exp:'Un letrero de diamante amarillo con una "X" y "RXR" es un letrero de advertencia anticipada para un cruce de ferrocarril. Significa que hay un cruce de ferrocarril adelante; reduzca la velocidad, mire y escuche en ambas direcciones, y esté preparado para detenerse. El letrero de advertencia anticipada aparece antes del cruce real.'},
  ans:1
},
{
  id:513, cat:'rightofway',
  en:{q:'You are driving on a road with a center left-turn lane (a two-way left-turn lane marked with yellow lines). What is this lane for?',opts:['Passing slower vehicles in the center of the road','Left turns only — vehicles from either direction may use it to slow down before turning left into a driveway or side street','Emergency vehicles traveling in both directions','Passing on the left when the right lane is blocked'],exp:'A center two-way left-turn lane (TWLTL) is a shared lane in the center of the road marked with solid and dashed yellow lines on both sides. Vehicles from BOTH directions can use it to slow down and prepare for a left turn into a driveway, business, or side street. You may not use it for passing or as a travel lane. Enter it only when you are ready to turn.'},
  zh:{q:'你在有中央左转车道（用黄线标记的双向左转车道）的道路上行驶。这条车道用途是什么？',opts:['在道路中央超越慢速车辆','仅限左转——两个方向的车辆都可以使用它在左转进入私家车道或支路前减速','两个方向行驶的紧急车辆','当右车道被堵时向左超车'],exp:'中央双向左转车道（TWLTL）是道路中央的共用车道，两侧有实线和虚线黄线标记。两个方向的车辆都可以使用它来减速并准备左转进入私家车道、商业区或支路。不能用于超车或作为行驶车道。只有在准备转弯时才进入该车道。'},
  zhTW:{q:'你在有中央左轉車道（用黃線標記的雙向左轉車道）的道路上行駛。這條車道用途是什麼？',opts:['在道路中央超越慢速車輛','僅限左轉——兩個方向的車輛都可以使用它在左轉進入私家車道或支路前減速','兩個方向行駛的緊急車輛','當右車道被堵時向左超車'],exp:'中央雙向左轉車道（TWLTL）是道路中央的共用車道，兩側有實線和虛線黃線標記。兩個方向的車輛都可以使用它來減速並準備左轉進入私家車道、商業區或支路。不能用於超車或作為行駛車道。只有在準備轉彎時才進入該車道。'},
  es:{q:'Está conduciendo en una carretera con un carril central de giro a la izquierda (un carril de giro a la izquierda en dos sentidos marcado con líneas amarillas). ¿Para qué es este carril?',opts:['Adelantar vehículos más lentos en el centro de la carretera','Solo para girar a la izquierda — los vehículos de cualquier dirección pueden usarlo para desacelerar antes de girar a la izquierda hacia una entrada o calle lateral','Para vehículos de emergencia que viajan en ambas direcciones','Adelantar a la izquierda cuando el carril derecho está bloqueado'],exp:'Un carril central de giro a la izquierda en dos sentidos (TWLTL) es un carril compartido en el centro de la carretera marcado con líneas amarillas sólidas y discontinuas en ambos lados. Los vehículos de AMBAS direcciones pueden usarlo para desacelerar y prepararse para girar a la izquierda hacia una entrada, negocio o calle lateral.'},
  ans:1
},
{
  id:514, cat:'speed',
  en:{q:'You are driving at night on an unlit rural road with your low-beam headlights on. What is a safe maximum speed?',opts:['The posted speed limit, regardless of conditions','Only as fast as allows you to stop within the range your headlights illuminate — typically about 40 mph for low beams','65 mph, since the road is clear','High beams must be used, making any speed up to 65 mph safe'],exp:'At night, your stopping distance must not exceed the distance illuminated by your headlights (this is called "overdriving your headlights"). Low beams illuminate about 200 feet ahead; if you are going too fast to stop within 200 feet, you are overdriving. High beams illuminate about 350–500 feet. On unlit roads, reduce speed significantly below the posted daytime limit to stay within your visual stopping distance.'},
  zh:{q:'你在夜间使用近光灯在无路灯的农村道路上行驶。最安全的最高速度是多少？',opts:['无论条件如何，都是限速','只允许在车头灯照射范围内能够停车的速度——近光灯通常约40英里/小时','65英里/小时，因为道路畅通','必须使用远光灯，使任何高达65英里/小时的速度都安全'],exp:'在夜间，你的停车距离不得超过车头灯照射的距离（这被称为"超出车灯行驶"）。近光灯照射约200英尺；如果你的速度快到在200英尺内无法停车，你就是超出车灯行驶。远光灯照射约350-500英尺。在无路灯道路上，将速度显著降低至日间限速以下，以保持在视觉停车距离内。'},
  zhTW:{q:'你在夜間使用近光燈在無路燈的農村道路上行駛。最安全的最高速度是多少？',opts:['無論條件如何，都是限速','只允許在車頭燈照射範圍內能夠停車的速度——近光燈通常約40英里/小時','65英里/小時，因為道路暢通','必須使用遠光燈，使任何高達65英里/小時的速度都安全'],exp:'在夜間，你的停車距離不得超過車頭燈照射的距離（這被稱為"超出車燈行駛"）。近光燈照射約200英尺；如果你的速度快到在200英尺內無法停車，你就是超出車燈行駛。遠光燈照射約350-500英尺。在無路燈道路上，將速度顯著降低至日間限速以下，以保持在視覺停車距離內。'},
  es:{q:'Está conduciendo de noche en una carretera rural sin iluminación con los faros de luz baja encendidos. ¿Cuál es una velocidad máxima segura?',opts:['El límite de velocidad publicado, independientemente de las condiciones','Solo tan rápido como le permita detenerse dentro del rango que iluminan sus faros — típicamente alrededor de 40 mph para luces bajas','65 mph, ya que la carretera está despejada','Se deben usar luces altas, haciendo segura cualquier velocidad hasta 65 mph'],exp:'De noche, su distancia de frenado no debe exceder la distancia iluminada por sus faros (esto se llama "adelantar a sus faros"). Las luces bajas iluminan unos 200 pies; si va demasiado rápido para detenerse en 200 pies, está adelantando a sus faros. Las luces altas iluminan unos 350-500 pies. En carreteras sin iluminación, reduzca significativamente la velocidad.'},
  ans:1
},
{
  id:515, cat:'dui',
  en:{q:'Which of the following can help sober you up after drinking alcohol?',opts:['Drinking black coffee','Taking a cold shower','Exercising vigorously','None of the above — only time allows the body to eliminate alcohol'],exp:'No method other than time sobers you up after drinking. Coffee, cold showers, food, exercise, or fresh air do NOT reduce your blood alcohol concentration (BAC) or speed up the elimination of alcohol from your body. Your liver processes alcohol at roughly one standard drink per hour, and nothing speeds that process up. The only safe choice is not to drive after drinking — plan ahead, use a rideshare, or designate a driver.'},
  zh:{q:'以下哪项能帮助你在饮酒后清醒？',opts:['喝黑咖啡','洗冷水澡','剧烈运动','以上都不能——只有时间才能让身体消除酒精'],exp:'饮酒后除了时间之外，没有任何方法能让你清醒。咖啡、冷水澡、食物、运动或新鲜空气都不能降低你的血液酒精浓度（BAC）或加速从体内消除酒精。你的肝脏以大约每小时一杯标准饮品的速度处理酒精，没有任何东西能加快这一过程。唯一安全的选择是饮酒后不开车——提前计划，使用打车软件，或指定一名驾驶员。'},
  zhTW:{q:'以下哪項能幫助你在飲酒後清醒？',opts:['喝黑咖啡','洗冷水澡','劇烈運動','以上都不能——只有時間才能讓身體消除酒精'],exp:'飲酒後除了時間之外，沒有任何方法能讓你清醒。咖啡、冷水澡、食物、運動或新鮮空氣都不能降低你的血液酒精濃度（BAC）或加速從體內消除酒精。你的肝臟以大約每小時一杯標準飲品的速度處理酒精，沒有任何東西能加快這一過程。唯一安全的選擇是飲酒後不開車——提前計劃，使用打車軟件，或指定一名駕駛員。'},
  es:{q:'¿Cuál de las siguientes opciones puede ayudarle a sobriarse después de beber alcohol?',opts:['Tomar café negro','Ducharse con agua fría','Hacer ejercicio vigoroso','Ninguna de las anteriores — solo el tiempo le permite al cuerpo eliminar el alcohol'],exp:'Ningún método que no sea el tiempo le sobriará después de beber. El café, las duchas frías, la comida, el ejercicio o el aire fresco NO reducen su concentración de alcohol en sangre (BAC) ni aceleran la eliminación del alcohol de su cuerpo. Su hígado procesa el alcohol a aproximadamente una bebida estándar por hora, y nada acelera ese proceso. La única opción segura es no conducir después de beber.'},
  ans:3
},
{
  id:516, cat:'laws',
  en:{q:'In California, you must carry which of the following in your vehicle at all times?',opts:['A first aid kit and emergency flares','Proof of vehicle insurance','Your physical driver\'s license card','Both proof of insurance and your driver\'s license'],exp:'California law requires all drivers to carry proof of valid automobile liability insurance in their vehicle at all times and to present it when requested by a law enforcement officer. You must also have your driver\'s license with you when driving. Failure to provide proof of insurance can result in a fine and vehicle impoundment. Digital proof of insurance (on a smartphone) is accepted in California.'},
  zh:{q:'在加州，你必须始终在车辆中携带以下哪些物品？',opts:['急救箱和紧急信号弹','车辆保险证明','实体驾驶执照卡','保险证明和驾驶执照都需要'],exp:'加州法律要求所有驾驶员始终在车辆中携带有效的汽车责任保险证明，并在执法人员要求时出示。驾驶时也必须随身携带驾驶执照。未能提供保险证明可能导致罚款和车辆被扣押。加州接受数字保险证明（在智能手机上）。'},
  zhTW:{q:'在加州，你必須始終在車輛中攜帶以下哪些物品？',opts:['急救箱和緊急信號彈','車輛保險證明','實體駕駛執照卡','保險證明和駕駛執照都需要'],exp:'加州法律要求所有駕駛員始終在車輛中攜帶有效的汽車責任保險證明，並在執法人員要求時出示。駕駛時也必須隨身攜帶駕駛執照。未能提供保險證明可能導致罰款和車輛被扣押。加州接受數字保險證明（在智能手機上）。'},
  es:{q:'En California, ¿cuál de los siguientes documentos debe llevar en su vehículo en todo momento?',opts:['Un botiquín de primeros auxilios y bengalas de emergencia','Prueba de seguro de vehículo','Su tarjeta de licencia de conducir física','Tanto la prueba de seguro como su licencia de conducir'],exp:'La ley de California requiere que todos los conductores lleven prueba de seguro de responsabilidad de automóvil válido en su vehículo en todo momento y la presenten cuando la solicite un agente de la ley. También debe tener su licencia de conducir consigo cuando conduzca. No proporcionar prueba de seguro puede resultar en multa e incautación del vehículo. California acepta prueba de seguro digital (en un teléfono inteligente).'},
  ans:3
},
{
  id:517, cat:'parking',
  en:{q:'You want to park on a hill with no curb. Which direction should your front wheels be turned?',opts:['Straight ahead, parallel to the road','Toward the road edge (away from uphill, toward the downslope side)','Away from the road edge (toward the center of the road)','The direction of travel'],exp:'When parking on a hill with no curb, always turn your front wheels toward the downhill edge of the road (away from the center). If your vehicle rolls, it will roll off the road rather than into traffic. This applies whether you are parking facing uphill or downhill. With a curb on uphill: wheels away from curb. With a curb on downhill: wheels toward curb. No curb: wheels toward the road edge always.'},
  zh:{q:'你想在没有路缘石的山坡上停车。前轮应该朝哪个方向转？',opts:['直行，与道路平行','朝道路边缘转（远离上坡，朝向下坡侧）','远离道路边缘（朝向道路中央）','行驶方向'],exp:'在没有路缘石的山坡停车时，始终将前轮朝向道路的下坡边缘（远离中央）。如果车辆滚动，它会滚向道路边缘而不是进入交通流。无论你是面向上坡还是下坡停车，这都适用。上坡有路缘石：轮子远离路缘石。下坡有路缘石：轮子朝向路缘石。没有路缘石：轮子始终朝向道路边缘。'},
  zhTW:{q:'你想在沒有路緣石的山坡上停車。前輪應該朝哪個方向轉？',opts:['直行，與道路平行','朝道路邊緣轉（遠離上坡，朝向下坡側）','遠離道路邊緣（朝向道路中央）','行駛方向'],exp:'在沒有路緣石的山坡停車時，始終將前輪朝向道路的下坡邊緣（遠離中央）。如果車輛滾動，它會滾向道路邊緣而不是進入交通流。無論你是面向上坡還是下坡停車，這都適用。上坡有路緣石：輪子遠離路緣石。下坡有路緣石：輪子朝向路緣石。沒有路緣石：輪子始終朝向道路邊緣。'},
  es:{q:'Quiere estacionar en una colina sin bordillo. ¿En qué dirección deben girar sus ruedas delanteras?',opts:['Recto, paralelo a la carretera','Hacia el borde de la carretera (alejándose del lado cuesta arriba, hacia el lado cuesta abajo)','Lejos del borde de la carretera (hacia el centro de la carretera)','La dirección de viaje'],exp:'Al estacionar en una colina sin bordillo, siempre gire las ruedas delanteras hacia el borde cuesta abajo de la carretera (lejos del centro). Si su vehículo rueda, rodará fuera de la carretera en lugar de hacia el tráfico. Esto aplica ya sea que estacione mirando cuesta arriba o cuesta abajo. Sin bordillo: ruedas siempre hacia el borde de la carretera.'},
  ans:1
},
{
  id:518, cat:'highway',
  en:{q:'What should you do when you see a "MERGE" sign on the freeway?',opts:['Accelerate to get ahead of merging vehicles','Be prepared to allow merging vehicles to enter from a ramp — adjust speed to create a safe gap','Stop in your lane until the merge is complete','Move to the far left lane immediately'],exp:'When you see a "MERGE" sign, be aware that vehicles will be entering the freeway from an on-ramp. Cooperate with merging drivers by adjusting your speed to open a gap, or by moving to the left lane if safe. Freeway drivers should facilitate smooth merges — not force ramp drivers to stop. Good merging requires mutual cooperation between both the driver entering and those already on the freeway.'},
  zh:{q:'在高速公路上看到"MERGE"（合并）标志时，应该怎么做？',opts:['加速超越合并的车辆','准备好让从匝道进入的车辆合并——调整速度创造安全空隙','在车道中停车直到合并完成','立即移至最左车道'],exp:'看到"MERGE"标志时，要意识到车辆将从入口匝道进入高速公路。通过调整速度留出空隙，或者在安全时移至左车道，与合并驾驶员合作。高速公路驾驶员应该促进平稳合并——而不是迫使匝道驾驶员停车。良好的合并需要进入的驾驶员和已在高速公路上的驾驶员共同合作。'},
  zhTW:{q:'在高速公路上看到"MERGE"（合並）標誌時，應該怎麼做？',opts:['加速超越合並的車輛','準備好讓從匝道進入的車輛合並——調整速度創造安全空隙','在車道中停車直到合並完成','立即移至最左車道'],exp:'看到"MERGE"標誌時，要意識到車輛將從入口匝道進入高速公路。通過調整速度留出空隙，或者在安全時移至左車道，與合並駕駛員合作。高速公路駕駛員應該促進平穩合並——而不是迫使匝道駕駛員停車。良好的合並需要進入的駕駛員和已在高速公路上的駕駛員共同合作。'},
  es:{q:'¿Qué debe hacer cuando ve un letrero "MERGE" (Fusión) en la autopista?',opts:['Acelerar para adelantarse a los vehículos que se fusionan','Estar preparado para permitir que los vehículos que se fusionan entren desde una rampa — ajuste la velocidad para crear un espacio seguro','Detenerse en su carril hasta que la fusión esté completa','Moverse inmediatamente al carril más a la izquierda'],exp:'Cuando vea un letrero "MERGE", sea consciente de que los vehículos entrarán a la autopista desde una rampa. Coopere con los conductores que se fusionan ajustando su velocidad para abrir un espacio, o moviéndose al carril izquierdo si es seguro. Los conductores de la autopista deben facilitar las fusiones suaves, no obligar a los conductores de la rampa a detenerse.'},
  ans:1
},
{
  id:519, cat:'safety',
  en:{q:'What is the recommended following distance when driving behind a motorcycle?',opts:['The same 3-second rule as for other vehicles','A full 4-second following distance — motorcyclists can stop faster and may swerve suddenly','At least 1 car length per 10 mph','Stay very close to protect the motorcyclist from rear-end collisions'],exp:'When following a motorcycle, California DMV recommends maintaining at least a 4-second following distance (more than the 3-second rule for other vehicles). Motorcycles can stop quickly and may swerve to avoid road hazards that your car would simply drive over. The extra distance gives you reaction time and prevents you from overrunning the motorcycle during sudden stops.'},
  zh:{q:'跟在摩托车后面行驶时，推荐的跟车距离是多少？',opts:['与其他车辆相同的3秒规则','完整的4秒跟车距离——摩托车手可以更快停车，可能会突然转向','每10英里/小时至少一个车身长度','非常靠近以保护摩托车手免遭追尾碰撞'],exp:'跟在摩托车后面时，加州DMV建议保持至少4秒的跟车距离（超过其他车辆的3秒规则）。摩托车可以快速停车，可能会转向以避开你的车会直接压过的路面障碍。额外的距离给你提供反应时间，并防止在紧急停车时追上摩托车。'},
  zhTW:{q:'跟在摩托車後面行駛時，推薦的跟車距離是多少？',opts:['與其他車輛相同的3秒規則','完整的4秒跟車距離——摩托車手可以更快停車，可能會突然轉向','每10英里/小時至少一個車身長度','非常靠近以保護摩托車手免遭追尾碰撞'],exp:'跟在摩托車後面時，加州DMV建議保持至少4秒的跟車距離（超過其他車輛的3秒規則）。摩托車可以快速停車，可能會轉向以避開你的車會直接壓過的路面障礙。額外的距離給你提供反應時間，並防止在緊急停車時追上摩托車。'},
  es:{q:'¿Cuál es la distancia de seguimiento recomendada cuando conduce detrás de una motocicleta?',opts:['La misma regla de 3 segundos que para otros vehículos','Una distancia de seguimiento completa de 4 segundos — los motociclistas pueden detenerse más rápido y pueden desviarse repentinamente','Al menos 1 largo de automóvil por cada 10 mph','Mantenerse muy cerca para proteger al motociclista de colisiones por alcance'],exp:'Al seguir a una motocicleta, el DMV de California recomienda mantener al menos una distancia de seguimiento de 4 segundos (más que la regla de 3 segundos para otros vehículos). Las motocicletas pueden detenerse rápidamente y pueden desviarse para evitar peligros viales que su automóvil simplemente atropellaría. La distancia adicional le da tiempo de reacción y evita que alcance la motocicleta durante paradas repentinas.'},
  ans:1
},
{
  id:520, cat:'signs',
  en:{q:'What does a sign with a white arrow pointing down over a black box mean on a highway?',opts:['Wrong way — turn around immediately','Keep right — stay in the right lane or move right','Lane ends — merge left','One lane only ahead — both lanes merge into one'],exp:'A sign with a downward white arrow on a black background (sometimes called a "lane control" or "keep right" sign) indicates that drivers should keep to the right side of the road or lane. These signs are often posted on medians or at highway lane splits. They remind drivers to stay right except when passing. Always look for lane control signs to understand how the road divides or directs traffic.'},
  zh:{q:'高速公路上黑色方框内有向下白色箭头的标志意味着什么？',opts:['逆行——立即掉头','靠右行驶——保持在右车道或向右移动','车道结束——向左合并','前方只有一个车道——两条车道合并为一'],exp:'黑色背景上有向下白色箭头的标志（有时称为"车道控制"或"靠右行驶"标志）表示驾驶员应靠道路或车道的右侧行驶。这些标志通常安装在中央分隔带上或公路车道分叉处。它们提醒驾驶员除超车外靠右行驶。始终注意车道控制标志，了解道路如何分流或引导交通。'},
  zhTW:{q:'高速公路上黑色方框內有向下白色箭頭的標誌意味著什麼？',opts:['逆行——立即掉頭','靠右行駛——保持在右車道或向右移動','車道結束——向左合並','前方只有一個車道——兩條車道合並為一'],exp:'黑色背景上有向下白色箭頭的標誌（有時稱為"車道控制"或"靠右行駛"標誌）表示駕駛員應靠道路或車道的右側行駛。這些標誌通常安裝在中央分隔帶上或公路車道分叉處。它們提醒駕駛員除超車外靠右行駛。始終注意車道控制標誌，了解道路如何分流或引導交通。'},
...
,
{
  ...
  zh:{q:'"路怒症"是什么，如果另一位驾驶员对你表现出攻击性，你应该怎么做？',opts:['路怒症是超速——立即向警方报告','路怒症是攻击性或暴力驾驶行为——避免眼神接触，不要进行攻击性回应，保持距离，如有危险拨打911','路怒症只在高速公路上违法','路怒症意味着你有权进行身体自卫'],exp:'路怒症涉及追尾、强行插队、不雅手势、威胁甚至身体暴力等攻击性驾驶行为。如果成为目标：不要眼神接触或参与；不要用手势或喇叭还击；冷静地离开；如果被跟踪，不要回家——去警察局或繁忙的公共场所；如有威胁，拨打911。永远不要低估路怒症——它可能迅速变得致命。'},
  zhTW:{q:'"路怒症"是什麼，如果另一位駕駛員對你表現出攻擊性，你應該怎麼做？',opts:['路怒症是超速——立即向警方報告','路怒症是攻擊性或暴力駕駛行為——避免眼神接觸，不要進行攻擊性回應，保持距離，如有危險撥打911','路怒症只在高速公路上違法','路怒症意味著你有權進行身體自衛'],exp:'路怒症涉及追尾、強行插隊、不雅手勢、威脅甚至身體暴力等攻擊性駕駛行為。如果成為目標：不要眼神接觸或參與；不要用手勢或喇叭還擊；冷靜地離開；如果被跟蹤，不要回家——去警察局或繁忙的公共場所；如有威脅，撥打911。永遠不要低估路怒症——它可能迅速變得致命。'},
  es:{q:'¿Qué es la "ira vial" (road rage) y qué debe hacer si otro conductor actúa agresivamente hacia usted?',opts:['La ira vial es exceso de velocidad — repórtela a la policía de inmediato','La ira vial es un comportamiento de conducción agresivo o violento — evite el contacto visual, no responda agresivamente, cree distancia y llame al 911 si está en peligro','La ira vial solo es ilegal en autopistas','La ira vial significa que tiene derecho a defenderse físicamente'],exp:'La ira vial implica comportamientos agresivos como seguir de cerca, hacer cortes, gestos obscenos, amenazas o incluso violencia física. Si es el objetivo: no haga contacto visual ni se involucre; no responda con gestos ni claxon; aléjese calmadamente; si es seguido, no vaya a casa — vaya a una estación de policía; llame al 911 si está amenazado.'},
  ans:1
},
{
  id:522, cat:'rightofway',
  en:{q:'A fire truck has just passed you responding to an emergency. When may you proceed?',opts:['Immediately after the fire truck passes your position','After the fire truck has cleared your immediate area and it is safe — do not follow within 300 feet of an emergency vehicle','Only when a police officer signals you to go','After waiting exactly 30 seconds'],exp:'After an emergency vehicle passes, you must remain stopped until it has completely passed and traffic is clear. Additionally, California law prohibits following within 300 feet of an emergency vehicle responding to an emergency — do not tailgate emergency vehicles. Resume only when it is safe. On a freeway, move right after the vehicle passes, then merge back carefully.'},
  zh:{q:'一辆消防车刚刚超过你去处理紧急情况。你什么时候可以继续行驶？',opts:['消防车经过你的位置后立即','消防车离开你的区域后且安全时——不得在紧急车辆300英尺内跟行','只有在警察示意你前进时','等待整整30秒后'],exp:'紧急车辆经过后，你必须保持停车状态，直到它完全经过且交通畅通。此外，加州法律禁止在响应紧急情况的紧急车辆300英尺内跟行——不要跟随紧急车辆太近。只有在安全时才恢复行驶。在高速公路上，车辆经过后向右移动，然后小心合并。'},
  zhTW:{q:'一輛消防車剛剛超過你去處理緊急情況。你什麼時候可以繼續行駛？',opts:['消防車經過你的位置後立即','消防車離開你的區域後且安全時——不得在緊急車輛300英尺內跟行','只有在警察示意你前進時','等待整整30秒後'],exp:'緊急車輛經過後，你必須保持停車狀態，直到它完全經過且交通暢通。此外，加州法律禁止在響應緊急情況的緊急車輛300英尺內跟行——不要跟隨緊急車輛太近。只有在安全時才恢復行駛。在高速公路上，車輛經過後向右移動，然後小心合並。'},
  es:{q:'Un camión de bomberos acaba de pasar respondiendo a una emergencia. ¿Cuándo puede continuar?',opts:['Inmediatamente después de que el camión de bomberos pase su posición','Después de que el camión de bomberos haya despejado su área inmediata y sea seguro — no siga a menos de 300 pies de un vehículo de emergencia','Solo cuando un oficial de policía le indique que avance','Después de esperar exactamente 30 segundos'],exp:'Después de que un vehículo de emergencia pase, debe permanecer detenido hasta que haya pasado completamente y el tráfico esté despejado. Además, la ley de California prohíbe seguir a menos de 300 pies de un vehículo de emergencia que responde a una emergencia. Continúe solo cuando sea seguro.'},
  ans:1
},
{
  id:523, cat:'speed',
  en:{q:'What is the speed limit in a business district in California when no speed sign is posted?',opts:['15 mph','20 mph','25 mph','35 mph'],exp:'The prima facie (assumed by law) speed limit in a business district in California is 25 mph when no other speed limit sign is posted. A business district is defined as an area where at least 50% of the road frontage on one or both sides within a 300-foot section consists of commercial businesses. Drivers should always look for posted speed limit signs, as the posted limit overrides the prima facie limit.'},
  zh:{q:'在没有限速标志的加州商业区，速度限制是多少？',opts:['15英里/小时','20英里/小时','25英里/小时','35英里/小时'],exp:'在没有其他限速标志的情况下，加州商业区的法定（法律推定）速度限制为25英里/小时。商业区定义为在300英尺路段内，道路一侧或两侧至少50%的临街面由商业企业组成的区域。驾驶员应始终注意张贴的限速标志，因为张贴的限速优先于法定限速。'},
  zhTW:{q:'在沒有限速標誌的加州商業區，速度限制是多少？',opts:['15英里/小時','20英里/小時','25英里/小時','35英里/小時'],exp:'在沒有其他限速標誌的情況下，加州商業區的法定（法律推定）速度限制為25英里/小時。商業區定義為在300英尺路段內，道路一側或兩側至少50%的臨街面由商業企業組成的區域。駕駛員應始終注意張貼的限速標誌，因為張貼的限速優先於法定限速。'},
  es:{q:'¿Cuál es el límite de velocidad en un distrito comercial de California cuando no hay letrero de velocidad publicado?',opts:['15 mph','20 mph','25 mph','35 mph'],exp:'El límite de velocidad prima facie (asumido por la ley) en un distrito comercial de California es 25 mph cuando no hay otro letrero de límite de velocidad publicado. Un distrito comercial se define como un área donde al menos el 50% del frente de la carretera en uno o ambos lados dentro de una sección de 300 pies consiste en negocios comerciales. Los conductores siempre deben buscar letreros de límite de velocidad publicados.'},
  ans:2
},
{
  id:524, cat:'dui',
  en:{q:'What is the legal blood alcohol concentration (BAC) limit for a person under 21 operating a vehicle in California?',opts:['0.08%','0.04%','0.02%','0.01%'],exp:'California has a zero tolerance policy for drivers under 21. Any driver under 21 with a BAC of 0.01% or higher is in violation of California\'s zero tolerance law. This means even a single drink could result in a DUI for a driver under 21. The limit is far stricter than the 0.08% limit that applies to drivers 21 and over. This law applies to all drivers under 21, not just those with provisional licenses.'},
  zh:{q:'在加州，21岁以下人员操作车辆的合法血液酒精浓度（BAC）限制是多少？',opts:['0.08%','0.04%','0.02%','0.01%'],exp:'加州对21岁以下驾驶员实行零容忍政策。任何BAC达到0.01%或以上的21岁以下驾驶员均违反加州零容忍法律。这意味着即使是一杯饮料也可能导致21岁以下驾驶员被以DUI处理。这个限制比适用于21岁及以上驾驶员的0.08%限制严格得多。该法律适用于所有21岁以下驾驶员，不仅仅是持有临时驾照的人。'},
  zhTW:{q:'在加州，21歲以下人員操作車輛的合法血液酒精濃度（BAC）限制是多少？',opts:['0.08%','0.04%','0.02%','0.01%'],exp:'加州對21歲以下駕駛員實行零容忍政策。任何BAC達到0.01%或以上的21歲以下駕駛員均違反加州零容忍法律。這意味著即使是一杯飲料也可能導致21歲以下駕駛員被以DUI處理。這個限制比適用於21歲及以上駕駛員的0.08%限制嚴格得多。該法律適用於所有21歲以下駕駛員，不僅僅是持有臨時駕照的人。'},
  es:{q:'¿Cuál es el límite legal de concentración de alcohol en sangre (BAC) para una persona menor de 21 años que opera un vehículo en California?',opts:['0.08%','0.04%','0.02%','0.01%'],exp:'California tiene una política de tolerancia cero para conductores menores de 21 años. Cualquier conductor menor de 21 años con un BAC de 0.01% o más está violando la ley de tolerancia cero de California. Esto significa que incluso una sola bebida podría resultar en un DUI para un conductor menor de 21 años. El límite es mucho más estricto que el límite de 0.08% que se aplica a los conductores de 21 años o más.'},
  ans:3
},
{
  id:525, cat:'safety',
  en:{q:'What is the greatest risk factor for teen drivers in California?',opts:['Driving at night','Distracted driving — especially cell phone use','Driving with passengers (peer pressure and social distraction)','All of the above — teens face elevated risks from multiple factors'],exp:'Teen drivers face elevated risks from multiple combined factors: inexperience, overconfidence, peer pressure when carrying passengers (the crash risk doubles with one passenger and triples with two or more), distracted driving (particularly texting), nighttime driving (half of teen traffic deaths occur at night), and not wearing seat belts. California\'s provisional license restrictions address many of these by limiting passengers and night driving for new drivers.'},
  zh:{q:'加州青少年驾驶员的最大风险因素是什么？',opts:['夜间驾驶','分心驾驶——尤其是手机使用','与乘客一起驾驶（同伴压力和社交分心）','以上所有——青少年面临多种因素的高风险'],exp:'青少年驾驶员面临多个综合因素的高风险：缺乏经验、过度自信、携带乘客时的同伴压力（有一名乘客时碰撞风险翻倍，有两名或以上时翻三倍）、分心驾驶（尤其是发短信）、夜间驾驶（一半的青少年交通死亡发生在夜间）以及不系安全带。加州的临时驾照限制通过限制新驾驶员的乘客人数和夜间驾驶来解决这些问题中的许多。'},
  zhTW:{q:'加州青少年駕駛員的最大風險因素是什麼？',opts:['夜間駕駛','分心駕駛——尤其是手機使用','與乘客一起駕駛（同伴壓力和社交分心）','以上所有——青少年面臨多種因素的高風險'],exp:'青少年駕駛員面臨多個綜合因素的高風險：缺乏經驗、過度自信、攜帶乘客時的同伴壓力（有一名乘客時碰撞風險翻倍，有兩名或以上時翻三倍）、分心駕駛（尤其是發短信）、夜間駕駛（一半的青少年交通死亡發生在夜間）以及不系安全帶。加州的臨時駕照限制通過限制新駕駛員的乘客人數和夜間駕駛來解決這些問題中的許多。'},
  es:{q:'¿Cuál es el mayor factor de riesgo para los conductores adolescentes en California?',opts:['Conducir de noche','Conducción distraída — especialmente el uso de teléfonos celulares','Conducir con pasajeros (presión de grupo y distracción social)','Todo lo anterior — los adolescentes enfrentan riesgos elevados por múltiples factores'],exp:'Los conductores adolescentes enfrentan riesgos elevados por múltiples factores combinados: inexperiencia, exceso de confianza, presión de grupo cuando llevan pasajeros (el riesgo de accidente se duplica con un pasajero y se triplica con dos o más), conducción distraída (especialmente mensajes de texto), conducción nocturna y no usar cinturones. Las restricciones de licencia provisional de California abordan muchos de estos problemas.'},
  ans:3
},
{
  id:526, cat:'parking',
  en:{q:'What is the minimum distance you must park from a stop sign in California?',opts:['10 feet','20 feet','30 feet','50 feet'],exp:'In California, you must not park within 20 feet of a crosswalk at an intersection, and you must not park within 30 feet of a stop sign. Parking too close to a stop sign obstructs the view of drivers approaching the intersection and makes the sign harder to see. These distances ensure that drivers have enough visibility to see and respond to traffic control devices.'},
  zh:{q:'在加州，你停车距停车标志的最小距离是多少？',opts:['10英尺','20英尺','30英尺','50英尺'],exp:'在加州，不得在路口人行横道20英尺以内停车，也不得在停车标志30英尺以内停车。在停车标志附近停车太近会阻挡接近路口的驾驶员的视线，使标志难以看见。这些距离确保驾驶员有足够的能见度来看到并响应交通控制装置。'},
  zhTW:{q:'在加州，你停車距停車標誌的最小距離是多少？',opts:['10英尺','20英尺','30英尺','50英尺'],exp:'在加州，不得在路口人行橫道20英尺以內停車，也不得在停車標誌30英尺以內停車。在停車標誌附近停車太近會阻擋接近路口的駕駛員的視線，使標誌難以看見。這些距離確保駕駛員有足夠的能見度來看到並響應交通控制裝置。'},
  es:{q:'¿Cuál es la distancia mínima a la que debe estacionar de una señal de alto en California?',opts:['10 pies','20 pies','30 pies','50 pies'],exp:'En California, no debe estacionar dentro de 20 pies de un cruce peatonal en una intersección, y no debe estacionar dentro de 30 pies de una señal de alto. Estacionar demasiado cerca de una señal de alto obstruye la visión de los conductores que se acercan a la intersección y hace que la señal sea más difícil de ver. Estas distancias garantizan que los conductores tengan suficiente visibilidad.'},
  ans:2
},
{
  id:527, cat:'highway',
  en:{q:'What does a solid white line separating lanes of traffic traveling in the same direction indicate?',opts:['Lane changes are strongly discouraged but still legal','You may not cross the line — it marks a boundary that must not be crossed, such as between a travel lane and an exit lane','High-speed lane change is permitted here','Lanes merge ahead — prepare to yield'],exp:'Solid white lines between lanes traveling in the same direction indicate that lane changes are discouraged or prohibited. A solid white line typically separates traffic lanes near intersections, exit ramps, or where lane changes would be unsafe or illegal. You should not cross a solid white line. Dashed white lines between same-direction lanes indicate lane changes are permitted when safe.'},
  zh:{q:'分隔同向行驶车道的实白线表示什么？',opts:['不鼓励变道，但仍然合法','不得越线——它标记不得越过的边界，例如行驶车道和出口车道之间','此处允许高速变道','前方车道合并——准备让行'],exp:'同向行驶车道之间的实白线表示不鼓励或禁止变道。实白线通常在路口附近、出口匝道或变道不安全或违法的地方分隔交通车道。不应越过实白线。同向车道之间的虚白线表示在安全时允许变道。'},
  zhTW:{q:'分隔同向行駛車道的實白線表示什麼？',opts:['不鼓勵變道，但仍然合法','不得越線——它標記不得越過的邊界，例如行駛車道和出口車道之間','此處允許高速變道','前方車道合並——準備讓行'],exp:'同向行駛車道之間的實白線表示不鼓勵或禁止變道。實白線通常在路口附近、出口匝道或變道不安全或違法的地方分隔交通車道。不應越過實白線。同向車道之間的虛白線表示在安全時允許變道。'},
  es:{q:'¿Qué indica una línea blanca sólida que separa carriles de tráfico que viajan en la misma dirección?',opts:['Los cambios de carril se desaconsejan fuertemente pero siguen siendo legales','No puede cruzar la línea — marca un límite que no debe cruzarse, como entre un carril de circulación y un carril de salida','Se permite el cambio de carril a alta velocidad aquí','Los carriles se fusionan adelante — prepárese para ceder el paso'],exp:'Las líneas blancas sólidas entre carriles que viajan en la misma dirección indican que los cambios de carril están desaconsejados o prohibidos. Una línea blanca sólida normalmente separa los carriles de tráfico cerca de intersecciones, rampas de salida o donde los cambios de carril serían inseguros o ilegales. No debe cruzar una línea blanca sólida.'},
  ans:1
},
{
  id:528, cat:'signs',
  en:{q:'What does a yellow sign with a truck going over a bump (hump symbol) mean?',opts:['Rough road ahead — slow down','No trucks allowed on this road beyond this point','Truck weigh station ahead — all trucks must stop','Hill ahead — trucks should use engine braking'],exp:'A yellow diamond sign showing a truck going over a hump warns of a bump or dip in the road ahead. Reduce your speed to avoid losing control or damaging your vehicle. Hitting a bump at high speed can cause you to lose steering control, damage the suspension, or cause cargo to shift in a truck. These signs are placed before significant road irregularities that could surprise an unprepared driver.'},
  zh:{q:'显示卡车越过隆起物（隆起符号）的黄色标志意味着什么？',opts:['前方路面崎岖——减速','此路禁止卡车通行','前方有卡车称重站——所有卡车必须停车','前方有坡道——卡车应使用发动机制动'],exp:'显示卡车越过隆起物的黄色菱形标志警告前方道路有隆起或凹陷。减速以避免失去控制或损坏车辆。以高速撞上隆起物可能导致失去转向控制、损坏悬挂系统或导致卡车货物移位。这些标志放置在可能使无准备驾驶员感到意外的重大路面不平处之前。'},
  zhTW:{q:'顯示卡車越過隆起物（隆起符號）的黃色標誌意味著什麼？',opts:['前方路面崎嶇——減速','此路禁止卡車通行','前方有卡車稱重站——所有卡車必須停車','前方有坡道——卡車應使用發動機制動'],exp:'顯示卡車越過隆起物的黃色菱形標誌警告前方道路有隆起或凹陷。減速以避免失去控制或損壞車輛。以高速撞上隆起物可能導致失去轉向控制、損壞懸掛系統或導致卡車貨物移位。這些標誌放置在可能使無準備駕駛員感到意外的重大路面不平處之前。'},
  es:{q:'¿Qué significa un letrero amarillo con un camión subiendo un montículo (símbolo de joroba)?',opts:['Carretera rugosa adelante — reduzca la velocidad','No se permiten camiones en esta carretera más allá de este punto','Estación de pesaje de camiones adelante — todos los camiones deben detenerse','Colina adelante — los camiones deben usar el freno del motor'],exp:'Un letrero de diamante amarillo que muestra un camión subiendo un montículo advierte de un bache o depresión en la carretera adelante. Reduzca su velocidad para evitar perder el control o dañar su vehículo. Golpear un bache a alta velocidad puede hacer que pierda el control de la dirección, dañe la suspensión o cause que la carga se desplace en un camión.'},
  ans:0
},
{
  id:529, cat:'laws',
  en:{q:'What is the minimum age to obtain a standard (non-commercial) Class C driver\'s license in California without restrictions?',opts:['16 years old','17 years old','18 years old','21 years old'],exp:'In California, you must be at least 18 years old to obtain an unrestricted Class C driver\'s license. Drivers aged 16–17 can obtain a provisional (probationary) license with restrictions on passengers and nighttime driving. Provisional license holders must complete a 12-month period without violations before restrictions can be lifted. The full, unrestricted license is issued at 18.'},
  zh:{q:'在加州，获得标准（非商业）C类驾驶执照而无限制的最低年龄是多少？',opts:['16岁','17岁','18岁','21岁'],exp:'在加州，必须年满18岁才能获得无限制C类驾驶执照。16-17岁的驾驶员可以获得对乘客和夜间驾驶有限制的临时（试用期）驾照。临时驾照持有人必须完成12个月无违规记录的期限后才能解除限制。完整的无限制驾照在18岁时颁发。'},
  zhTW:{q:'在加州，獲得標準（非商業）C類駕駛執照而無限制的最低年齡是多少？',opts:['16歲','17歲','18歲','21歲'],exp:'在加州，必須年滿18歲才能獲得無限制C類駕駛執照。16-17歲的駕駛員可以獲得對乘客和夜間駕駛有限制的臨時（試用期）駕照。臨時駕照持有人必須完成12個月無違規記錄的期限後才能解除限制。完整的無限制駕照在18歲時頒發。'},
  es:{q:'¿Cuál es la edad mínima para obtener una licencia de conducir Clase C estándar (no comercial) en California sin restricciones?',opts:['16 años','17 años','18 años','21 años'],exp:'En California, debe tener al menos 18 años para obtener una licencia de conducir Clase C sin restricciones. Los conductores de 16-17 años pueden obtener una licencia provisional con restricciones sobre pasajeros y conducción nocturna. Los titulares de licencia provisional deben completar un período de 12 meses sin infracciones antes de que se puedan levantar las restricciones. La licencia completa sin restricciones se emite a los 18 años.'},
  ans:2
},
{
  id:530, cat:'safety',
  en:{q:'When should you use your high-beam headlights?',opts:['Only in heavy rain and snow','On open highways when no oncoming vehicles are within 500 feet, and when you are not following another vehicle within 300 feet','At all times on unlit rural roads regardless of other traffic','Only when you cannot see more than 100 feet ahead'],exp:'Use high beams on open roads, highways, and unlit areas when no oncoming traffic is within 500 feet and you are not following another vehicle within 300 feet. Dim to low beams when oncoming vehicles approach (to avoid blinding them), when following close behind another vehicle, in fog (high beams reflect and reduce visibility), and in rain or snow. In fog, low beams or special fog lights are far better than high beams.'},
  zh:{q:'什么时候应该使用远光灯？',opts:['只在大雨和降雪时','在开阔公路上，当对向车辆在500英尺内且没有跟在另一辆车300英尺以内时','在无路灯的农村道路上始终使用，无论有无其他交通','只有当你在100英尺内看不清时'],exp:'在开阔道路、公路和无照明区域，当对向交通在500英尺以外且不跟在另一辆车300英尺以内时，使用远光灯。当对向车辆接近时（以免使他们目眩）、紧跟另一辆车时、在雾中（远光灯反射并降低能见度）以及在雨雪中，切换至近光灯。在雾中，近光灯或特殊雾灯远好于远光灯。'},
  zhTW:{q:'什麼時候應該使用遠光燈？',opts:['只在大雨和降雪時','在開闊公路上，當對向車輛在500英尺內且沒有跟在另一輛車300英尺以內時','在無路燈的農村道路上始終使用，無論有無其他交通','只有當你在100英尺內看不清時'],exp:'在開闊道路、公路和無照明區域，當對向交通在500英尺以外且不跟在另一輛車300英尺以內時，使用遠光燈。當對向車輛接近時（以免使他們目眩）、緊跟另一輛車時、在霧中（遠光燈反射並降低能見度）以及在雨雪中，切換至近光燈。在霧中，近光燈或特殊霧燈遠好於遠光燈。'},
...
,
{
  ...
  zh:{q:'白色五边形标志用于标记什么？',opts:['学区和学校人行横道','州际公路路线','双车道道路不得超车区域','临时施工限速'],exp:'五边形标志（五边形，尖端朝上）在美国专门用于标记学区和学校人行横道。这些标志为黄绿色，黑色文字，提醒驾驶员注意儿童的存在。驾驶员必须遵守学区内张贴的降低限速，并仔细观察过马路的儿童。独特的形状使其在文字可以被读到之前就能被识别。'},
  zhTW:{q:'白色五邊形標誌用於標記什麼？',opts:['學區和學校人行橫道','州際公路路線','雙車道道路不得超車區域','臨時施工限速'],exp:'五邊形標誌（五邊形，尖端朝上）在美國專門用於標記學區和學校人行橫道。這些標誌為黃綠色，黑色文字，提醒駕駛員注意兒童的存在。駕駛員必須遵守學區內張貼的降低限速，並仔細觀察過馬路的兒童。獨特的形狀使其在文字可以被讀到之前就能被識別。'},
  es:{q:'Un letrero blanco de forma pentagonal se usa para marcar ¿qué?',opts:['Zonas escolares y cruces escolares','Rutas de carretera interestatal','Zonas de no adelantamiento en carreteras de dos carriles','Límites de velocidad temporales de construcción'],exp:'Los letreros pentagonales (cinco lados, punta hacia arriba) se usan exclusivamente para marcar zonas escolares y cruces escolares en los Estados Unidos. Estos letreros son de color amarillo-verde con texto negro y alertan a los conductores sobre la presencia de niños. Los conductores deben obedecer los límites de velocidad reducidos publicados en las zonas escolares y observar cuidadosamente a los niños que cruzan la carretera.'},
  ans:0
},
{
  id:532, cat:'laws',
  en:{q:'What is the minimum liability insurance required to legally drive in California?',opts:['$10,000/$20,000/$5,000','$15,000/$30,000/$5,000','$25,000/$50,000/$10,000','$50,000/$100,000/$25,000'],exp:'California law requires minimum liability insurance of 15/30/5: $15,000 for injury or death of one person, $30,000 for injury or death of more than one person, and $5,000 for property damage. These are minimums and many experts recommend higher coverage. Driving without insurance is illegal and can result in fines, vehicle impoundment, and license suspension. You must show proof of insurance if requested by law enforcement.'},
  zh:{q:'在加州合法驾驶所需的最低责任保险是多少？',opts:['$10,000/$20,000/$5,000','$15,000/$30,000/$5,000','$25,000/$50,000/$10,000','$50,000/$100,000/$25,000'],exp:'加州法律要求最低责任保险为15/30/5：一人伤亡$15,000，多人伤亡$30,000，财产损失$5,000。这些是最低要求，许多专家建议购买更高的保险。无保险驾驶是违法的，可能导致罚款、车辆扣押和驾照暂停。如果执法人员要求，您必须出示保险证明。'},
  zhTW:{q:'在加州合法駕駛所需的最低責任保險是多少？',opts:['$10,000/$20,000/$5,000','$15,000/$30,000/$5,000','$25,000/$50,000/$10,000','$50,000/$100,000/$25,000'],exp:'加州法律要求最低責任保險為15/30/5：一人傷亡$15,000，多人傷亡$30,000，財產損失$5,000。這些是最低要求，許多專家建議購買更高的保險。無保險駕駛是違法的，可能導致罰款、車輛扣押和駕照暫停。如果執法人員要求，您必須出示保險證明。'},
  es:{q:'¿Cuál es el seguro de responsabilidad mínimo requerido para conducir legalmente en California?',opts:['$10,000/$20,000/$5,000','$15,000/$30,000/$5,000','$25,000/$50,000/$10,000','$50,000/$100,000/$25,000'],exp:'La ley de California requiere un seguro de responsabilidad mínimo de 15/30/5: $15,000 por lesión o muerte de una persona, $30,000 por lesión o muerte de más de una persona y $5,000 por daños a la propiedad. Estos son mínimos y muchos expertos recomiendan mayor cobertura. Conducir sin seguro es ilegal y puede resultar en multas, impound del vehículo y suspensión de licencia.'},
  ans:1
},
{
  id:533, cat:'rightofway',
  en:{q:'Two cars arrive at an uncontrolled intersection (no signs or signals) at approximately the same time from different roads. Who has the right of way?',opts:['The car traveling on the wider road','The car on the right','The car traveling at the higher speed','The car that arrived first'],exp:'When two vehicles arrive at an uncontrolled intersection at the same time from different roads, the driver on the LEFT must yield to the vehicle on the RIGHT. This is the "yield to the right" rule. If you arrive at an uncontrolled intersection at the same time as another driver, look to your right — if a car is there, yield to it. This rule helps prevent deadlock and collisions at intersections without traffic control.'},
  zh:{q:'两辆汽车同时从不同道路到达一个无控制交叉口（无标志或信号灯）。谁有先行权？',opts:['行驶在较宽道路上的车','右侧的车','行驶速度较高的车','先到达的车'],exp:'当两辆车同时从不同道路到达无控制交叉口时，左侧驾驶员必须向右侧车辆让行。这就是"向右让行"规则。如果您与另一名驾驶员同时到达无控制交叉口，向右看——如果那里有车，就向它让行。这条规则有助于防止无交通控制交叉口的僵局和碰撞。'},
  zhTW:{q:'兩輛汽車同時從不同道路到達一個無控制交叉口（無標誌或信號燈）。誰有先行權？',opts:['行駛在較寬道路上的車','右側的車','行駛速度較高的車','先到達的車'],exp:'當兩輛車同時從不同道路到達無控制交叉口時，左側駕駛員必須向右側車輛讓行。這就是「向右讓行」規則。如果您與另一名駕駛員同時到達無控制交叉口，向右看——如果那裡有車，就向它讓行。這條規則有助於防止無交通控制交叉口的僵局和碰撞。'},
  es:{q:'Dos autos llegan a una intersección sin control (sin señales ni semáforos) al mismo tiempo desde diferentes carreteras. ¿Quién tiene el derecho de paso?',opts:['El auto que viaja por la carretera más ancha','El auto a la derecha','El auto que viaja a mayor velocidad','El auto que llegó primero'],exp:'Cuando dos vehículos llegan a una intersección sin control al mismo tiempo desde diferentes carreteras, el conductor a la IZQUIERDA debe ceder al vehículo a la DERECHA. Esta es la regla de "ceder a la derecha". Si llega a una intersección sin control al mismo tiempo que otro conductor, mire a su derecha — si hay un auto, cédalo.'},
  ans:1
},
{
  id:534, cat:'speed',
  en:{q:'What is the prima facie speed limit on a two-lane undivided highway outside of a business or residential district?',opts:['45 mph','55 mph','65 mph','70 mph'],exp:'The prima facie speed limit on a two-lane undivided highway outside of business and residential districts is 55 mph in California. This applies unless posted signs indicate otherwise. "Prima facie" means the limit is presumed safe unless conditions dictate otherwise (e.g., weather, traffic, road conditions). On divided highways with four or more lanes, the limit is 65 mph. Always follow posted signs as they may override prima facie limits.'},
  zh:{q:'在商业区或住宅区外的双车道不分隔公路上，基准限速是多少？',opts:['45英里/小时','55英里/小时','65英里/小时','70英里/小时'],exp:'在加州，商业区和住宅区外的双车道不分隔公路的基准限速为每小时55英里。除非标志另有说明，否则均适用。"基准"意味着除非条件另有要求（如天气、交通、道路状况），否则该限速被推定为安全的。在有四个或更多车道的分隔公路上，限速为每小时65英里。请始终遵循张贴的标志，因为它们可能会覆盖基准限速。'},
  zhTW:{q:'在商業區或住宅區外的雙車道不分隔公路上，基準限速是多少？',opts:['45英里/小時','55英里/小時','65英里/小時','70英里/小時'],exp:'在加州，商業區和住宅區外的雙車道不分隔公路的基準限速為每小時55英里。除非標誌另有說明，否則均適用。「基準」意味著除非條件另有要求（如天氣、交通、道路狀況），否則該限速被推定為安全的。在有四個或更多車道的分隔公路上，限速為每小時65英里。請始終遵循張貼的標誌，因為它們可能會覆蓋基準限速。'},
  es:{q:'¿Cuál es el límite de velocidad prima facie en una carretera de dos carriles sin divisor fuera de un distrito comercial o residencial?',opts:['45 mph','55 mph','65 mph','70 mph'],exp:'El límite de velocidad prima facie en una carretera de dos carriles sin divisor fuera de distritos comerciales y residenciales es de 55 mph en California. Esto aplica a menos que los letreros indiquen lo contrario. "Prima facie" significa que el límite se presume seguro a menos que las condiciones dicten lo contrario. En autopistas divididas con cuatro o más carriles, el límite es 65 mph.'},
  ans:1
},
{
  id:535, cat:'dui',
  en:{q:'How long does a DUI conviction remain on your driving record in California?',opts:['3 years','7 years','10 years','It is permanent and never removed'],exp:'A DUI conviction remains on your California driving record for 10 years from the date of the offense. During that 10-year period, any subsequent DUI will be treated as a repeat offense with enhanced penalties. After 10 years, the DUI may be removed from your DMV driving record for purposes of calculating prior offenses. However, a DUI conviction on your criminal record may remain longer depending on whether it was charged as a misdemeanor or felony.'},
  zh:{q:'在加州，DUI定罪在您的驾驶记录上保留多长时间？',opts:['3年','7年','10年','永久，永不删除'],exp:'DUI定罪从违规日期起在加州驾驶记录上保留10年。在这10年期间，任何后续DUI将被视为重犯，并处以更严厉的处罚。10年后，DUI可能会从您的DMV驾驶记录中删除，用于计算以前的违规次数。但是，根据DUI是以轻罪还是重罪起诉，您刑事记录上的DUI定罪可能保留更长时间。'},
  zhTW:{q:'在加州，DUI定罪在您的駕駛記錄上保留多長時間？',opts:['3年','7年','10年','永久，永不刪除'],exp:'DUI定罪從違規日期起在加州駕駛記錄上保留10年。在這10年期間，任何後續DUI將被視為重犯，並處以更嚴厲的處罰。10年後，DUI可能會從您的DMV駕駛記錄中刪除，用於計算以前的違規次數。但是，根據DUI是以輕罪還是重罪起訴，您刑事記錄上的DUI定罪可能保留更長時間。'},
  es:{q:'¿Cuánto tiempo permanece una condena por DUI en su registro de conducción en California?',opts:['3 años','7 años','10 años','Es permanente y nunca se elimina'],exp:'Una condena por DUI permanece en su registro de conducción de California durante 10 años desde la fecha de la infracción. Durante ese período de 10 años, cualquier DUI posterior se tratará como una reincidencia con penalidades mejoradas. Después de 10 años, el DUI puede ser eliminado de su registro de conducción del DMV para calcular infracciones previas. Sin embargo, una condena por DUI en su registro criminal puede permanecer más tiempo.'},
  ans:2
},
{
  id:536, cat:'parking',
  en:{q:'When are you permitted to park in a bicycle lane?',opts:['Never under any circumstances','Only when it is safe and there are no cyclists nearby','When authorized by posted signs or when briefly stopping to load or unload (up to five minutes)','Whenever there is no bike lane traffic'],exp:'You may not park in a bicycle lane unless signs specifically permit it or you are briefly stopping to load or unload passengers or cargo (typically up to 5 minutes). You must not block bicyclists\' travel path and must yield to any cyclist using the lane. Parking in a bike lane without authorization is illegal and creates hazards for cyclists who may be forced into vehicle traffic to go around your car.'},
  zh:{q:'什么时候允许在自行车道停车？',opts:['任何情况下都不允许','只要安全且附近没有骑车人','当有张贴标志授权或短暂停车（不超过五分钟）装卸货物时','只要没有自行车道交通时'],exp:'除非标志特别允许，或者您短暂停车装卸乘客或货物（通常不超过5分钟），否则不得在自行车道停车。您不得阻碍骑车人的行驶路径，并且必须向使用该车道的任何骑车人让行。未经授权在自行车道停车是违法的，会为可能被迫绕过您的车进入车辆交通的骑车人造成危险。'},
  zhTW:{q:'什麼時候允許在自行車道停車？',opts:['任何情況下都不允許','只要安全且附近沒有騎車人','當有張貼標誌授權或短暫停車（不超過五分鐘）裝卸貨物時','只要沒有自行車道交通時'],exp:'除非標誌特別允許，或者您短暫停車裝卸乘客或貨物（通常不超過5分鐘），否則不得在自行車道停車。您不得阻礙騎車人的行駛路徑，並且必須向使用該車道的任何騎車人讓行。未經授權在自行車道停車是違法的，會為可能被迫繞過您的車進入車輛交通的騎車人造成危險。'},
  es:{q:'¿Cuándo se le permite estacionar en un carril para bicicletas?',opts:['Nunca bajo ninguna circunstancia','Solo cuando es seguro y no hay ciclistas cerca','Cuando lo autorizan letreros publicados o cuando se detiene brevemente para cargar o descargar (hasta cinco minutos)','Siempre que no haya tráfico en el carril de bicicletas'],exp:'No puede estacionar en un carril para bicicletas a menos que los letreros lo permitan específicamente o esté haciendo una parada breve para cargar o descargar pasajeros o carga (típicamente hasta 5 minutos). No debe bloquear el camino de viaje de los ciclistas y debe ceder a cualquier ciclista que use el carril. Estacionar en un carril de bicicletas sin autorización es ilegal y crea peligros para los ciclistas.'},
  ans:2
},
{
  id:537, cat:'highway',
  en:{q:'What is the triangular paved area between an exit ramp and the highway called, and can you drive or stop in it?',opts:['The gore area; you must never drive or stop in it','The buffer zone; you may stop there in an emergency','The merge lane; it is used to accelerate before merging','The transition lane; slower vehicles may use it'],exp:'The triangular paved area between an exit ramp and the main highway is called the gore area. You must NEVER drive across or stop in the gore area. It is not a lane of traffic. The gore is marked with painted arrows and "V" shaped striping. Entering or stopping in the gore is dangerous because drivers on the highway do not expect vehicles there, and it is illegal. If you miss your exit, continue to the next exit; do not back up on a highway.'},
  zh:{q:'出口匝道与高速公路之间的三角形铺装区域叫什么，您可以在其中行驶或停车吗？',opts:['戈尔区；绝对不得在其中行驶或停车','缓冲区；紧急情况下可以在那里停车','合并车道；用于在合并前加速','过渡车道；较慢车辆可以使用'],exp:'出口匝道和主高速公路之间的三角形铺装区域被称为戈尔区（gore area）。绝对不得在戈尔区内行驶或停车。它不是交通车道。戈尔区用画有箭头的"V"形条纹标记。进入或停在戈尔区是危险的，因为高速公路上的驾驶员不会预期那里有车辆，而且这也是违法的。如果您错过了出口，继续到下一个出口；不要在高速公路上倒车。'},
  zhTW:{q:'出口匝道與高速公路之間的三角形鋪裝區域叫什麼，您可以在其中行駛或停車嗎？',opts:['戈爾區；絕對不得在其中行駛或停車','緩衝區；緊急情況下可以在那裡停車','合並車道；用於在合並前加速','過渡車道；較慢車輛可以使用'],exp:'出口匝道和主高速公路之間的三角形鋪裝區域被稱為戈爾區（gore area）。絕對不得在戈爾區內行駛或停車。它不是交通車道。戈爾區用畫有箭頭的「V」形條紋標記。進入或停在戈爾區是危險的，因為高速公路上的駕駛員不會預期那裡有車輛，而且這也是違法的。如果您錯過了出口，繼續到下一個出口；不要在高速公路上倒車。'},
  es:{q:'¿Cómo se llama el área pavimentada triangular entre una rampa de salida y la carretera, y puede conducir o detenerse en ella?',opts:['El área de gore; nunca debe conducir o detenerse en ella','La zona de amortiguación; puede detenerse allí en una emergencia','El carril de fusión; se usa para acelerar antes de fusionarse','El carril de transición; los vehículos más lentos pueden usarlo'],exp:'El área pavimentada triangular entre una rampa de salida y la autopista principal se llama área de gore. NUNCA debe conducir a través o detenerse en el área de gore. No es un carril de tráfico. El gore está marcado con flechas pintadas y rayas en forma de "V". Entrar o detenerse en el gore es peligroso porque los conductores en la autopista no esperan vehículos allí y es ilegal.'},
  ans:0
},
{
  id:538, cat:'safety',
  en:{q:'What is the recommended minimum following distance for normal driving conditions at highway speed?',opts:['1 second','2 seconds','3 seconds','5 seconds'],exp:'California\'s DMV recommends a minimum following distance of 3 seconds under normal conditions. To measure: when the vehicle ahead passes a fixed object, count "one-thousand-one, one-thousand-two, one-thousand-three." You should not reach the same object before finishing counting. Increase following distance to 4+ seconds in rain or low visibility, 5+ seconds on wet roads, and even more when following large trucks, motorcycles, or in heavy traffic. The 3-second rule adjusts automatically for speed.'},
  zh:{q:'在正常行驶条件下，在高速公路速度行驶时，建议的最小跟车距离是多少？',opts:['1秒','2秒','3秒','5秒'],exp:'加州DMV建议在正常条件下最小跟车距离为3秒。测量方法：当前面的车辆经过固定物体时，数"一千零一，一千零二，一千零三"。在您数完之前不应到达同一物体。在雨天或低能见度时将跟车距离增加到4秒以上，在湿滑道路上增加到5秒以上，跟随大型卡车、摩托车或在拥堵交通中时更要增加。3秒规则会根据速度自动调整。'},
  zhTW:{q:'在正常行駛條件下，在高速公路速度行駛時，建議的最小跟車距離是多少？',opts:['1秒','2秒','3秒','5秒'],exp:'加州DMV建議在正常條件下最小跟車距離為3秒。測量方法：當前面的車輛經過固定物體時，數「一千零一，一千零二，一千零三」。在您數完之前不應到達同一物體。在雨天或低能見度時將跟車距離增加到4秒以上，在濕滑道路上增加到5秒以上，跟隨大型卡車、摩托車或在擁擠交通中時更要增加。3秒規則會根據速度自動調整。'},
  es:{q:'¿Cuál es la distancia de seguimiento mínima recomendada para condiciones de conducción normales a velocidad de autopista?',opts:['1 segundo','2 segundos','3 segundos','5 segundos'],exp:'El DMV de California recomienda una distancia de seguimiento mínima de 3 segundos en condiciones normales. Para medir: cuando el vehículo delante pasa un objeto fijo, cuente "mil uno, mil dos, mil tres." No debe llegar al mismo objeto antes de terminar de contar. Aumente la distancia de seguimiento a 4+ segundos en lluvia o baja visibilidad, 5+ segundos en carreteras mojadas.'},
  ans:2
},
{
  id:539, cat:'signs',
  en:{q:'What color background do signs that provide motorist services information (gas, food, lodging, hospitals) typically use?',opts:['Green','Brown','Blue','Yellow'],exp:'Blue signs provide motorist services information such as gas stations, restaurants, hotels/motels, hospitals, and rest areas. You will often see these on highways and interstates. Green signs give directional and distance information (exits, destinations, distances). Brown signs indicate recreational areas, parks, and cultural sites. Yellow signs are warnings. Knowing sign colors helps you quickly identify the type of information even before reading the text.'},
  zh:{q:'提供驾驶员服务信息（加油、餐饮、住宿、医院）的标志通常使用什么颜色背景？',opts:['绿色','棕色','蓝色','黄色'],exp:'蓝色标志提供驾驶员服务信息，如加油站、餐厅、酒店/汽车旅馆、医院和休息区。您经常在高速公路和州际公路上看到这些标志。绿色标志提供方向和距离信息（出口、目的地、距离）。棕色标志指示休闲区、公园和文化场所。黄色标志是警告标志。了解标志颜色有助于您在阅读文字之前快速识别信息类型。'},
  zhTW:{q:'提供駕駛員服務信息（加油、餐飲、住宿、醫院）的標誌通常使用什麼顏色背景？',opts:['綠色','棕色','藍色','黃色'],exp:'藍色標誌提供駕駛員服務信息，如加油站、餐廳、酒店/汽車旅館、醫院和休息區。您經常在高速公路和州際公路上看到這些標誌。綠色標誌提供方向和距離信息（出口、目的地、距離）。棕色標誌指示休閒區、公園和文化場所。黃色標誌是警告標誌。了解標誌顏色有助於您在閱讀文字之前快速識別信息類型。'},
  es:{q:'¿Qué color de fondo usan típicamente los letreros que proporcionan información de servicios para motoristas (gasolina, comida, alojamiento, hospitales)?',opts:['Verde','Marrón','Azul','Amarillo'],exp:'Los letreros azules proporcionan información de servicios para motoristas como estaciones de gasolina, restaurantes, hoteles/moteles, hospitales y áreas de descanso. A menudo los verá en autopistas e interestatales. Los letreros verdes dan información de dirección y distancia. Los letreros marrones indican áreas recreativas, parques y sitios culturales. Los letreros amarillos son advertencias.'},
  ans:2
},
{
  id:540, cat:'laws',
  en:{q:'What happens to your driver\'s license if you refuse to take a chemical test (breathalyzer or blood test) when lawfully arrested for DUI in California?',opts:['Nothing — you have the right to refuse any test','Your license is suspended for 1 year for a first offense','You receive a small fine but keep your license','The officer must release you without charges'],exp:'Under California\'s "implied consent" law, any person who drives a motor vehicle is deemed to have consented to chemical testing if lawfully arrested for DUI. Refusing a chemical test results in automatic license suspension: 1 year for a first refusal, 2 years for a second refusal within 10 years, and 3 years for a third or subsequent refusal. You can still be prosecuted for DUI based on other evidence, and refusal can be used against you in court.'},
  zh:{q:'在加州，当被依法逮捕涉嫌DUI时，如果您拒绝进行化学测试（呼气测试或血液测试），您的驾照会怎样？',opts:['没有任何后果——您有权拒绝任何测试','您的驾照将因首次违规被暂停1年','您会收到小额罚款但保留驾照','警察必须释放您，不予起诉'],exp:'根据加州的"默示同意"法，任何驾驶机动车的人被视为已同意在依法逮捕DUI时进行化学测试。拒绝化学测试会导致自动暂停驾照：首次拒绝1年，10年内第二次拒绝2年，第三次或以后拒绝3年。您仍然可以根据其他证据被起诉DUI，且拒绝可在法庭上用于对抗您。'},
  zhTW:{q:'在加州，當被依法逮捕涉嫌DUI時，如果您拒絕進行化學測試（呼氣測試或血液測試），您的駕照會怎樣？',opts:['沒有任何後果——您有權拒絕任何測試','您的駕照將因首次違規被暫停1年','您會收到小額罰款但保留駕照','警察必須釋放您，不予起訴'],exp:'根據加州的「默示同意」法，任何駕駛機動車的人被視為已同意在依法逮捕DUI時進行化學測試。拒絕化學測試會導致自動暫停駕照：首次拒絕1年，10年內第二次拒絕2年，第三次或以後拒絕3年。您仍然可以根據其他證據被起訴DUI，且拒絕可在法庭上用於對抗您。'},
...
,
{
  ...
  zh:{q:'一名行人正在标记的人行横道上过马路。您正在绿灯左转。您应该怎么做？',opts:['继续转弯——您有绿灯','鸣喇叭提醒行人等待','向行人让行——行人在人行横道内始终有先行权','示意行人快速通过，以便您继续行驶'],exp:'人行横道内的行人始终有先行权，即使您有绿灯。在任何路口转弯时，您必须向在您行驶路径中人行横道内通过的行人让行。干扰、恐吓或未能向标记或未标记人行横道中的行人让行是违法的。这适用于标记的人行横道和路口合法的未标记人行横道。'},
  zhTW:{q:'一名行人正在標記的人行橫道上過馬路。您正在綠燈左轉。您應該怎麼做？',opts:['繼續轉彎——您有綠燈','鳴喇叭提醒行人等待','向行人讓行——行人在人行橫道內始終有先行權','示意行人快速通過，以便您繼續行駛'],exp:'人行橫道內的行人始終有先行權，即使您有綠燈。在任何路口轉彎時，您必須向在您行駛路徑中人行橫道內通過的行人讓行。干擾、恐嚇或未能向標記或未標記人行橫道中的行人讓行是違法的。這適用於標記的人行橫道和路口合法的未標記人行橫道。'},
  es:{q:'Un peatón está cruzando la calle en un paso de peatones marcado. Usted está girando a la izquierda con luz verde. ¿Qué debe hacer?',opts:['Continúe el giro — tiene luz verde','Toque la bocina para alertar al peatón que espere','Ceda al peatón — los peatones siempre tienen derecho de paso en un paso de peatones','Haga señas al peatón para que cruce rápido y pueda continuar'],exp:'Los peatones en un paso de peatones siempre tienen el derecho de paso, incluso cuando usted tiene luz verde. Al girar en cualquier intersección, debe ceder a los peatones que cruzan en el paso de peatones en su camino. Es ilegal interferir, intimidar o no ceder a un peatón en un paso de peatones marcado o no marcado.'},
  ans:2
},
{
  id:542, cat:'speed',
  en:{q:'What is the maximum speed limit on a California freeway unless otherwise posted?',opts:['55 mph','65 mph','70 mph','75 mph'],exp:'The maximum speed limit on California freeways is 65 mph unless otherwise posted. Some freeways in rural areas or with favorable conditions may be posted at 70 mph. Always follow posted signs, which may be lower (55 mph in congested or construction areas) or higher (70 mph in designated areas). The minimum speed on a freeway is also regulated — driving too slowly can be as dangerous as driving too fast. Drivers must not impede the normal flow of traffic.'},
  zh:{q:'除非另有张贴，加州高速公路的最高限速是多少？',opts:['55英里/小时','65英里/小时','70英里/小时','75英里/小时'],exp:'除非另有张贴，加州高速公路的最高限速为65英里/小时。一些农村地区或条件良好的高速公路可能张贴70英里/小时。请始终遵循张贴的标志，在拥堵或施工区域可能为55英里/小时，在指定区域可能为70英里/小时。高速公路上的最低速度也受到监管——驾驶太慢可能和驾驶太快一样危险。驾驶员不得阻碍正常交通流量。'},
  zhTW:{q:'除非另有張貼，加州高速公路的最高限速是多少？',opts:['55英里/小時','65英里/小時','70英里/小時','75英里/小時'],exp:'除非另有張貼，加州高速公路的最高限速為65英里/小時。一些農村地區或條件良好的高速公路可能張貼70英里/小時。請始終遵循張貼的標誌，在擁堵或施工區域可能為55英里/小時，在指定區域可能為70英里/小時。高速公路上的最低速度也受到監管——駕駛太慢可能和駕駛太快一樣危險。駕駛員不得阻礙正常交通流量。'},
  es:{q:'¿Cuál es el límite de velocidad máximo en una autopista de California a menos que se indique lo contrario?',opts:['55 mph','65 mph','70 mph','75 mph'],exp:'El límite de velocidad máximo en las autopistas de California es de 65 mph a menos que se indique lo contrario. Algunas autopistas en áreas rurales o con condiciones favorables pueden estar publicadas a 70 mph. Siempre siga los letreros publicados, que pueden ser más bajos (55 mph en áreas congestionadas o de construcción) o más altos (70 mph en áreas designadas). La velocidad mínima en una autopista también está regulada.'},
  ans:1
},
{
  id:543, cat:'signs',
  en:{q:'What does a sign with a red circle and a diagonal red bar over a symbol mean?',opts:['Warning — that activity or condition is ahead','That activity or movement is prohibited','That action is recommended but optional','Construction zone — workers present'],exp:'A red circle with a diagonal red bar (the international "NO" symbol) placed over a symbol means that action or activity is prohibited. For example, a red circle with a bar over a U-turn arrow means no U-turns are allowed. A red circle with a bar over a bicycle means bicycles are not permitted. This symbol is used worldwide and means "do not do" whatever is shown inside the red circle. It is a regulatory sign.'},
  zh:{q:'带有红色圆圈和红色斜杠覆盖符号的标志意味着什么？',opts:['警告——前方有该活动或状况','该活动或动作被禁止','该动作被建议但可选','施工区——有工人'],exp:'红色圆圈加红色斜杠（国际"禁止"符号）覆盖在符号上意味着该行为或活动被禁止。例如，红色圆圈加斜杠覆盖在U形转弯箭头上意味着禁止U形转弯。红色圆圈加斜杠覆盖在自行车上意味着不允许自行车通行。这个符号在全球使用，意味着"不要做"圆圈内显示的任何事情。它是一个法规标志。'},
  zhTW:{q:'帶有紅色圓圈和紅色斜杠覆蓋符號的標誌意味著什麼？',opts:['警告——前方有該活動或狀況','該活動或動作被禁止','該動作被建議但可選','施工區——有工人'],exp:'紅色圓圈加紅色斜杠（國際「禁止」符號）覆蓋在符號上意味著該行為或活動被禁止。例如，紅色圓圈加斜杠覆蓋在U形轉彎箭頭上意味著禁止U形轉彎。紅色圓圈加斜杠覆蓋在自行車上意味著不允許自行車通行。這個符號在全球使用，意味著「不要做」圓圈內顯示的任何事情。它是一個法規標誌。'},
  es:{q:'¿Qué significa un letrero con un círculo rojo y una barra diagonal roja sobre un símbolo?',opts:['Advertencia — esa actividad o condición está adelante','Esa actividad o movimiento está prohibido','Esa acción es recomendada pero opcional','Zona de construcción — hay trabajadores presentes'],exp:'Un círculo rojo con una barra diagonal roja (el símbolo internacional de "NO") colocado sobre un símbolo significa que esa acción o actividad está prohibida. Por ejemplo, un círculo rojo con barra sobre una flecha de vuelta en U significa que no se permiten vueltas en U. Este símbolo se usa en todo el mundo y significa "no hacer" lo que sea que se muestre dentro del círculo rojo. Es una señal regulatoria.'},
  ans:1
},
{
  id:544, cat:'parking',
  en:{q:'What does a red curb indicate?',opts:['No parking — you may stop momentarily to load/unload passengers','No stopping or standing at any time','Parking permitted for 15 minutes only','Emergency vehicles only may park here'],exp:'A red curb means NO stopping, standing, or parking at any time. You cannot even stop briefly to drop off a passenger at a red curb. Red curbs are used near fire hydrants, fire stations, bus zones, and in other places where any stopping would create a hazard or obstruction. Stopping at a red curb — even for a moment — is illegal and can result in a fine or towing. This is stricter than yellow curbs (commercial loading only) or white curbs (passenger loading only).'},
  zh:{q:'红色路缘代表什么？',opts:['禁止停车——可以短暂停车上下乘客','任何时候禁止停车或站立','只允许停车15分钟','只有紧急车辆可以在此停车'],exp:'红色路缘表示任何时候都不得停车、站立或停放车辆。您甚至不能短暂停车让乘客下车。红色路缘用于消防栓、消防站、公共汽车站附近以及其他任何停车都会造成危险或阻碍的地方。在红色路缘停车——即使是片刻——也是违法的，可能导致罚款或拖车。这比黄色路缘（仅商业装卸）或白色路缘（仅乘客上下车）更严格。'},
  zhTW:{q:'紅色路緣代表什麼？',opts:['禁止停車——可以短暫停車上下乘客','任何時候禁止停車或站立','只允許停車15分鐘','只有緊急車輛可以在此停車'],exp:'紅色路緣表示任何時候都不得停車、站立或停放車輛。您甚至不能短暫停車讓乘客下車。紅色路緣用於消防栓、消防站、公共汽車站附近以及其他任何停車都會造成危險或阻礙的地方。在紅色路緣停車——即使是片刻——也是違法的，可能導致罰款或拖車。這比黃色路緣（僅商業裝卸）或白色路緣（僅乘客上下車）更嚴格。'},
  es:{q:'¿Qué indica un bordillo rojo?',opts:['Prohibido estacionar — puede detenerse momentáneamente para subir/bajar pasajeros','No detenerse ni estacionarse en ningún momento','Estacionamiento permitido solo por 15 minutos','Solo los vehículos de emergencia pueden estacionarse aquí'],exp:'Un bordillo rojo significa que NO puede detenerse, pararse ni estacionar en ningún momento. No puede ni siquiera detenerse brevemente para dejar a un pasajero en un bordillo rojo. Los bordillos rojos se usan cerca de hidrantes, estaciones de bomberos, zonas de autobús y en otros lugares donde cualquier parada crearía un peligro u obstrucción. Detenerse en un bordillo rojo es ilegal y puede resultar en multa o remolque.'},
  ans:1
},
{
  id:545, cat:'dui',
  en:{q:'If you are convicted of a DUI with a blood alcohol concentration (BAC) of 0.15% or higher, what additional consequence may you face compared to a standard DUI?',opts:['Automatic felony charge instead of misdemeanor','Mandatory installation of an ignition interlock device (IID) and enhanced penalties','Permanent revocation of your driver\'s license','Automatic 60-day jail sentence with no alternatives'],exp:'A BAC of 0.15% or higher (nearly twice the legal limit) triggers enhanced DUI penalties in California. These include a longer mandatory IID (ignition interlock device) installation requirement, longer DUI school, longer license suspension, and potentially higher fines. An IID requires you to breathe into a device before your car will start. Enhanced penalties also apply for BAC over 0.20%. The standard legal limit is 0.08% for adults 21+.'},
  zh:{q:'如果您因血液酒精浓度（BAC）达到0.15%或更高而被定罪DUI，与标准DUI相比，您可能面临什么额外后果？',opts:['自动以重罪而非轻罪起诉','强制安装点火互锁装置（IID）并加重处罚','永久吊销驾照','自动60天监禁，没有替代方案'],exp:'血液酒精浓度达到0.15%或更高（几乎是法定限制的两倍）会在加州触发加重DUI处罚。这些包括更长的强制点火互锁装置（IID）安装要求、更长的DUI学校、更长的驾照暂停以及可能更高的罚款。IID要求您在汽车启动前向设备呼气。BAC超过0.20%也适用加重处罚。21岁及以上成年人的标准法定限制为0.08%。'},
  zhTW:{q:'如果您因血液酒精濃度（BAC）達到0.15%或更高而被定罪DUI，與標準DUI相比，您可能面臨什麼額外後果？',opts:['自動以重罪而非輕罪起訴','強制安裝點火互鎖裝置（IID）並加重處罰','永久吊銷駕照','自動60天監禁，沒有替代方案'],exp:'血液酒精濃度達到0.15%或更高（幾乎是法定限制的兩倍）會在加州觸發加重DUI處罰。這些包括更長的強制點火互鎖裝置（IID）安裝要求、更長的DUI學校、更長的駕照暫停以及可能更高的罰款。IID要求您在汽車啟動前向設備呼氣。BAC超過0.20%也適用加重處罰。21歲及以上成年人的標準法定限制為0.08%。'},
  es:{q:'Si es condenado por DUI con una concentración de alcohol en sangre (BAC) de 0.15% o más, ¿qué consecuencia adicional puede enfrentar en comparación con un DUI estándar?',opts:['Cargo automático de delito mayor en lugar de delito menor','Instalación obligatoria de un dispositivo de bloqueo de encendido (IID) y penalidades mejoradas','Revocación permanente de su licencia de conducir','Sentencia automática de 60 días de cárcel sin alternativas'],exp:'Un BAC de 0.15% o más (casi el doble del límite legal) desencadena penalidades mejoradas por DUI en California. Estas incluyen un requisito más largo de instalación obligatoria de IID, escuela de DUI más larga, suspensión de licencia más larga y posiblemente multas más altas. El IID requiere que respire en el dispositivo antes de que el auto arranque.'},
  ans:1
},
{
  id:546, cat:'highway',
  en:{q:'When entering a freeway from an on-ramp, what should you do?',opts:['Stop at the end of the on-ramp and wait for a gap in traffic','Merge immediately without adjusting your speed','Use the acceleration lane to match the speed of freeway traffic, then merge when safe','Honk to signal that you are merging'],exp:'When entering a freeway, use the on-ramp acceleration lane to speed up and match the speed of freeway traffic before merging. Signal your intention to merge. Look for a safe gap in traffic and merge smoothly. Freeway drivers should adjust to accommodate merging vehicles when safely possible, but entering drivers must yield to traffic already on the freeway. Never stop at the end of the ramp unless absolutely necessary — stopping creates a serious rear-end collision risk.'},
  zh:{q:'从匝道进入高速公路时，您应该怎么做？',opts:['在匝道末端停车，等待交通空档','立即合并，不调整速度','使用加速车道匹配高速公路交通速度，然后在安全时合并','鸣喇叭以示合并'],exp:'进入高速公路时，使用匝道加速车道加速，在合并前匹配高速公路交通速度。发出合并意图信号。寻找交通中的安全空档并顺畅合并。高速公路驾驶员应在安全可能时调整以容纳合并车辆，但进入驾驶员必须向已在高速公路上的交通让行。除非绝对必要，否则永远不要在匝道末端停车——停车会产生严重的追尾碰撞风险。'},
  zhTW:{q:'從匝道進入高速公路時，您應該怎麼做？',opts:['在匝道末端停車，等待交通空擋','立即合並，不調整速度','使用加速車道匹配高速公路交通速度，然後在安全時合並','鳴喇叭以示合並'],exp:'進入高速公路時，使用匝道加速車道加速，在合並前匹配高速公路交通速度。發出合並意圖信號。尋找交通中的安全空擋並順暢合並。高速公路駕駛員應在安全可能時調整以容納合並車輛，但進入駕駛員必須向已在高速公路上的交通讓行。除非絕對必要，否則永遠不要在匝道末端停車——停車會產生嚴重的追尾碰撞風險。'},
  es:{q:'Al entrar a una autopista desde una rampa de entrada, ¿qué debe hacer?',opts:['Detenerse al final de la rampa y esperar un hueco en el tráfico','Fusionarse inmediatamente sin ajustar su velocidad','Usar el carril de aceleración para igualar la velocidad del tráfico de la autopista, luego fusionarse cuando sea seguro','Tocar la bocina para señalar que se está fusionando'],exp:'Al entrar a una autopista, use el carril de aceleración de la rampa para acelerar e igualar la velocidad del tráfico de la autopista antes de fusionarse. Señale su intención de fusionarse. Busque un hueco seguro en el tráfico y fusionese sin problemas. Nunca se detenga al final de la rampa a menos que sea absolutamente necesario.'},
  ans:2
},
{
  id:547, cat:'safety',
  en:{q:'What should you do if your accelerator (gas pedal) sticks while you are driving?',opts:['Immediately turn off the ignition','Shift to neutral, steer safely to the side of the road, brake, and signal for help','Pump the brakes repeatedly until the car stops','Open the door and jump out'],exp:'If your accelerator sticks: 1) Keep your eyes on the road. 2) Shift the transmission to neutral — this disconnects the engine power from the wheels. 3) Brake firmly and steer safely to the right side of the road. 4) Turn on your hazard lights and signal for help once stopped. 5) Do not turn off the ignition while moving — this would lock the steering wheel. Turning off the ignition should only be done if shifting to neutral fails and as a last resort.'},
  zh:{q:'如果在驾驶时油门（油门踏板）卡住了，您应该怎么做？',opts:['立即关闭点火装置','换到空挡，安全驶向路边，刹车，并发出求助信号','反复踩刹车直到车停下','打开车门跳出去'],exp:'如果油门卡住了：1）保持眼睛在路上。2）将变速器换到空挡——这会断开发动机动力与车轮的连接。3）用力刹车并安全驶向道路右侧。4）停车后打开危险灯并发出求助信号。5）移动时不要关闭点火装置——这会锁定方向盘。只有在换空挡失败时才应作为最后手段关闭点火装置。'},
  zhTW:{q:'如果在駕駛時油門（油門踏板）卡住了，您應該怎麼做？',opts:['立即關閉點火裝置','換到空檔，安全駛向路邊，刹車，並發出求助信號','反覆踩刹車直到車停下','打開車門跳出去'],exp:'如果油門卡住了：1）保持眼睛在路上。2）將變速器換到空檔——這會斷開發動機動力與車輪的連接。3）用力刹車並安全駛向道路右側。4）停車後打開危險燈並發出求助信號。5）移動時不要關閉點火裝置——這會鎖定方向盤。只有在換空檔失敗時才應作為最後手段關閉點火裝置。'},
  es:{q:'¿Qué debe hacer si el acelerador (pedal del gas) se queda atascado mientras conduce?',opts:['Apague inmediatamente el encendido','Cambie a neutral, dirija con seguridad hacia el lado de la carretera, frene y señale pidiendo ayuda','Bombee los frenos repetidamente hasta que el auto se detenga','Abra la puerta y salte'],exp:'Si su acelerador se atasca: 1) Mantenga los ojos en la carretera. 2) Cambie la transmisión a neutral — esto desconecta la potencia del motor de las ruedas. 3) Frene firmemente y dirija con seguridad al lado derecho de la carretera. 4) Encienda las luces de emergencia y señale pidiendo ayuda una vez detenido. 5) No apague el encendido mientras esté en movimiento — esto bloquearía el volante.'},
  ans:1
},
{
  id:548, cat:'laws',
  en:{q:'In California, at what age can a passenger ride in the front seat of a vehicle without special restrictions?',opts:['Any age if they can reach the seatbelt','8 years old','At least 4 feet 9 inches tall regardless of age','There are no front-seat age restrictions in California'],exp:'Children under 8 years old must be secured in a car seat or booster seat in the BACK seat of the vehicle. At age 8 OR when a child reaches 4 feet 9 inches tall (whichever comes first), the child may use a regular seatbelt and can sit in the front seat. Children should remain in the back seat as long as possible for safety — front airbags can injure small children. There is no law prohibiting any child from the front seat at age 8+, but back seat is still safest.'},
  zh:{q:'在加州，乘客在什么年龄可以在没有特殊限制的情况下坐在车辆前排？',opts:['任何年龄，只要能系上安全带','8岁','无论年龄，至少4英尺9英寸高','加州没有前排座位年龄限制'],exp:'8岁以下儿童必须在车辆后排座位使用儿童安全座椅或增高座椅。当孩子满8岁或达到4英尺9英寸高（以先到为准）时，可以使用普通安全带，也可以坐在前排。为了安全，儿童应尽可能长时间待在后座——前排安全气囊可能伤害小儿童。没有法律禁止8岁及以上儿童坐前排，但后座仍然是最安全的。'},
  zhTW:{q:'在加州，乘客在什麼年齡可以在沒有特殊限制的情況下坐在車輛前排？',opts:['任何年齡，只要能系上安全帶','8歲','無論年齡，至少4英尺9英寸高','加州沒有前排座位年齡限制'],exp:'8歲以下兒童必須在車輛後排座位使用兒童安全座椅或增高座椅。當孩子滿8歲或達到4英尺9英寸高（以先到為準）時，可以使用普通安全帶，也可以坐在前排。為了安全，兒童應盡可能長時間待在後座——前排安全氣囊可能傷害小兒童。沒有法律禁止8歲及以上兒童坐前排，但後座仍然是最安全的。'},
  es:{q:'En California, ¿a qué edad puede un pasajero sentarse en el asiento delantero de un vehículo sin restricciones especiales?',opts:['Cualquier edad si puede alcanzar el cinturón de seguridad','8 años','Al menos 4 pies 9 pulgadas de altura sin importar la edad','No hay restricciones de edad para el asiento delantero en California'],exp:'Los niños menores de 8 años deben estar asegurados en un asiento de seguridad o de elevación en el asiento TRASERO del vehículo. A los 8 años O cuando un niño alcanza 4 pies 9 pulgadas (lo que ocurra primero), el niño puede usar un cinturón de seguridad regular y puede sentarse en el asiento delantero. Los niños deben permanecer en el asiento trasero el mayor tiempo posible por seguridad.'},
  ans:1
},
{
  id:549, cat:'signs',
  en:{q:'A sign with an orange background is most commonly associated with what?',opts:['Recreational areas and scenic routes','Work zones and road construction','School zones and crosswalks','Warnings about curves and hazards'],exp:'Orange signs are used for construction and work zone warnings. They alert drivers to temporary conditions such as lane closures, road work, detours, and the presence of workers. Speed limits are often reduced in work zones (and fines can be doubled). Orange cones, barrels, and signs mark the boundaries of work zones. Drivers must obey all orange signs and flaggers. Hitting a worker in a work zone can result in criminal charges in addition to traffic penalties.'},
  zh:{q:'橙色背景的标志最常与什么相关联？',opts:['休闲区和风景路线','工作区和道路施工','学区和人行横道','关于弯道和危险的警告'],exp:'橙色标志用于施工和工作区警告。它们提醒驾驶员注意临时情况，如车道封闭、道路施工、绕行和工人的存在。工作区内的限速通常会降低（罚款可能加倍）。橙色锥形、桶形和标志标记工作区的边界。驾驶员必须遵守所有橙色标志和旗手。在工作区撞到工人除了交通处罚外还可能导致刑事指控。'},
  zhTW:{q:'橙色背景的標誌最常與什麼相關聯？',opts:['休閒區和風景路線','工作區和道路施工','學區和人行橫道','關於彎道和危險的警告'],exp:'橙色標誌用於施工和工作區警告。它們提醒駕駛員注意臨時情況，如車道封閉、道路施工、繞行和工人的存在。工作區內的限速通常會降低（罰款可能加倍）。橙色錐形、桶形和標誌標記工作區的邊界。駕駛員必須遵守所有橙色標誌和旗手。在工作區撞到工人除了交通處罰外還可能導致刑事指控。'},
  es:{q:'Un letrero con fondo naranja está más comúnmente asociado con ¿qué?',opts:['Áreas recreativas y rutas escénicas','Zonas de trabajo y construcción de carreteras','Zonas escolares y cruces de peatones','Advertencias sobre curvas y peligros'],exp:'Los letreros naranjas se usan para advertencias en zonas de construcción y trabajo. Alertan a los conductores sobre condiciones temporales como cierres de carriles, trabajos en carreteras, desvíos y la presencia de trabajadores. Los límites de velocidad a menudo se reducen en las zonas de trabajo (y las multas pueden duplicarse). Los conos, barriles y letreros naranjas marcan los límites de las zonas de trabajo.'},
  ans:1
},
{
  id:550, cat:'safety',
  en:{q:'What is the safest action to take if you become drowsy while driving on a highway?',opts:['Open the window and turn up the music to stay awake','Drink coffee or an energy drink while driving','Pull off at the next exit or rest area and sleep for at least 15–20 minutes','Increase your speed so you arrive at your destination faster'],exp:'If you become drowsy while driving, the only truly safe option is to stop driving and rest. Pull off at the next exit or rest area and sleep for at least 15–20 minutes. Brief naps of 15–20 minutes are shown to significantly improve alertness. Opening windows, loud music, and caffeine may provide short-term relief but are not reliable. Drowsy driving is as dangerous as drunk driving — reaction time, awareness, and decision-making are all impaired. Never push through drowsiness on a highway.'},
  zh:{q:'如果您在高速公路驾驶时感到困倦，最安全的做法是什么？',opts:['打开车窗并调大音乐声以保持清醒','一边开车一边喝咖啡或能量饮料','在下一个出口或休息区停车，至少睡15-20分钟','加快速度以便更快到达目的地'],exp:'如果在驾驶时感到困倦，唯一真正安全的选择是停止驾驶并休息。在下一个出口或休息区停车，至少睡15-20分钟。研究表明，15-20分钟的短暂小睡可以显著提高警觉性。打开车窗、嘈杂的音乐和咖啡因可能提供短期缓解，但并不可靠。疲劳驾驶和醉酒驾驶一样危险——反应时间、意识和决策能力都会受损。永远不要在高速公路上忍受困倦继续驾驶。'},
  zhTW:{q:'如果您在高速公路駕駛時感到困倦，最安全的做法是什麼？',opts:['打開車窗並調大音樂聲以保持清醒','一邊開車一邊喝咖啡或能量飲料','在下一個出口或休息區停車，至少睡15-20分鐘','加快速度以便更快到達目的地'],exp:'如果在駕駛時感到困倦，唯一真正安全的選擇是停止駕駛並休息。在下一個出口或休息區停車，至少睡15-20分鐘。研究表明，15-20分鐘的短暫小睡可以顯著提高警覺性。打開車窗、嘈雜的音樂和咖啡因可能提供短期緩解，但並不可靠。疲勞駕駛和醉酒駕駛一樣危險——反應時間、意識和決策能力都會受損。永遠不要在高速公路上忍受困倦繼續駕駛。'},
...
,
{
  ...
  zh:{q:'在加州搬到新地址后，您必须怎么做？',opts:['什么都不用做——可以在下次续期时更新地址','搬家后10天内通知DMV','搬家后30天内通知DMV','只有收到罚单时才需要通知DMV'],exp:'加州法律要求您在搬家后10天内通知DMV您的新地址。您可以在线、邮寄或亲自办理。您的驾照不需要立即更换，但您必须保持DMV记录的地址是最新的。不通知DMV可能导致收不到重要通知（如注册续期或驾照暂停通知）。您的车辆注册地址也必须保持最新。'},
  zhTW:{q:'在加州搬到新地址後，您必須怎麼做？',opts:['什麼都不用做——可以在下次續期時更新地址','搬家後10天內通知DMV','搬家後30天內通知DMV','只有收到罰單時才需要通知DMV'],exp:'加州法律要求您在搬家後10天內通知DMV您的新地址。您可以在線、郵寄或親自辦理。您的駕照不需要立即更換，但您必須保持DMV記錄的地址是最新的。不通知DMV可能導致收不到重要通知（如注冊續期或駕照暫停通知）。您的車輛注冊地址也必須保持最新。'},
  es:{q:'¿Qué debe hacer cuando se muda a una nueva dirección en California?',opts:['Nada — puede actualizar su dirección en su próxima renovación','Notificar al DMV dentro de los 10 días de mudarse','Notificar al DMV dentro de los 30 días de mudarse','Solo notificar al DMV si recibe una multa'],exp:'La ley de California requiere que notifique al DMV de su nueva dirección dentro de los 10 días de mudarse. Puede hacerlo en línea, por correo o en persona. Su licencia de conducir no necesita ser reemplazada de inmediato, pero debe mantener su dirección actualizada con el DMV. No notificar al DMV puede resultar en no recibir avisos importantes.'},
  ans:1
},
{
  id:552, cat:'signs',
  en:{q:'What does a flashing yellow light at an intersection mean?',opts:['Stop completely, then proceed when safe','Yield and proceed with caution','The traffic light is broken — treat it as a 4-way stop','Speed up to clear the intersection before the light turns red'],exp:'A flashing yellow light means you should slow down, yield if necessary, and proceed with caution. You do not need to stop for a flashing yellow light unless required by other conditions (such as pedestrians or crossing traffic). Flashing yellow lights are used at intersections where cross traffic is controlled by a different signal or stop sign. A flashing RED light, by contrast, means stop completely and proceed when safe — like a stop sign.'},
  zh:{q:'路口的黄色闪烁灯意味着什么？',opts:['完全停车，然后在安全时继续行驶','谨慎让行','交通灯坏了——将其视为四路停车','加速穿越路口，以免灯变红'],exp:'黄色闪烁灯意味着您应该减速，必要时让行，并谨慎行驶。除非其他条件（如行人或横穿交通）要求，否则不需要在黄色闪烁灯前停车。黄色闪烁灯用于交叉交通由不同信号或停止标志控制的路口。相比之下，红色闪烁灯意味着完全停车并在安全时继续行驶——就像停止标志一样。'},
  zhTW:{q:'路口的黃色閃爍燈意味著什麼？',opts:['完全停車，然後在安全時繼續行駛','謹慎讓行','交通燈壞了——將其視為四路停車','加速穿越路口，以免燈變紅'],exp:'黃色閃爍燈意味著您應該減速，必要時讓行，並謹慎行駛。除非其他條件（如行人或橫穿交通）要求，否則不需要在黃色閃爍燈前停車。黃色閃爍燈用於交叉交通由不同信號或停止標誌控制的路口。相比之下，紅色閃爍燈意味著完全停車並在安全時繼續行駛——就像停止標誌一樣。'},
  es:{q:'¿Qué significa una luz amarilla intermitente en una intersección?',opts:['Detenga completamente, luego proceda cuando sea seguro','Ceda y proceda con precaución','El semáforo está roto — trátelo como una parada de 4 vías','Acelere para cruzar la intersección antes de que la luz se ponga roja'],exp:'Una luz amarilla intermitente significa que debe reducir la velocidad, ceder si es necesario y proceder con precaución. No necesita detenerse para una luz amarilla intermitente a menos que otras condiciones lo requieran. Las luces amarillas intermitentes se usan en intersecciones donde el tráfico cruzado está controlado por una señal diferente o señal de stop. Una luz ROJA intermitente, por el contrario, significa detenerse completamente y proceder cuando sea seguro.'},
  ans:1
},
{
  id:553, cat:'rightofway',
  en:{q:'You are in a roundabout (traffic circle). A vehicle outside the roundabout wants to enter. Who has the right of way?',opts:['The entering vehicle — they were waiting longer','Vehicles inside the roundabout have the right of way','Whichever vehicle is larger','They must negotiate and take turns'],exp:'In a roundabout (traffic circle), vehicles already circulating inside the roundabout have the right of way. Entering vehicles must yield to all vehicles already in the roundabout. Enter when there is a safe gap in the circulating traffic. In a roundabout, traffic flows counterclockwise, you do not stop inside the roundabout (unless for a pedestrian), and you must signal when exiting. Roundabouts are designed to reduce serious accidents by eliminating high-speed crossing conflicts.'},
  zh:{q:'您在环形交叉路口（交通圈）中。环形交叉路口外的车辆想要进入。谁有先行权？',opts:['进入的车辆——他们等待的时间更长','环形交叉路口内的车辆有先行权','无论哪辆车更大','他们必须协商并轮流'],exp:'在环形交叉路口（交通圈）中，已经在环形交叉路口内循环的车辆有先行权。进入的车辆必须向环形交叉路口内所有车辆让行。在循环交通中有安全空档时进入。在环形交叉路口中，交通逆时针流动，不在环形交叉路口内停车（除非为了行人），退出时必须发出信号。环形交叉路口旨在通过消除高速交叉冲突来减少严重事故。'},
  zhTW:{q:'您在環形交叉路口（交通圈）中。環形交叉路口外的車輛想要進入。誰有先行權？',opts:['進入的車輛——他們等待的時間更長','環形交叉路口內的車輛有先行權','無論哪輛車更大','他們必須協商並輪流'],exp:'在環形交叉路口（交通圈）中，已經在環形交叉路口內循環的車輛有先行權。進入的車輛必須向環形交叉路口內所有車輛讓行。在循環交通中有安全空擋時進入。在環形交叉路口中，交通逆時針流動，不在環形交叉路口內停車（除非為了行人），退出時必須發出信號。環形交叉路口旨在通過消除高速交叉衝突來減少嚴重事故。'},
  es:{q:'Está en una rotonda (glorieta). Un vehículo fuera de la rotonda quiere entrar. ¿Quién tiene el derecho de paso?',opts:['El vehículo que entra — han estado esperando más tiempo','Los vehículos dentro de la rotonda tienen el derecho de paso','El vehículo que sea más grande','Deben negociar y turnarse'],exp:'En una rotonda, los vehículos que ya circulan dentro de la rotonda tienen el derecho de paso. Los vehículos que entran deben ceder a todos los vehículos que ya están en la rotonda. Entre cuando haya un espacio seguro en el tráfico circulante. En una rotonda, el tráfico fluye en sentido antihorario y debe señalizar al salir.'},
  ans:1
},
{
  id:554, cat:'speed',
  en:{q:'In California, is it legal to exceed the posted speed limit to pass another vehicle?',opts:['Yes, briefly exceeding the limit is permitted when passing','Yes, but only on two-lane roads','No — you must stay within the posted speed limit at all times','Only if the other vehicle is going below the speed limit'],exp:'No, you may not exceed the posted speed limit to pass another vehicle, even on a two-lane road. If you cannot safely pass while staying within the speed limit, wait for a better opportunity. Speeding to pass is illegal and dangerous. On a two-lane road, you should only pass when: the road ahead is clear, there is no solid yellow line on your side, there is sufficient distance, and you can complete the pass safely and legally without exceeding the speed limit.'},
  zh:{q:'在加州，超过张贴限速以超越另一辆车是合法的吗？',opts:['是的，超车时短暂超速是允许的','是的，但只在双车道道路上','不——您必须始终在张贴限速内行驶','只有当另一辆车低于限速时'],exp:'不，即使在双车道道路上，您也不得超过张贴限速来超越另一辆车。如果在限速内无法安全超车，等待更好的时机。超速超车是违法且危险的。在双车道道路上，只有在以下情况才应该超车：前方道路畅通，您一侧没有实黄线，有足够距离，并且您可以在不超速的情况下安全合法地完成超车。'},
  zhTW:{q:'在加州，超過張貼限速以超越另一輛車是合法的嗎？',opts:['是的，超車時短暫超速是允許的','是的，但只在雙車道道路上','不——您必須始終在張貼限速內行駛','只有當另一輛車低於限速時'],exp:'不，即使在雙車道道路上，您也不得超過張貼限速來超越另一輛車。如果在限速內無法安全超車，等待更好的時機。超速超車是違法且危險的。在雙車道道路上，只有在以下情況才應該超車：前方道路暢通，您一側沒有實黃線，有足夠距離，並且您可以在不超速的情況下安全合法地完成超車。'},
  es:{q:'En California, ¿es legal exceder el límite de velocidad publicado para adelantar a otro vehículo?',opts:['Sí, exceder brevemente el límite está permitido al adelantar','Sí, pero solo en carreteras de dos carriles','No — debe mantenerse dentro del límite de velocidad publicado en todo momento','Solo si el otro vehículo va por debajo del límite de velocidad'],exp:'No, no puede exceder el límite de velocidad publicado para adelantar a otro vehículo, incluso en una carretera de dos carriles. Si no puede adelantar de forma segura dentro del límite de velocidad, espere una mejor oportunidad. Acelerar para adelantar es ilegal y peligroso.'},
  ans:2
},
{
  id:555, cat:'dui',
  en:{q:'What is the legal BAC (blood alcohol concentration) limit for a person 21 or older operating a commercial motor vehicle in California?',opts:['0.08%','0.04%','0.01%','0.10%'],exp:'For commercial vehicle drivers (operating vehicles requiring a commercial driver\'s license), the legal BAC limit is 0.04% — half the standard limit for non-commercial drivers. This applies while driving a commercial vehicle, regardless of whether you have a CDL. The stricter limit reflects the greater responsibility and risk associated with large commercial vehicles. For non-commercial drivers 21+, the limit is 0.08%. For drivers under 21, any measurable BAC (0.01%) is illegal.'},
  zh:{q:'在加州，21岁或以上驾驶商业机动车的人的合法BAC（血液酒精浓度）限制是多少？',opts:['0.08%','0.04%','0.01%','0.10%'],exp:'对于商业车辆驾驶员（驾驶需要商业驾驶执照的车辆），合法BAC限制为0.04%——非商业驾驶员标准限制的一半。这适用于驾驶商业车辆时，无论您是否持有CDL。更严格的限制反映了与大型商业车辆相关的更大责任和风险。21岁以上非商业驾驶员的限制为0.08%。21岁以下驾驶员，任何可测量的BAC（0.01%）都是违法的。'},
  zhTW:{q:'在加州，21歲或以上駕駛商業機動車的人的合法BAC（血液酒精濃度）限制是多少？',opts:['0.08%','0.04%','0.01%','0.10%'],exp:'對於商業車輛駕駛員（駕駛需要商業駕駛執照的車輛），合法BAC限制為0.04%——非商業駕駛員標準限制的一半。這適用於駕駛商業車輛時，無論您是否持有CDL。更嚴格的限制反映了與大型商業車輛相關的更大責任和風險。21歲以上非商業駕駛員的限制為0.08%。21歲以下駕駛員，任何可測量的BAC（0.01%）都是違法的。'},
  es:{q:'¿Cuál es el límite legal de BAC (concentración de alcohol en sangre) para una persona de 21 años o más que opera un vehículo motorizado comercial en California?',opts:['0.08%','0.04%','0.01%','0.10%'],exp:'Para los conductores de vehículos comerciales (que operan vehículos que requieren una licencia de conductor comercial), el límite legal de BAC es de 0.04% — la mitad del límite estándar para conductores no comerciales. Esto aplica al conducir un vehículo comercial, independientemente de si tiene un CDL. Para conductores no comerciales de 21+, el límite es 0.08%. Para conductores menores de 21 años, cualquier BAC medible (0.01%) es ilegal.'},
  ans:1
},
{
  id:556, cat:'parking',
  en:{q:'What does a yellow curb mean?',opts:['No parking at any time','Parking for 30 minutes maximum at all hours','Stop only long enough to load or unload passengers or freight — usually limited to commercial vehicles during certain hours','Parking for disabled persons only'],exp:'A yellow curb means you may stop only long enough to load or unload passengers or freight. Typically, yellow curbs are limited to commercial vehicles during posted hours, but restrictions can vary. You should not park and leave your vehicle at a yellow curb. Drivers of non-commercial vehicles may stop briefly to drop off or pick up cargo or people if signs indicate this is permitted. Always check posted signs near yellow curbs for specific time and vehicle restrictions.'},
  zh:{q:'黄色路缘代表什么？',opts:['任何时候禁止停车','任何时间最多停车30分钟','仅允许停留足够长时间以装卸乘客或货物——通常限于特定时段的商业车辆','仅供残疾人停车'],exp:'黄色路缘意味着您只能停留足够长时间来装卸乘客或货物。通常，黄色路缘在张贴时段内仅限商业车辆使用，但限制可能有所不同。您不应在黄色路缘处停车离开。如果标志表明允许，非商业车辆驾驶员可以短暂停车卸货或接送人。请始终检查黄色路缘附近张贴的标志，了解具体的时间和车辆限制。'},
  zhTW:{q:'黃色路緣代表什麼？',opts:['任何時候禁止停車','任何時間最多停車30分鐘','僅允許停留足夠長時間以裝卸乘客或貨物——通常限於特定時段的商業車輛','僅供殘疾人停車'],exp:'黃色路緣意味著您只能停留足夠長時間來裝卸乘客或貨物。通常，黃色路緣在張貼時段內僅限商業車輛使用，但限制可能有所不同。您不應在黃色路緣處停車離開。如果標誌表明允許，非商業車輛駕駛員可以短暫停車卸貨或接送人。請始終檢查黃色路緣附近張貼的標誌，了解具體的時間和車輛限制。'},
  es:{q:'¿Qué significa un bordillo amarillo?',opts:['No estacionar en ningún momento','Estacionamiento máximo de 30 minutos a todas horas','Detenerse solo el tiempo suficiente para cargar o descargar pasajeros o carga — generalmente limitado a vehículos comerciales durante ciertas horas','Estacionamiento solo para personas con discapacidad'],exp:'Un bordillo amarillo significa que puede detenerse solo el tiempo suficiente para cargar o descargar pasajeros o carga. Típicamente, los bordillos amarillos están limitados a vehículos comerciales durante las horas publicadas, pero las restricciones pueden variar. No debe estacionar y dejar su vehículo en un bordillo amarillo. Siempre verifique los letreros publicados cerca de los bordillos amarillos.'},
  ans:2
},
{
  id:557, cat:'highway',
  en:{q:'On a multi-lane freeway, which lane should slow-moving vehicles use?',opts:['The leftmost (fast) lane','Any lane — all lanes are equal','The rightmost lane','The center lane'],exp:'Slow-moving vehicles should use the rightmost (right) lane on a freeway. The left lanes are for faster-moving traffic and passing. California law prohibits driving in the far-left lane on a freeway with three or more lanes at a speed that is slower than normal traffic flow, causing other cars to overtake on the right. Blocking the fast lane is dangerous and inconsiderate. The general rule is to keep right except to pass.'},
  zh:{q:'在多车道高速公路上，慢速车辆应该使用哪条车道？',opts:['最左侧（快速）车道','任何车道——所有车道都相同','最右侧车道','中间车道'],exp:'慢速车辆应该使用高速公路上最右侧（右侧）车道。左侧车道是为速度较快的交通和超车而设。加州法律禁止在有三条或更多车道的高速公路上，以低于正常交通流速度在最左侧车道行驶，导致其他车辆从右侧超越。阻塞快速车道是危险且不礼貌的。一般规则是除非超车，否则靠右行驶。'},
  zhTW:{q:'在多車道高速公路上，慢速車輛應該使用哪條車道？',opts:['最左側（快速）車道','任何車道——所有車道都相同','最右側車道','中間車道'],exp:'慢速車輛應該使用高速公路上最右側（右側）車道。左側車道是為速度較快的交通和超車而設。加州法律禁止在有三條或更多車道的高速公路上，以低於正常交通流速度在最左側車道行駛，導致其他車輛從右側超越。阻塞快速車道是危險且不禮貌的。一般規則是除非超車，否則靠右行駛。'},
  es:{q:'En una autopista de múltiples carriles, ¿qué carril deben usar los vehículos de movimiento lento?',opts:['El carril izquierdo (rápido)','Cualquier carril — todos los carriles son iguales','El carril derecho','El carril del centro'],exp:'Los vehículos de movimiento lento deben usar el carril derecho en una autopista. Los carriles izquierdos son para el tráfico más rápido y para adelantar. La ley de California prohíbe conducir en el carril izquierdo a una velocidad más lenta que el flujo normal del tráfico en autopistas con tres o más carriles. La regla general es mantenerse a la derecha excepto para adelantar.'},
  ans:2
},
{
  id:558, cat:'safety',
  en:{q:'What does "hydroplaning" mean, and what should you do if it happens?',opts:['Your tires overheat — pull over and let them cool','Your vehicle skims on a layer of water, losing traction — ease off the gas, do not brake hard, and steer straight until traction returns','Your vehicle surges forward unexpectedly — shift to neutral','Your windshield fogs up — turn on the defroster'],exp:'Hydroplaning occurs when your tires ride on a film of water rather than the road surface, causing a sudden loss of steering and braking control. If you hydroplane: ease off the accelerator gently (do not brake hard or steer sharply — these can cause you to spin), steer straight, and wait for traction to return. Reduce speed in rain, avoid driving through standing water, keep tires properly inflated, and replace worn tires to reduce hydroplaning risk.'},
  zh:{q:'"水滑"是什么意思，如果发生这种情况您应该怎么做？',opts:['您的轮胎过热——靠边停车，让其冷却','您的车辆在一层水上滑行，失去牵引力——松开油门，不要猛踩刹车，并保持直线行驶直到牵引力恢复','您的车辆意外向前冲——换到空挡','您的挡风玻璃起雾——打开除霜器'],exp:'当轮胎在水膜上而不是路面上行驶时，会发生水滑现象，导致转向和制动控制突然失控。如果发生水滑：轻轻松开加速踏板（不要猛踩刹车或急转方向盘——这些可能导致您打转），保持直线行驶，等待牵引力恢复。在雨天减速，避免在积水中行驶，保持轮胎气压适当，更换磨损的轮胎以降低水滑风险。'},
  zhTW:{q:'「水滑」是什麼意思，如果發生這種情況您應該怎麼做？',opts:['您的輪胎過熱——靠邊停車，讓其冷卻','您的車輛在一層水上滑行，失去牽引力——鬆開油門，不要猛踩刹車，並保持直線行駛直到牽引力恢復','您的車輛意外向前衝——換到空檔','您的擋風玻璃起霧——打開除霜器'],exp:'當輪胎在水膜上而不是路面上行駛時，會發生水滑現象，導致轉向和制動控制突然失控。如果發生水滑：輕輕鬆開加速踏板（不要猛踩刹車或急轉方向盤——這些可能導致您打轉），保持直線行駛，等待牽引力恢復。在雨天減速，避免在積水中行駛，保持輪胎氣壓適當，更換磨損的輪胎以降低水滑風險。'},
  es:{q:'¿Qué significa "aquaplaning" y qué debe hacer si ocurre?',opts:['Sus neumáticos se sobrecalientan — deténgase y déjelos enfriar','Su vehículo se desliza sobre una capa de agua, perdiendo tracción — suelte el gas, no frene fuerte y dirija recto hasta que vuelva la tracción','Su vehículo avanza inesperadamente — cambie a neutral','Su parabrisas se empaña — encienda el desempañador'],exp:'El aquaplaning ocurre cuando sus neumáticos van sobre una película de agua en lugar de la superficie de la carretera, causando una pérdida repentina del control de dirección y frenado. Si hace aquaplaning: suelte el acelerador suavemente (no frene fuerte ni gire bruscamente — esto puede hacer que gire), dirija recto y espere a que regrese la tracción. Reduzca la velocidad en la lluvia y evite conducir por agua estancada.'},
  ans:1
},
{
  id:559, cat:'signs',
  en:{q:'You see a sign that reads "YIELD". What are you required to do?',opts:['Come to a complete stop, then proceed when safe','Slow down and be prepared to stop if necessary to let traffic or pedestrians go first','Keep your speed but be watchful','Stop only if another vehicle is directly in your path'],exp:'A YIELD sign requires you to slow down and be prepared to stop if necessary. You must give the right of way to vehicles and pedestrians in the intersection or crosswalk you are approaching. If there is no conflict — no vehicles or pedestrians requiring you to stop — you may proceed without stopping. Unlike a STOP sign, you are not required to stop at a YIELD sign unless necessary. Yield signs are common at freeway ramps, roundabouts, and some minor street intersections.'},
  zh:{q:'您看到一个写着"YIELD（让行）"的标志。您被要求做什么？',opts:['完全停车，然后在安全时继续行驶','减速并准备必要时停车，让交通或行人先行','保持速度但保持警惕','只有当另一辆车直接在您的路径中时才停车'],exp:'"YIELD"标志要求您减速并在必要时准备停车。您必须向您正在接近的路口或人行横道中的车辆和行人让行。如果没有冲突——没有需要您停车的车辆或行人——您可以不停车继续行驶。与停止标志不同，除非必要，否则不需要在让行标志前停车。让行标志常见于高速公路匝道、环形交叉路口和一些次要街道路口。'},
  zhTW:{q:'您看到一個寫著「YIELD（讓行）」的標誌。您被要求做什麼？',opts:['完全停車，然後在安全時繼續行駛','減速並準備必要時停車，讓交通或行人先行','保持速度但保持警惕','只有當另一輛車直接在您的路徑中時才停車'],exp:'「YIELD」標誌要求您減速並在必要時準備停車。您必須向您正在接近的路口或人行橫道中的車輛和行人讓行。如果沒有衝突——沒有需要您停車的車輛或行人——您可以不停車繼續行駛。與停止標誌不同，除非必要，否則不需要在讓行標誌前停車。讓行標誌常見於高速公路匝道、環形交叉路口和一些次要街道路口。'},
  es:{q:'Ve un letrero que dice "YIELD (CEDA EL PASO)". ¿Qué debe hacer?',opts:['Detenerse por completo, luego proceder cuando sea seguro','Reducir la velocidad y estar preparado para detenerse si es necesario para dejar pasar el tráfico o los peatones primero','Mantener su velocidad pero estar atento','Detenerse solo si otro vehículo está directamente en su camino'],exp:'Un letrero de CEDA EL PASO requiere que reduzca la velocidad y esté preparado para detenerse si es necesario. Debe dar el derecho de paso a vehículos y peatones en la intersección o cruce que se aproxima. Si no hay conflicto, puede proceder sin detenerse. A diferencia de un letrero de STOP, no está obligado a detenerse en un letrero de YIELD a menos que sea necesario.'},
  ans:1
},
{
  id:560, cat:'laws',
  en:{q:'When are you required to use your headlights in California?',opts:['Only at night (after sunset and before sunrise)','From 30 minutes after sunset to 30 minutes before sunrise, and any time visibility is less than 1,000 feet','Whenever it is raining, snowing, or foggy','Only when driving on unlit roads at night'],exp:'California law requires headlights to be on from 30 minutes after sunset to 30 minutes before sunrise. Headlights are also required any time visibility is less than 1,000 feet due to weather (fog, rain, snow, dust) or other conditions. California also requires headlights when wipers are in continuous use (not just intermittent use). DRL (daytime running lights) alone do not satisfy the headlight requirement — you must have full headlights including taillights.'},
  zh:{q:'在加州，您何时被要求使用车头灯？',opts:['仅在夜间（日落后和日出前）','从日落后30分钟到日出前30分钟，以及任何时候能见度不足1,000英尺时','每当下雨、下雪或有雾时','仅在夜间无照明道路上行驶时'],exp:'加州法律要求从日落后30分钟到日出前30分钟开启车头灯。当天气（雾、雨、雪、沙尘）或其他原因导致能见度不足1,000英尺时，也必须开启车头灯。加州还要求在雨刷连续使用（不仅仅是间歇使用）时开启车头灯。仅有白天行驶灯（DRL）不满足车头灯要求——您必须开启包括尾灯在内的全部车头灯。'},
  zhTW:{q:'在加州，您何時被要求使用車頭燈？',opts:['僅在夜間（日落後和日出前）','從日落後30分鐘到日出前30分鐘，以及任何時候能見度不足1,000英尺時','每當下雨、下雪或有霧時','僅在夜間無照明道路上行駛時'],exp:'加州法律要求從日落後30分鐘到日出前30分鐘開啟車頭燈。當天氣（霧、雨、雪、沙塵）或其他原因導致能見度不足1,000英尺時，也必須開啟車頭燈。加州還要求在雨刷連續使用（不僅僅是間歇使用）時開啟車頭燈。僅有白天行駛燈（DRL）不滿足車頭燈要求——您必須開啟包括尾燈在內的全部車頭燈。'},
...
,
{
  ...
  zh:{q:'您正在路口左转。一辆对向车辆直行。谁有先行权？',opts:['您——左转有优先权','直行的对向车辆','先打信号的人','取决于谁先到达路口'],exp:'左转时，您必须向直行的对向交通让行。直行的车辆始终优先于左转的车辆。这适用于有或无交通信号的路口。在完成左转之前，您必须等待对向交通中的安全空档。左转时未让行是路口碰撞的主要原因之一。'},
  zhTW:{q:'您正在路口左轉。一輛對向車輛直行。誰有先行權？',opts:['您——左轉有優先權','直行的對向車輛','先打信號的人','取決於誰先到達路口'],exp:'左轉時，您必須向直行的對向交通讓行。直行的車輛始終優先於左轉的車輛。這適用於有或無交通信號的路口。在完成左轉之前，您必須等待對向交通中的安全空擋。左轉時未讓行是路口碰撞的主要原因之一。'},
  es:{q:'Está girando a la izquierda en una intersección. Un vehículo que viene en sentido contrario va recto. ¿Quién tiene el derecho de paso?',opts:['Usted — los giros a la izquierda tienen prioridad','El vehículo que viene en sentido contrario y va recto','El que señale primero','Depende de quién llegó primero a la intersección'],exp:'Al girar a la izquierda, debe ceder al tráfico que viene en sentido contrario y va recto. Un vehículo que va recto siempre tiene el derecho de paso sobre un vehículo que gira a la izquierda. Esto aplica en intersecciones con o sin semáforos. Debe esperar un espacio seguro en el tráfico que viene antes de completar su giro a la izquierda.'},
  ans:1
},
{
  id:562, cat:'speed',
  en:{q:'What does the "Basic Speed Law" in California mean?',opts:['You must always drive at the posted speed limit exactly','You must drive at a speed that is safe for current conditions, even if below the posted limit','You may exceed the posted limit in good weather','The speed limit applies only to cars, not trucks'],exp:'California\'s Basic Speed Law states that a driver must never drive faster than is safe for current road conditions. Even if the posted speed limit is 65 mph, if weather, visibility, traffic, or road conditions make that speed unsafe, you must drive slower. Conversely, the posted limit is the maximum — you cannot exceed it even if conditions seem perfect. The Basic Speed Law means you can be cited for driving too fast for conditions even if you are under the posted limit.'},
  zh:{q:'加州的"基本限速法"是什么意思？',opts:['您必须始终以张贴限速精确行驶','您必须以在当前条件下安全的速度驾驶，即使低于张贴限速','在良好天气中您可以超过张贴限速','限速仅适用于汽车，不适用于卡车'],exp:'加州基本限速法规定，驾驶员在任何情况下都不得以超过当前道路条件安全速度的速度驾驶。即使张贴限速为65英里/小时，如果天气、能见度、交通或道路条件使该速度不安全，您也必须减慢速度。相反，张贴限速是最高限速——即使条件看起来完美，您也不能超过它。基本限速法意味着即使您低于张贴限速，如果速度对当前条件来说太快，您也可能被罚款。'},
  zhTW:{q:'加州的「基本限速法」是什麼意思？',opts:['您必須始終以張貼限速精確行駛','您必須以在當前條件下安全的速度駕駛，即使低於張貼限速','在良好天氣中您可以超過張貼限速','限速僅適用於汽車，不適用於卡車'],exp:'加州基本限速法規定，駕駛員在任何情況下都不得以超過當前道路條件安全速度的速度駕駛。即使張貼限速為65英里/小時，如果天氣、能見度、交通或道路條件使該速度不安全，您也必須減慢速度。相反，張貼限速是最高限速——即使條件看起來完美，您也不能超過它。基本限速法意味著即使您低於張貼限速，如果速度對當前條件來說太快，您也可能被罰款。'},
  es:{q:'¿Qué significa la "Ley de Velocidad Básica" en California?',opts:['Debe conducir siempre exactamente al límite de velocidad publicado','Debe conducir a una velocidad que sea segura para las condiciones actuales, incluso si es inferior al límite publicado','Puede exceder el límite publicado en buen clima','El límite de velocidad aplica solo a los autos, no a los camiones'],exp:'La Ley de Velocidad Básica de California establece que un conductor nunca debe conducir más rápido de lo que es seguro para las condiciones actuales de la carretera. Incluso si el límite de velocidad publicado es de 65 mph, si el clima, la visibilidad, el tráfico o las condiciones de la carretera hacen que esa velocidad sea insegura, debe conducir más despacio.'},
  ans:1
},
{
  id:563, cat:'dui',
  en:{q:'Can you be arrested for DUI in California even if your BAC is below 0.08%?',opts:['No — the law only allows DUI arrests at 0.08% BAC or higher','Yes — you can be arrested if your driving is impaired by alcohol or drugs regardless of BAC','No — below 0.08% is always legal','Only if you are under 21'],exp:'Yes. In California, you can be arrested and convicted of DUI if your driving ability is impaired by alcohol or drugs, even if your BAC is below 0.08%. The 0.08% limit is a per se standard — meaning you are automatically presumed impaired above that level — but impairment can exist at any BAC depending on the individual. Drug impairment (prescription, over-the-counter, or illegal drugs) can also result in a DUI regardless of alcohol BAC.'},
  zh:{q:'即使您的BAC低于0.08%，在加州也可能因DUI被捕吗？',opts:['不——法律只允许在BAC达到0.08%或更高时进行DUI逮捕','是的——无论BAC如何，如果您的驾驶能力因酒精或毒品受损，您可能被逮捕','不——低于0.08%始终合法','只有21岁以下'],exp:'是的。在加州，如果您的驾驶能力因酒精或毒品受损，即使BAC低于0.08%，您也可能因DUI被逮捕和定罪。0.08%限制是一个"本身"标准——意味着超过该水平自动推定受损——但受损可能在任何BAC下出现，取决于个人。无论酒精BAC如何，毒品损伤（处方药、非处方药或非法毒品）也可能导致DUI。'},
  zhTW:{q:'即使您的BAC低於0.08%，在加州也可能因DUI被捕嗎？',opts:['不——法律只允許在BAC達到0.08%或更高時進行DUI逮捕','是的——無論BAC如何，如果您的駕駛能力因酒精或毒品受損，您可能被逮捕','不——低於0.08%始終合法','只有21歲以下'],exp:'是的。在加州，如果您的駕駛能力因酒精或毒品受損，即使BAC低於0.08%，您也可能因DUI被逮捕和定罪。0.08%限制是一個「本身」標準——意味著超過該水平自動推定受損——但受損可能在任何BAC下出現，取決於個人。無論酒精BAC如何，毒品損傷（處方藥、非處方藥或非法毒品）也可能導致DUI。'},
  es:{q:'¿Puede ser arrestado por DUI en California incluso si su BAC está por debajo del 0.08%?',opts:['No — la ley solo permite arrestos por DUI con un BAC del 0.08% o más','Sí — puede ser arrestado si su capacidad de conducción está deteriorada por alcohol o drogas independientemente del BAC','No — por debajo del 0.08% siempre es legal','Solo si tiene menos de 21 años'],exp:'Sí. En California, puede ser arrestado y condenado por DUI si su capacidad de conducción está deteriorada por alcohol o drogas, incluso si su BAC está por debajo del 0.08%. El límite de 0.08% es un estándar "per se" — significa que automáticamente se presume deterioro por encima de ese nivel — pero el deterioro puede existir en cualquier BAC dependiendo del individuo.'},
  ans:1
},
{
  id:564, cat:'parking',
  en:{q:'How close to a fire hydrant may you legally park in California?',opts:['5 feet','10 feet','15 feet','25 feet'],exp:'In California, you must not park within 15 feet of a fire hydrant. This clearance ensures that fire trucks can quickly access the hydrant in an emergency. Parking too close to a hydrant is illegal and can result in your vehicle being towed and fined. If a fire truck needs access, firefighters are permitted to break windows to run hoses through your car if it is blocking the hydrant. The 15-foot rule applies on both sides of the hydrant.'},
  zh:{q:'在加州，您可以合法停车离消防栓多近？',opts:['5英尺','10英尺','15英尺','25英尺'],exp:'在加州，您不得在消防栓15英尺以内停车。这一间距确保消防车可以在紧急情况下快速访问消防栓。在消防栓附近停车太近是违法的，可能导致您的车被拖走和罚款。如果消防车需要通道，如果您的车阻挡了消防栓，消防员被允许打破窗户将水管穿过您的车。15英尺规则适用于消防栓两侧。'},
  zhTW:{q:'在加州，您可以合法停車離消防栓多近？',opts:['5英尺','10英尺','15英尺','25英尺'],exp:'在加州，您不得在消防栓15英尺以內停車。這一間距確保消防車可以在緊急情況下快速訪問消防栓。在消防栓附近停車太近是違法的，可能導致您的車被拖走和罰款。如果消防車需要通道，如果您的車阻擋了消防栓，消防員被允許打破窗戶將水管穿過您的車。15英尺規則適用於消防栓兩側。'},
  es:{q:'¿A qué distancia de una boca de incendios puede estacionar legalmente en California?',opts:['5 pies','10 pies','15 pies','25 pies'],exp:'En California, no debe estacionar dentro de los 15 pies de una boca de incendios. Este espacio libre asegura que los camiones de bomberos puedan acceder rápidamente a la boca de incendios en una emergencia. Estacionar demasiado cerca de una boca de incendios es ilegal y puede resultar en que su vehículo sea remolcado y multado. Los bomberos tienen permitido romper ventanas para pasar mangueras por su auto si bloquea la boca de incendios.'},
  ans:2
},
{
  id:565, cat:'highway',
  en:{q:'What should you do if you miss your freeway exit?',opts:['Brake hard and try to make the exit anyway','Reverse on the shoulder back to the exit','Continue to the next exit and use surface streets to return','Make a U-turn on the freeway as soon as it is safe'],exp:'If you miss your freeway exit, continue to the next exit. Do not stop, brake suddenly, back up, or make a U-turn on a freeway — all of these are dangerous and illegal. Sudden changes in speed or direction on a freeway can cause serious crashes at high speed. Plan your route in advance, stay in the right lane as you approach your exit, and watch for exit signs early. Missing an exit is a minor inconvenience; causing a crash trying to make it is catastrophic.'},
  zh:{q:'如果您错过了高速公路出口，您应该怎么做？',opts:['猛踩刹车，无论如何尝试走出口','在路肩倒车回到出口','继续到下一个出口，使用地面道路返回','在高速公路上在安全时立即调头'],exp:'如果您错过了高速公路出口，继续到下一个出口。不要在高速公路上停车、突然刹车、倒车或调头——所有这些都是危险且违法的。在高速公路上突然改变速度或方向可能在高速下造成严重事故。提前规划路线，在接近出口时保持在右侧车道，并尽早注意出口标志。错过出口是小事；在尝试赶出口时造成事故是灾难性的。'},
  zhTW:{q:'如果您錯過了高速公路出口，您應該怎麼做？',opts:['猛踩刹車，無論如何嘗試走出口','在路肩倒車回到出口','繼續到下一個出口，使用地面道路返回','在高速公路上在安全時立即調頭'],exp:'如果您錯過了高速公路出口，繼續到下一個出口。不要在高速公路上停車、突然刹車、倒車或調頭——所有這些都是危險且違法的。在高速公路上突然改變速度或方向可能在高速下造成嚴重事故。提前規劃路線，在接近出口時保持在右側車道，並盡早注意出口標誌。錯過出口是小事；在嘗試趕出口時造成事故是災難性的。'},
  es:{q:'¿Qué debe hacer si se pierde su salida de la autopista?',opts:['Frene fuerte e intente tomar la salida de todas formas','Retroceda en el arcén hasta la salida','Continúe hasta la siguiente salida y use carreteras secundarias para regresar','Haga un giro en U en la autopista tan pronto como sea seguro'],exp:'Si se pierde su salida de la autopista, continúe hasta la siguiente salida. No se detenga, frene repentinamente, retroceda ni haga un giro en U en una autopista — todo esto es peligroso e ilegal. Los cambios repentinos de velocidad o dirección en una autopista pueden causar accidentes graves a alta velocidad. Perderse una salida es un inconveniente menor; causar un accidente al intentar tomarla es catastrófico.'},
  ans:2
},
{
  id:566, cat:'safety',
  en:{q:'What is the correct way to hold the steering wheel for maximum control?',opts:['One hand at the top (12 o\'clock)','Both hands at the bottom (7 and 5 o\'clock)','Both hands on opposite sides (9 and 3 o\'clock, or 8 and 4 o\'clock)','One hand at 3 o\'clock and one hand on the gear shift'],exp:'The recommended hand positions on a steering wheel are 9 and 3 o\'clock or 8 and 4 o\'clock. These positions provide maximum stability, control during emergency maneuvers, and allow safe airbag deployment (hands stay low, away from the airbag). The old "10 and 2" position has been updated because it puts hands too close to where the airbag deploys. Keeping both hands on the wheel allows you to steer quickly in both directions and reduces fatigue on long drives.'},
  zh:{q:'为了最大控制，正确持握方向盘的方式是什么？',opts:['一只手在顶部（12点位置）','两只手在底部（7点和5点位置）','两只手在相对两侧（9点和3点，或8点和4点）','一只手在3点位置，一只手在换挡杆上'],exp:'方向盘上推荐的手部位置是9点和3点或8点和4点。这些位置在紧急操作时提供最大稳定性和控制，并允许安全的安全气囊展开（手保持低位，远离安全气囊）。旧的"10点和2点"位置已经更新，因为它把手放得太靠近安全气囊展开的位置。两手握住方向盘可以让您快速向两个方向转向，并减少长途驾驶时的疲劳。'},
  zhTW:{q:'為了最大控制，正確持握方向盤的方式是什麼？',opts:['一隻手在頂部（12點位置）','兩隻手在底部（7點和5點位置）','兩隻手在相對兩側（9點和3點，或8點和4點）','一隻手在3點位置，一隻手在換挡杆上'],exp:'方向盤上推薦的手部位置是9點和3點或8點和4點。這些位置在緊急操作時提供最大穩定性和控制，並允許安全的安全氣囊展開（手保持低位，遠離安全氣囊）。舊的「10點和2點」位置已經更新，因為它把手放得太靠近安全氣囊展開的位置。兩手握住方向盤可以讓您快速向兩個方向轉向，並減少長途駕駛時的疲勞。'},
  es:{q:'¿Cuál es la forma correcta de sostener el volante para el máximo control?',opts:['Una mano en la parte superior (posición de 12)','Ambas manos en la parte inferior (posiciones de 7 y 5)','Ambas manos en lados opuestos (posiciones de 9 y 3, o de 8 y 4)','Una mano en la posición de 3 y una mano en la palanca de cambios'],exp:'Las posiciones recomendadas de manos en el volante son 9 y 3 o 8 y 4. Estas posiciones proporcionan máxima estabilidad, control durante maniobras de emergencia y permiten el despliegue seguro del airbag. La antigua posición "10 y 2" ha sido actualizada porque coloca las manos demasiado cerca de donde se despliega el airbag.'},
  ans:2
},
{
  id:567, cat:'laws',
  en:{q:'What is the penalty for a first offense of driving without a valid driver\'s license in California?',opts:['Warning only — no citation','Fine up to $250 and possible vehicle impoundment','Automatic 30-day license suspension','Immediate arrest and jail time'],exp:'Driving without a valid license (Vehicle Code 12500) in California is an infraction or misdemeanor depending on circumstances. A first offense typically results in a fine and possible vehicle impoundment. The vehicle may be impounded for up to 30 days. If you have never had a license, it is more serious than if your license simply expired. The court has discretion over penalties. Driving on a suspended or revoked license (VC 14601) is a separate, more serious offense with larger fines and potential jail time.'},
  zh:{q:'在加州，首次无效驾照驾驶的处罚是什么？',opts:['仅警告——不开罚单','最高$250罚款和可能的车辆扣押','自动30天驾照暂停','立即逮捕和监禁'],exp:'在加州无效驾照驾驶（车辆法规12500）根据情况可能是违规行为或轻罪。首次违规通常导致罚款和可能的车辆扣押。车辆可能被扣押最多30天。如果您从未拥有过驾照，比驾照仅仅过期更严重。法院对处罚有自由裁量权。在吊销或撤销驾照的情况下驾驶（VC 14601）是一个单独的、更严重的违规行为，罚款更高，可能有监禁时间。'},
  zhTW:{q:'在加州，首次無效駕照駕駛的處罰是什麼？',opts:['僅警告——不開罰單','最高$250罰款和可能的車輛扣押','自動30天駕照暫停','立即逮捕和監禁'],exp:'在加州無效駕照駕駛（車輛法規12500）根據情況可能是違規行為或輕罪。首次違規通常導致罰款和可能的車輛扣押。車輛可能被扣押最多30天。如果您從未擁有過駕照，比駕照僅僅過期更嚴重。法院對處罰有自由裁量權。在吊銷或撤銷駕照的情況下駕駛（VC 14601）是一個單獨的、更嚴重的違規行為，罰款更高，可能有監禁時間。'},
  es:{q:'¿Cuál es la penalidad por conducir sin una licencia de conducir válida por primera vez en California?',opts:['Solo advertencia — sin citación','Multa de hasta $250 y posible impound del vehículo','Suspensión automática de la licencia por 30 días','Arresto inmediato y tiempo en prisión'],exp:'Conducir sin una licencia válida (Código de Vehículos 12500) en California es una infracción o delito menor según las circunstancias. Una primera infracción típicamente resulta en una multa y posible impound del vehículo. El vehículo puede ser confiscado por hasta 30 días. Si nunca ha tenido una licencia, es más serio que si simplemente venció.'},
  ans:1
},
{
  id:568, cat:'signs',
  en:{q:'What shape is a railroad crossing sign?',opts:['Diamond (square on point)','Circle','Pentagon (five-sided)','Triangle'],exp:'Railroad advance warning signs are round (circular) with an "X" and "RR" lettering, placed ahead of railroad crossings to warn drivers. The actual crossbuck sign at the crossing is X-shaped (two planks crossed). The round sign is yellow with black lettering. When approaching a railroad crossing, slow down, look and listen for trains, and be prepared to stop. If a train is approaching, you must stop. Never stop on railroad tracks and never try to race a train.'},
  zh:{q:'铁路道口标志是什么形状？',opts:['菱形（尖端朝上的正方形）','圆形','五边形（五边形）','三角形'],exp:'铁路提前警告标志是圆形（圆形），带有"X"和"RR"字母，放置在铁路道口前面以警告驾驶员。道口处的实际十字形标志是X形（两块交叉的木板）。圆形标志为黄色，黑色字母。接近铁路道口时，减速、眺望并倾听火车，并准备停车。如果火车正在接近，您必须停车。不要停在铁路轨道上，也不要试图与火车赛跑。'},
  zhTW:{q:'鐵路道口標誌是什麼形狀？',opts:['菱形（尖端朝上的正方形）','圓形','五邊形（五邊形）','三角形'],exp:'鐵路提前警告標誌是圓形（圓形），帶有「X」和「RR」字母，放置在鐵路道口前面以警告駕駛員。道口處的實際十字形標誌是X形（兩塊交叉的木板）。圓形標誌為黃色，黑色字母。接近鐵路道口時，減速、眺望並傾聽火車，並準備停車。如果火車正在接近，您必須停車。不要停在鐵路軌道上，也不要試圖與火車賽跑。'},
  es:{q:'¿Qué forma tiene un letrero de cruce de ferrocarril?',opts:['Diamante (cuadrado en punta)','Círculo','Pentágono (cinco lados)','Triángulo'],exp:'Los letreros de advertencia avanzada de ferrocarril son redondos (circulares) con letras "X" y "RR", colocados antes de los cruces de ferrocarril para advertir a los conductores. El letrero de cruceta real en el cruce es en forma de X. El letrero redondo es amarillo con letras negras. Al acercarse a un cruce de ferrocarril, reduzca la velocidad, mire y escuche trenes y esté preparado para detenerse.'},
  ans:1
},
{
  id:569, cat:'parking',
  en:{q:'You want to park on a hill with no curb. Which direction should you turn your wheels?',opts:['Toward the road (away from the edge of the road)','Away from the road (toward the edge of the road or shoulder)','Straight ahead — wheels should always be straight when parked','It does not matter as long as the parking brake is set'],exp:'When parking on a hill with NO curb, turn your wheels toward the shoulder (away from the road, toward the edge). This way, if your vehicle rolls, it rolls off the road rather than into traffic. When there IS a curb, turn wheels toward the curb when facing downhill (so the curb stops the car) and away from the curb when facing uphill (so the curb catches the front wheel if the car rolls back). Always set the parking brake regardless of direction.'},
  zh:{q:'您想在没有路缘的山坡上停车。您应该将车轮转向哪个方向？',opts:['朝向道路（远离道路边缘）','远离道路（朝向道路边缘或路肩）','朝前——停车时车轮应始终保持直线','只要拉好手刹，方向无关紧要'],exp:'在没有路缘的山坡上停车时，将车轮转向路肩（远离道路，朝向边缘）。这样，如果您的车辆滚动，它会滚离道路而不是进入交通。如果有路缘，面朝下坡时将车轮转向路缘（使路缘停住车）；面朝上坡时将车轮转离路缘（使路缘在车辆向后滚动时抓住前轮）。无论方向如何，始终拉好停车制动器。'},
  zhTW:{q:'您想在沒有路緣的山坡上停車。您應該將車輪轉向哪個方向？',opts:['朝向道路（遠離道路邊緣）','遠離道路（朝向道路邊緣或路肩）','朝前——停車時車輪應始終保持直線','只要拉好手刹，方向無關緊要'],exp:'在沒有路緣的山坡上停車時，將車輪轉向路肩（遠離道路，朝向邊緣）。這樣，如果您的車輛滾動，它會滾離道路而不是進入交通。如果有路緣，面朝下坡時將車輪轉向路緣（使路緣停住車）；面朝上坡時將車輪轉離路緣（使路緣在車輛向後滾動時抓住前輪）。無論方向如何，始終拉好停車制動器。'},
  es:{q:'Quiere estacionar en una colina sin bordillo. ¿En qué dirección debe girar sus ruedas?',opts:['Hacia la carretera (lejos del borde de la carretera)','Lejos de la carretera (hacia el borde de la carretera o el arcén)','Recto al frente — las ruedas siempre deben estar rectas al estacionar','No importa siempre que esté puesto el freno de mano'],exp:'Al estacionar en una colina SIN bordillo, gire sus ruedas hacia el arcén (lejos de la carretera, hacia el borde). De esta manera, si su vehículo rueda, rueda fuera de la carretera en lugar de hacia el tráfico. Cuando HAY bordillo, gire las ruedas hacia el bordillo cuando mira cuesta abajo y lejos del bordillo cuando mira cuesta arriba. Siempre ponga el freno de estacionamiento.'},
  ans:1
},
{
  id:570, cat:'highway',
  en:{q:'What is the purpose of an HOV (High Occupancy Vehicle) lane, and who may use it?',opts:['It is a faster lane for any driver willing to pay a toll','It is reserved for vehicles with two or more occupants (varies by sign) to reduce traffic congestion','It is for commercial trucks and buses only','It is for emergency vehicles and law enforcement only'],exp:'HOV lanes (also called carpool lanes or diamond lanes, marked with a diamond symbol) are reserved for vehicles with a minimum number of occupants as indicated by signs (usually 2+ or 3+ persons). Motorcycles may also use HOV lanes regardless of occupants. Some HOV lanes allow qualifying clean air vehicles with a special sticker even with only one occupant. HOV lanes are designed to reduce traffic congestion by encouraging carpooling and reduce emissions. Solo drivers in an HOV lane can be heavily fined.'},
  zh:{q:'HOV（高占用率车辆）车道的目的是什么，谁可以使用它？',opts:['对任何愿意付费的司机来说，这是一条更快的车道','它为有两名或更多乘员（因标志而异）的车辆保留，以减少交通拥堵','仅供商业卡车和公共汽车使用','仅供紧急车辆和执法部门使用'],exp:'HOV车道（也称为拼车车道或菱形车道，用菱形符号标记）为具有标志所示最低乘员数量的车辆保留（通常为2人以上或3人以上）。摩托车也可以不管乘员数量使用HOV车道。一些HOV车道允许持有特殊贴纸的合格清洁能源车辆即使只有一名乘员也可使用。HOV车道旨在通过鼓励拼车来减少交通拥堵并减少排放。单独驾驶员在HOV车道上可能被重罚。'},
  zhTW:{q:'HOV（高佔用率車輛）車道的目的是什麼，誰可以使用它？',opts:['對任何願意付費的司機來說，這是一條更快的車道','它為有兩名或更多乘員（因標誌而異）的車輛保留，以減少交通擁堵','僅供商業卡車和公共汽車使用','僅供緊急車輛和執法部門使用'],exp:'HOV車道（也稱為拼車車道或菱形車道，用菱形符號標記）為具有標誌所示最低乘員數量的車輛保留（通常為2人以上或3人以上）。摩托車也可以不管乘員數量使用HOV車道。一些HOV車道允許持有特殊貼紙的合格清潔能源車輛即使只有一名乘員也可使用。HOV車道旨在通過鼓勵拼車來減少交通擁堵並減少排放。單獨駕駛員在HOV車道上可能被重罰。'},
...
,
{
  ...
  zh:{q:'在高速公路换道之前，您应该做什么？',opts:['打信号立即移动','检查后视镜，打信号，检查盲点，然后安全时移动','只检查后视镜','只需打信号——后视镜和盲点是可选的'],exp:'换道之前：1）检查后视镜（后视镜和侧视镜）。2）用转向灯至少3-5秒发出意图信号。3）通过短暂朝换道方向回头看来检查盲点。4）安全时进入车道。这个顺序可以防止与可能在盲点中或从后面接近的车辆碰撞。不检查盲点是换道事故的主要原因。不要在路口换道。'},
  zhTW:{q:'在高速公路換道之前，您應該做什麼？',opts:['打信號立即移動','檢查後視鏡，打信號，檢查盲點，然後安全時移動','只檢查後視鏡','只需打信號——後視鏡和盲點是可選的'],exp:'換道之前：1）檢查後視鏡（後視鏡和側視鏡）。2）用轉向燈至少3-5秒發出意圖信號。3）通過短暫朝換道方向回頭看來檢查盲點。4）安全時進入車道。這個順序可以防止與可能在盲點中或從後面接近的車輛碰撞。不檢查盲點是換道事故的主要原因。不要在路口換道。'},
  es:{q:'¿Qué debe hacer antes de cambiar de carril en una autopista?',opts:['Señalice y muévase inmediatamente','Revise sus espejos, señalice, revise su punto ciego, luego muévase si es seguro','Solo revise sus espejos','Solo señalice — los espejos y los puntos ciegos son opcionales'],exp:'Antes de cambiar de carril: 1) Revise sus espejos (retrovisor y laterales). 2) Señalice su intención con la señal de giro durante al menos 3-5 segundos. 3) Revise su punto ciego mirando brevemente por encima del hombro en la dirección del cambio de carril. 4) Muévase al carril si es seguro. No cambiar de carril en una intersección.'},
  ans:1
},
{
  id:572, cat:'laws',
  en:{q:'In California, texting while driving is:',opts:['Legal if you are stopped at a red light','Legal only when using voice-to-text','Illegal at all times — hands-free only is required for phone use','Only illegal for drivers under 18'],exp:'In California, it is illegal to use a handheld electronic device while driving at any time, including while stopped at a red light. Drivers 18+ may use a device in hands-free mode (mounted, voice-activated). Drivers under 18 may NOT use any wireless communication device while driving — even hands-free. Violators face escalating fines. Using a cell phone while driving (even briefly) significantly increases crash risk. Hands-free use is still distracting, so minimize all phone use while driving.'},
  zh:{q:'在加州，驾驶时发短信是：',opts:['如果您在红灯前停车，则合法','只有使用语音转文字时合法','任何时候都违法——手机使用只允许免提','只对18岁以下驾驶员违法'],exp:'在加州，驾驶时任何时候（包括在红灯前停车时）使用手持电子设备都是违法的。18岁以上的驾驶员可以以免提模式（固定安装、语音激活）使用设备。18岁以下的驾驶员驾驶时不得使用任何无线通信设备——即使是免提。违规者面临递增的罚款。驾驶时使用手机（即使是短暂使用）会显著增加事故风险。免提使用仍然令人分心，因此在驾驶时尽量减少所有电话使用。'},
  zhTW:{q:'在加州，駕駛時發短信是：',opts:['如果您在紅燈前停車，則合法','只有使用語音轉文字時合法','任何時候都違法——手機使用只允許免提','只對18歲以下駕駛員違法'],exp:'在加州，駕駛時任何時候（包括在紅燈前停車時）使用手持電子設備都是違法的。18歲以上的駕駛員可以以免提模式（固定安裝、語音激活）使用設備。18歲以下的駕駛員駕駛時不得使用任何無線通信設備——即使是免提。違規者面臨遞增的罰款。駕駛時使用手機（即使是短暫使用）會顯著增加事故風險。免提使用仍然令人分心，因此在駕駛時盡量減少所有電話使用。'},
  es:{q:'En California, enviar mensajes de texto mientras conduce es:',opts:['Legal si está detenido en un semáforo en rojo','Legal solo cuando usa voz a texto','Ilegal en todo momento — solo se permite el uso de teléfono con manos libres','Solo ilegal para conductores menores de 18 años'],exp:'En California, es ilegal usar un dispositivo electrónico de mano mientras conduce en cualquier momento, incluso cuando está detenido en un semáforo rojo. Los conductores de 18+ pueden usar un dispositivo en modo manos libres (montado, activado por voz). Los conductores menores de 18 años NO pueden usar ningún dispositivo de comunicación inalámbrica mientras conducen — ni siquiera manos libres.'},
  ans:2
},
{
  id:573, cat:'signs',
  en:{q:'A sign with a green background and white text is most commonly used for what?',opts:['Warning about road hazards ahead','Directional and distance information (route markers, highway exits, place names)','School zone and pedestrian crossing information','Construction zone and detour information'],exp:'Green signs with white text are used for directional and distance information on roads and highways. They show destinations, distances to cities, highway route numbers, and exit information. For example: "Exit 42 — Downtown 2 miles." Green signs help drivers navigate. Yellow (warning), orange (construction), red (stop/regulatory), blue (services), brown (recreation/cultural), and white (regulatory, like speed limits) signs all have specific purposes based on their color.'},
  zh:{q:'绿色背景白色文字的标志最常用于什么？',opts:['关于前方道路危险的警告','方向和距离信息（路线标志、公路出口、地名）','学区和行人过道信息','施工区和绕行信息'],exp:'绿色白字标志用于道路和公路上的方向和距离信息。它们显示目的地、到城市的距离、公路路线编号和出口信息。例如："出口42——市中心2英里"。绿色标志帮助驾驶员导航。黄色（警告）、橙色（施工）、红色（停止/法规）、蓝色（服务）、棕色（休闲/文化）和白色（法规，如限速）标志都根据颜色有特定用途。'},
  zhTW:{q:'綠色背景白色文字的標誌最常用於什麼？',opts:['關於前方道路危險的警告','方向和距離信息（路線標誌、公路出口、地名）','學區和行人過道信息','施工區和繞行信息'],exp:'綠色白字標誌用於道路和公路上的方向和距離信息。它們顯示目的地、到城市的距離、公路路線編號和出口信息。例如：「出口42——市中心2英里」。綠色標誌幫助駕駛員導航。黃色（警告）、橙色（施工）、紅色（停止/法規）、藍色（服務）、棕色（休閒/文化）和白色（法規，如限速）標誌都根據顏色有特定用途。'},
  es:{q:'Un letrero con fondo verde y texto blanco se usa más comúnmente para ¿qué?',opts:['Advertencia sobre peligros en la carretera adelante','Información de dirección y distancia (marcadores de ruta, salidas de carretera, nombres de lugares)','Información de zona escolar y cruce peatonal','Información de zona de construcción y desvío'],exp:'Los letreros verdes con texto blanco se usan para información de dirección y distancia en carreteras y autopistas. Muestran destinos, distancias a ciudades, números de rutas de carretera e información de salidas. Por ejemplo: "Salida 42 — Centro 2 millas." Los letreros verdes ayudan a los conductores a navegar.'},
  ans:1
},
{
  id:574, cat:'rightofway',
  en:{q:'A funeral procession is passing. What must you do?',opts:['You may pass through the procession if there is a gap and it is safe','You must yield to the entire procession even if you have a green light','Honk to alert the procession that you need to pass','Funeral processions have no special right-of-way privileges'],exp:'A funeral procession has the right of way over all traffic unless directed otherwise by a law enforcement officer. Once the lead vehicle of a funeral procession lawfully enters an intersection, all vehicles in the procession may continue through even if the light changes to red. Other drivers must yield. You must not drive between or interfere with vehicles in a funeral procession. Vehicles in a procession typically have their headlights on and may have a special funeral flag.'},
  zh:{q:'送葬队伍经过时，您必须怎么做？',opts:['如果有空档且安全，您可以穿过队伍','即使您有绿灯，您也必须向整个队伍让行','鸣喇叭提醒队伍您需要通过','送葬队伍没有特殊先行权特权'],exp:'送葬队伍优先于所有交通，除非执法人员另有指示。一旦送葬队伍的领头车辆合法进入路口，即使灯变红，队伍中的所有车辆也可以继续通过。其他驾驶员必须让行。不得在送葬队伍中的车辆之间行驶或干扰送葬队伍。队伍中的车辆通常开着车头灯，可能有特殊的送葬旗帜。'},
  zhTW:{q:'送葬隊伍經過時，您必須怎麼做？',opts:['如果有空擋且安全，您可以穿過隊伍','即使您有綠燈，您也必須向整個隊伍讓行','鳴喇叭提醒隊伍您需要通過','送葬隊伍沒有特殊先行權特權'],exp:'送葬隊伍優先於所有交通，除非執法人員另有指示。一旦送葬隊伍的領頭車輛合法進入路口，即使燈變紅，隊伍中的所有車輛也可以繼續通過。其他駕駛員必須讓行。不得在送葬隊伍中的車輛之間行駛或干擾送葬隊伍。隊伍中的車輛通常開著車頭燈，可能有特殊的送葬旗幟。'},
  es:{q:'Pasa una procesión fúnebre. ¿Qué debe hacer?',opts:['Puede pasar a través de la procesión si hay un espacio y es seguro','Debe ceder a toda la procesión incluso si tiene luz verde','Toque la bocina para alertar a la procesión de que necesita pasar','Las procesiones fúnebres no tienen privilegios especiales de derecho de paso'],exp:'Una procesión fúnebre tiene el derecho de paso sobre todo el tráfico a menos que un oficial de policía indique lo contrario. Una vez que el vehículo líder de una procesión fúnebre entra legalmente a una intersección, todos los vehículos de la procesión pueden continuar aunque la luz cambie a rojo. Los demás conductores deben ceder.'},
  ans:1
},
{
  id:575, cat:'speed',
  en:{q:'Under California law, what is the prima facie speed limit in an alley?',opts:['10 mph','15 mph','20 mph','25 mph'],exp:'The prima facie speed limit in an alley in California is 15 mph. Alleys are narrow access roads, typically behind buildings, and are shared by vehicles, cyclists, and pedestrians. The low speed limit accounts for limited sight lines, parked vehicles, and the presence of vulnerable users including children. Always proceed slowly and cautiously in alleys, yield to pedestrians, and watch for people coming out from between vehicles or buildings.'},
  zh:{q:'根据加州法律，小巷的基准限速是多少？',opts:['10英里/小时','15英里/小时','20英里/小时','25英里/小时'],exp:'在加州，小巷的基准限速为每小时15英里。小巷是狭窄的通道，通常在建筑物后方，由车辆、骑车人和行人共用。低限速考虑到了有限的视线、停放的车辆以及包括儿童在内的弱势用户的存在。在小巷中始终慢速谨慎行驶，向行人让行，并注意从车辆或建筑物之间出来的人。'},
  zhTW:{q:'根據加州法律，小巷的基準限速是多少？',opts:['10英里/小時','15英里/小時','20英里/小時','25英里/小時'],exp:'在加州，小巷的基準限速為每小時15英里。小巷是狹窄的通道，通常在建築物後方，由車輛、騎車人和行人共用。低限速考慮到了有限的視線、停放的車輛以及包括兒童在內的弱勢用戶的存在。在小巷中始終慢速謹慎行駛，向行人讓行，並注意從車輛或建築物之間出來的人。'},
  es:{q:'Bajo la ley de California, ¿cuál es el límite de velocidad prima facie en un callejón?',opts:['10 mph','15 mph','20 mph','25 mph'],exp:'El límite de velocidad prima facie en un callejón en California es de 15 mph. Los callejones son caminos de acceso estrechos, típicamente detrás de edificios, y son compartidos por vehículos, ciclistas y peatones. El bajo límite de velocidad tiene en cuenta las líneas de visión limitadas, los vehículos estacionados y la presencia de usuarios vulnerables, incluidos los niños.'},
  ans:1
},
{
  id:576, cat:'dui',
  en:{q:'Which of the following is true about prescription medication and driving?',opts:['Prescription drugs cannot cause impairment because they are legally prescribed','You can be convicted of DUI for driving impaired by prescription medication','Prescription medication only impairs driving if taken in excess of the prescribed dose','Only illegal drugs can lead to a DUI charge'],exp:'Prescription medications can impair your ability to drive, and you can be arrested and convicted of DUI if you drive while impaired by prescription drugs — even if you are taking them exactly as prescribed. Drugs that cause drowsiness, affect vision, or alter reaction time (such as opioids, benzodiazepines, antihistamines, and muscle relaxants) are particularly dangerous. Your doctor or pharmacist should warn you if a medication affects driving. When in doubt, do not drive after taking any medication that may cause impairment.'},
  zh:{q:'以下关于处方药和驾驶的哪项陈述是正确的？',opts:['处方药不能导致损伤，因为它们是合法处方的','如果因处方药受损而驾驶，您可能被定罪DUI','处方药只有在超过处方剂量服用时才会影响驾驶','只有非法药物才能导致DUI指控'],exp:'处方药可能损害您的驾驶能力，如果您在处方药物影响下驾驶，您可能被逮捕和定罪DUI——即使您按照处方服用。导致嗜睡、影响视力或改变反应时间的药物（如阿片类、苯二氮䓬类、抗组胺药和肌肉松弛剂）尤其危险。如果药物影响驾驶，您的医生或药剂师应该警告您。如果有疑问，服用任何可能导致损伤的药物后不要驾驶。'},
  zhTW:{q:'以下關於處方藥和駕駛的哪項陳述是正確的？',opts:['處方藥不能導致損傷，因為它們是合法處方的','如果因處方藥受損而駕駛，您可能被定罪DUI','處方藥只有在超過處方劑量服用時才會影響駕駛','只有非法藥物才能導致DUI指控'],exp:'處方藥可能損害您的駕駛能力，如果您在處方藥物影響下駕駛，您可能被逮捕和定罪DUI——即使您按照處方服用。導致嗜睡、影響視力或改變反應時間的藥物（如阿片類、苯二氮䓬類、抗組胺藥和肌肉鬆弛劑）尤其危險。如果有疑問，服用任何可能導致損傷的藥物後不要駕駛。'},
  es:{q:'¿Cuál de los siguientes es verdadero sobre los medicamentos con receta y la conducción?',opts:['Los medicamentos con receta no pueden causar deterioro porque son recetados legalmente','Puede ser condenado por DUI por conducir deteriorado por medicamentos con receta','Los medicamentos con receta solo deterioran la conducción si se toman en exceso de la dosis prescrita','Solo las drogas ilegales pueden llevar a un cargo de DUI'],exp:'Los medicamentos con receta pueden deteriorar su capacidad para conducir, y puede ser arrestado y condenado por DUI si conduce deteriorado por medicamentos con receta — incluso si los está tomando exactamente como se recetó. Los medicamentos que causan somnolencia, afectan la visión o alteran el tiempo de reacción son particularmente peligrosos.'},
  ans:1
},
{
  id:577, cat:'parking',
  en:{q:'You are parking parallel to the curb. How far from the curb should your tires be?',opts:['Within 6 inches','Within 12 inches','Within 18 inches','Within 24 inches'],exp:'When parking parallel to the curb in California, your vehicle\'s right wheels must be within 18 inches of the curb. If you are more than 18 inches from the curb, you may be blocking traffic or creating a hazard, and you can receive a parking citation. When parking on the right side of a one-way street, wheels must be within 18 inches of the right curb. On a one-way street with permitted left-side parking, wheels must be within 18 inches of the left curb.'},
  zh:{q:'您正在紧靠路缘平行停车。您的轮胎应该离路缘多远？',opts:['6英寸以内','12英寸以内','18英寸以内','24英寸以内'],exp:'在加州平行停车时，您的车辆右轮必须在路缘18英寸以内。如果您离路缘超过18英寸，您可能阻塞交通或造成危险，可能收到停车罚单。在单行道右侧停车时，车轮必须在右侧路缘18英寸以内。在允许左侧停车的单行道上，车轮必须在左侧路缘18英寸以内。'},
  zhTW:{q:'您正在緊靠路緣平行停車。您的輪胎應該離路緣多遠？',opts:['6英寸以內','12英寸以內','18英寸以內','24英寸以內'],exp:'在加州平行停車時，您的車輛右輪必須在路緣18英寸以內。如果您離路緣超過18英寸，您可能阻塞交通或造成危險，可能收到停車罰單。在單行道右側停車時，車輪必須在右側路緣18英寸以內。在允許左側停車的單行道上，車輪必須在左側路緣18英寸以內。'},
  es:{q:'Está estacionando paralelo al bordillo. ¿A qué distancia del bordillo deben estar sus neumáticos?',opts:['Dentro de 6 pulgadas','Dentro de 12 pulgadas','Dentro de 18 pulgadas','Dentro de 24 pulgadas'],exp:'Al estacionar paralelo al bordillo en California, las ruedas derechas de su vehículo deben estar dentro de las 18 pulgadas del bordillo. Si está a más de 18 pulgadas del bordillo, puede estar bloqueando el tráfico o creando un peligro, y puede recibir una citación de estacionamiento.'},
  ans:2
},
{
  id:578, cat:'highway',
  en:{q:'When is it legal to pass another vehicle on the right on a California highway?',opts:['Never — passing on the right is always illegal','Only when the vehicle ahead is turning left and there is a paved lane to the right','On any road as long as you signal first','On freeways only, using the shoulder'],exp:'Passing on the right is permitted when the vehicle you are passing is making or preparing to make a left turn, and there is a lane to the right that is wide enough to allow passing. You may also pass on the right on a multi-lane one-way street, or on a road with multiple lanes traveling in the same direction. However, you must never pass on the right by driving off the paved portion of the roadway or onto the shoulder.'},
  zh:{q:'在加州公路上，何时可以合法从右侧超越另一辆车？',opts:['永不——从右侧超车始终违法','只有当前方车辆左转且右侧有铺设车道时','只要先打信号，在任何道路上','仅在高速公路上，使用路肩'],exp:'当您超越的车辆正在进行或准备进行左转，且右侧有足够宽的车道允许超车时，允许从右侧超车。在多车道单行道上，或在同一方向有多个车道的道路上，您也可以从右侧超车。但是，您绝不能通过驶离铺设路面或进入路肩从右侧超车。'},
  zhTW:{q:'在加州公路上，何時可以合法從右側超越另一輛車？',opts:['永不——從右側超車始終違法','只有當前方車輛左轉且右側有鋪設車道時','只要先打信號，在任何道路上','僅在高速公路上，使用路肩'],exp:'當您超越的車輛正在進行或準備進行左轉，且右側有足夠寬的車道允許超車時，允許從右側超車。在多車道單行道上，或在同一方向有多個車道的道路上，您也可以從右側超車。但是，您絕不能通過駛離鋪設路面或進入路肩從右側超車。'},
  es:{q:'¿Cuándo es legal adelantar a otro vehículo por la derecha en una carretera de California?',opts:['Nunca — adelantar por la derecha siempre es ilegal','Solo cuando el vehículo de adelante está girando a la izquierda y hay un carril pavimentado a la derecha','En cualquier carretera siempre que señalice primero','Solo en autopistas, usando el arcén'],exp:'Adelantar por la derecha está permitido cuando el vehículo que está adelantando está girando o preparándose para girar a la izquierda, y hay un carril a la derecha lo suficientemente ancho para permitir adelantar. También puede adelantar por la derecha en una calle de sentido único de múltiples carriles, o en una carretera con múltiples carriles en la misma dirección. Sin embargo, nunca debe adelantar por la derecha conduciendo fuera del pavimento o por el arcén.'},
  ans:1
},
{
  id:579, cat:'safety',
  en:{q:'What should you do if your vehicle starts to skid on a slippery surface?',opts:['Brake hard to stop the vehicle quickly','Steer into the skid (turn in the direction the rear of the car is skidding), ease off the gas, and avoid hard braking','Turn the wheel sharply to the opposite direction of the skid','Shift into reverse to slow down'],exp:'If your vehicle skids: 1) Ease off the accelerator. 2) Steer in the direction of the skid — if the rear slides right, turn your wheels to the right. This is called "steering into the skid." 3) Avoid hard braking, which can worsen the skid (especially without ABS). 4) If you have ABS, apply steady firm pressure — the system prevents wheel lockup. 5) Once you regain control, straighten the wheels. Skids typically occur on wet, icy, or gravelly surfaces, especially during sudden acceleration, hard braking, or sharp turns.'},
  zh:{q:'如果您的车辆在滑溜表面开始打滑，您应该怎么做？',opts:['猛踩刹车以快速停车','朝打滑方向转向（朝车尾打滑方向转动方向盘），松开油门，避免猛踩刹车','将方向盘急转向打滑相反方向','换到倒挡减速'],exp:'如果您的车辆打滑：1）松开加速踏板。2）朝打滑方向转向——如果车尾向右滑，将车轮转向右。这叫做"顺滑转向"。3）避免猛踩刹车，这可能加剧打滑（特别是没有ABS时）。4）如果您有ABS，施加稳定的力——该系统防止车轮锁死。5）一旦重新控制，将方向盘摆正。打滑通常发生在潮湿、结冰或有砾石的表面上，特别是在急加速、急刹车或急转弯时。'},
  zhTW:{q:'如果您的車輛在滑溜表面開始打滑，您應該怎麼做？',opts:['猛踩刹車以快速停車','朝打滑方向轉向（朝車尾打滑方向轉動方向盤），鬆開油門，避免猛踩刹車','將方向盤急轉向打滑相反方向','換到倒擋減速'],exp:'如果您的車輛打滑：1）鬆開加速踏板。2）朝打滑方向轉向——如果車尾向右滑，將車輪轉向右。這叫做「順滑轉向」。3）避免猛踩刹車，這可能加劇打滑（特別是沒有ABS時）。4）如果您有ABS，施加穩定的力——該系統防止車輪鎖死。5）一旦重新控制，將方向盤擺正。打滑通常發生在潮濕、結冰或有礫石的表面上，特別是在急加速、急刹車或急轉彎時。'},
  es:{q:'¿Qué debe hacer si su vehículo empieza a derrapar en una superficie resbaladiza?',opts:['Frene fuerte para detener el vehículo rápidamente','Dirija hacia el derrape (gire en la dirección en que se desliza la parte trasera del auto), suelte el gas y evite frenar fuerte','Gire el volante bruscamente en la dirección opuesta al derrape','Cambie a reversa para reducir la velocidad'],exp:'Si su vehículo derrapa: 1) Suelte el acelerador. 2) Dirija en la dirección del derrape — si la parte trasera se desliza a la derecha, gire sus ruedas a la derecha. Esto se llama "dirigir hacia el derrape." 3) Evite frenar fuerte, lo que puede empeorar el derrape. 4) Si tiene ABS, aplique presión firme constante. 5) Una vez que recupere el control, enderece las ruedas.'},
  ans:1
},
{
  id:580, cat:'laws',
  en:{q:'What is a "Failure to Yield" violation in California?',opts:['Driving below the minimum speed limit on a freeway','Not yielding the right of way to those who legally have it, such as pedestrians, cyclists, or other vehicles','Running a stop sign','Not using turn signals when required'],exp:'A "Failure to Yield" violation occurs when a driver does not give the right of way to those who are legally entitled to it. Examples include: failing to yield to pedestrians at crosswalks, failing to yield when turning left across oncoming traffic, failing to yield at a yield sign, failing to yield to emergency vehicles, and failing to yield when merging. Failure to yield is a primary cause of intersection collisions and can result in a traffic fine and points on your license.'},
  zh:{q:'在加州，"未能让行"违规是什么？',opts:['在高速公路上以低于最低限速行驶','未向合法拥有先行权的人（如行人、骑车人或其他车辆）让行','闯停车标志','在需要时不使用转向信号'],exp:'"未能让行"违规发生在驾驶员未向合法享有先行权的人让行时。例子包括：未向人行横道处的行人让行，左转时穿越对向交通未让行，在让行标志处未让行，未向紧急车辆让行，以及合并时未让行。未能让行是路口碰撞的主要原因，可能导致交通罚款和驾照记分。'},
  zhTW:{q:'在加州，「未能讓行」違規是什麼？',opts:['在高速公路上以低於最低限速行駛','未向合法擁有先行權的人（如行人、騎車人或其他車輛）讓行','闖停車標誌','在需要時不使用轉向信號'],exp:'「未能讓行」違規發生在駕駛員未向合法享有先行權的人讓行時。例子包括：未向人行橫道處的行人讓行，左轉時穿越對向交通未讓行，在讓行標誌處未讓行，未向緊急車輛讓行，以及合並時未讓行。未能讓行是路口碰撞的主要原因，可能導致交通罰款和駕照記分。'},
...
,
{
  ...
  zh:{q:'"禁止进入"标志看起来是什么样的，它意味着什么？',opts:['红色八边形——进入前停车','带有白色水平条纹的红色方形——您不能从这个方向进入那条道路','带有红色边框的白色圆形——禁止通行','红色三角形——进入前让行'],exp:'"禁止进入"标志是带有白色水平条纹的红色方形（"禁止进入"符号）。它意味着您不能从那个方向驾驶进入那条道路。这些标志通常放置在单行道入口、高速公路出口匝道和限制区域。进入有"禁止进入"标志的道路极其危险，因为您将逆向驾驶（逆行）。如果您意外进入，停车并小心倒车到安全位置。'},
  zhTW:{q:'「禁止進入」標誌看起來是什麼樣的，它意味著什麼？',opts:['紅色八邊形——進入前停車','帶有白色水平條紋的紅色方形——您不能從這個方向進入那條道路','帶有紅色邊框的白色圓形——禁止通行','紅色三角形——進入前讓行'],exp:'「禁止進入」標誌是帶有白色水平條紋的紅色方形（「禁止進入」符號）。它意味著您不能從那個方向駕駛進入那條道路。這些標誌通常放置在單行道入口、高速公路出口匝道和限制區域。進入有「禁止進入」標誌的道路極其危險，因為您將逆向駕駛（逆行）。如果您意外進入，停車並小心倒車到安全位置。'},
  es:{q:'¿Cómo se ve un letrero de NO ENTRE y qué significa?',opts:['Un octágono rojo — deténgase antes de entrar','Un cuadrado rojo con una barra horizontal blanca — no puede entrar a esa carretera desde esta dirección','Un círculo blanco con borde rojo — no hay tráfico de paso','Un triángulo rojo — ceda antes de entrar'],exp:'Un letrero de NO ENTRE es un cuadrado rojo con una barra horizontal blanca (símbolo de "prohibido el paso"). Significa que no puede conducir hacia esa carretera desde esa dirección. Estos letreros se colocan comúnmente en las entradas de calles de sentido único, rampas de salida de autopistas y áreas restringidas. Entrar a una carretera con un letrero de NO ENTRE es extremadamente peligroso porque conducirá contra el tráfico que viene.'},
  ans:1
},
{
  id:582, cat:'safety',
  en:{q:'What is the purpose of an antilock braking system (ABS)?',opts:['To make brakes last longer before they wear out','To prevent wheel lockup during hard braking so you can maintain steering control','To automatically brake the vehicle to avoid rear-end collisions','To reduce the distance needed to stop in normal conditions'],exp:'ABS (Antilock Braking System) prevents your wheels from locking up during emergency braking, which allows you to maintain steering control. Without ABS, braking too hard can cause wheels to lock and tires to skid — you lose steering and skid in a straight line. With ABS, you can brake hard AND steer around obstacles. If your car has ABS, apply firm, steady pressure to the brake pedal during emergency stops (do not pump). You will feel a pulsation or hear a noise — this is normal.'},
  zh:{q:'防抱死制动系统（ABS）的目的是什么？',opts:['使刹车在磨损前使用更长时间','防止急刹车时车轮锁死，使您能够保持转向控制','自动刹车以避免追尾碰撞','减少在正常条件下停车所需的距离'],exp:'ABS（防抱死制动系统）防止紧急制动时车轮锁死，使您能够保持转向控制。没有ABS，刹车过猛可能导致车轮锁死，轮胎打滑——您失去转向，直线打滑。有了ABS，您可以大力刹车并同时绕过障碍物转向。如果您的车有ABS，在紧急停车时对刹车踏板施加稳定的持续压力（不要踩踩放放）。您会感到脉动或听到噪音——这是正常的。'},
  zhTW:{q:'防抱死制動系統（ABS）的目的是什麼？',opts:['使刹車在磨損前使用更長時間','防止急刹車時車輪鎖死，使您能夠保持轉向控制','自動刹車以避免追尾碰撞','減少在正常條件下停車所需的距離'],exp:'ABS（防抱死制動系統）防止緊急制動時車輪鎖死，使您能夠保持轉向控制。沒有ABS，刹車過猛可能導致車輪鎖死，輪胎打滑——您失去轉向，直線打滑。有了ABS，您可以大力刹車並同時繞過障礙物轉向。如果您的車有ABS，在緊急停車時對刹車踏板施加穩定的持續壓力（不要踩踩放放）。您會感到脈動或聽到噪音——這是正常的。'},
  es:{q:'¿Cuál es el propósito de un sistema de frenos antibloqueo (ABS)?',opts:['Para que los frenos duren más antes de desgastarse','Para evitar el bloqueo de ruedas durante el frenado fuerte para mantener el control de dirección','Para frenar automáticamente el vehículo y evitar colisiones traseras','Para reducir la distancia necesaria para detenerse en condiciones normales'],exp:'El ABS (Sistema de Frenos Antibloqueo) evita que sus ruedas se bloqueen durante el frenado de emergencia, lo que le permite mantener el control de dirección. Sin ABS, frenar demasiado fuerte puede hacer que las ruedas se bloqueen y los neumáticos patinen — pierde la dirección. Con ABS, puede frenar fuerte Y dirigir alrededor de obstáculos. Aplique presión firme y constante al pedal del freno durante paradas de emergencia (no bombee).'},
  ans:1
},
{
  id:583, cat:'rightofway',
  en:{q:'You are at a four-way stop. Two cars arrive at exactly the same time and are facing each other (opposite directions). One wants to go straight, the other wants to turn left. Who goes first?',opts:['The car turning left, since they were signaling','The car going straight','They must alternate — the car on the left goes first','They both go simultaneously since they are not in each other\'s path'],exp:'When two vehicles arrive simultaneously at a four-way stop facing each other and one is going straight while the other is turning left, the vehicle going straight has the right of way. The left-turning vehicle must yield to the oncoming straight-traveling vehicle. This is the general rule: when turning left, always yield to oncoming traffic going straight. This prevents collisions from vehicles crossing each other\'s paths.'},
  zh:{q:'您在四路停车处。两辆车同时到达并面对面（相反方向）。一辆想直行，另一辆想左转。谁先走？',opts:['左转的车，因为他们在打信号','直行的车','他们必须交替——左侧的车先走','他们同时走，因为他们不在对方的路径上'],exp:'当两辆车同时到达四路停车处，面对面，一辆直行，另一辆左转时，直行车辆有先行权。左转车辆必须向直行的对向车辆让行。这是一般规则：左转时，始终向直行的对向交通让行。这可以防止车辆穿越对方路径时发生碰撞。'},
  zhTW:{q:'您在四路停車處。兩輛車同時到達並面對面（相反方向）。一輛想直行，另一輛想左轉。誰先走？',opts:['左轉的車，因為他們在打信號','直行的車','他們必須交替——左側的車先走','他們同時走，因為他們不在對方的路徑上'],exp:'當兩輛車同時到達四路停車處，面對面，一輛直行，另一輛左轉時，直行車輛有先行權。左轉車輛必須向直行的對向車輛讓行。這是一般規則：左轉時，始終向直行的對向交通讓行。這可以防止車輛穿越對方路徑時發生碰撞。'},
  es:{q:'Está en una parada de cuatro vías. Dos autos llegan exactamente al mismo tiempo y se enfrentan (direcciones opuestas). Uno quiere seguir recto, el otro quiere girar a la izquierda. ¿Quién va primero?',opts:['El auto que gira a la izquierda, ya que estaba señalizando','El auto que va recto','Deben alternar — el auto a la izquierda va primero','Ambos van simultáneamente ya que no están en el camino del otro'],exp:'Cuando dos vehículos llegan simultáneamente a una parada de cuatro vías enfrentándose y uno va recto mientras el otro gira a la izquierda, el vehículo que va recto tiene el derecho de paso. El vehículo que gira a la izquierda debe ceder al vehículo que viene en sentido contrario y va recto.'},
  ans:1
},
{
  id:584, cat:'speed',
  en:{q:'A school zone sign shows "SCHOOL SPEED LIMIT 25 MPH WHEN CHILDREN ARE PRESENT". What does this mean?',opts:['The 25 mph limit applies only during posted school hours','The 25 mph limit applies only when a school crossing guard is present','The 25 mph limit applies whenever children are visible in or near the school zone, regardless of time','The 25 mph limit applies only on school days'],exp:'"When children are present" means the reduced speed limit applies whenever children are visible in or near the school zone — whether walking, cycling, or near the road — regardless of time of day, day of the week, or whether school is in session. If you see children in or near the zone, you must observe the 25 mph limit. If there are no children visible, normal speed applies. This standard makes school zones safer by tying the speed limit to actual conditions rather than a fixed time schedule.'},
  zh:{q:'学区标志显示"学区限速25英里/小时，有儿童时"。这意味着什么？',opts:['25英里/小时限速仅在张贴的上学时间适用','25英里/小时限速仅在有学校交通协管员时适用','每当学区内或附近有儿童可见时，无论何时都适用25英里/小时限速','25英里/小时限速仅在上学日适用'],exp:'"有儿童时"意味着每当学区内或附近有儿童可见时——无论是步行、骑车还是在路边——无论一天中的什么时间、一周的哪天，或者学校是否在上课，降低的限速都适用。如果您在该区域内或附近看到儿童，您必须遵守25英里/小时限速。如果没有儿童可见，正常速度适用。这一标准通过将限速与实际条件而非固定时间表挂钩，使学区更安全。'},
  zhTW:{q:'學區標誌顯示「學區限速25英里/小時，有兒童時」。這意味著什麼？',opts:['25英里/小時限速僅在張貼的上學時間適用','25英里/小時限速僅在有學校交通協管員時適用','每當學區內或附近有兒童可見時，無論何時都適用25英里/小時限速','25英里/小時限速僅在上學日適用'],exp:'「有兒童時」意味著每當學區內或附近有兒童可見時——無論是步行、騎車還是在路邊——無論一天中的什麼時間、一周的哪天，或者學校是否在上課，降低的限速都適用。如果您在該區域內或附近看到兒童，您必須遵守25英里/小時限速。如果沒有兒童可見，正常速度適用。'},
  es:{q:'Un letrero de zona escolar muestra "LÍMITE DE VELOCIDAD ESCOLAR 25 MPH CUANDO HAY NIÑOS PRESENTES". ¿Qué significa esto?',opts:['El límite de 25 mph aplica solo durante el horario escolar publicado','El límite de 25 mph aplica solo cuando hay un guardia de cruce escolar presente','El límite de 25 mph aplica siempre que haya niños visibles en o cerca de la zona escolar, independientemente de la hora','El límite de 25 mph aplica solo en días escolares'],exp:'"Cuando hay niños presentes" significa que el límite de velocidad reducido aplica siempre que los niños sean visibles en o cerca de la zona escolar — ya sea caminando, en bicicleta o cerca de la carretera — independientemente de la hora del día, el día de la semana o si la escuela está en sesión.'},
  ans:2
},
{
  id:585, cat:'dui',
  en:{q:'After drinking alcohol, what is the only reliable way to become sober enough to drive safely?',opts:['Drink coffee or eat food to absorb the alcohol','Exercise vigorously to speed up metabolism','Wait for time to pass — the body processes alcohol at about one standard drink per hour','Take a cold shower and drink water'],exp:'The only reliable way to sober up is time. Your liver processes alcohol at approximately one standard drink per hour (roughly 0.015% BAC per hour), and this rate cannot be significantly changed by coffee, food, water, exercise, or any other method. These measures may make you feel more alert, but they do not reduce your BAC. The only safe choice is to not drink and drive, or to wait until your BAC is genuinely below the legal limit — which requires adequate time.'},
  zh:{q:'饮酒后，什么是唯一可靠的方式使您足够清醒以安全驾驶？',opts:['喝咖啡或吃东西以吸收酒精','剧烈运动以加速新陈代谢','等待时间流逝——身体以每小时约一杯标准酒精饮料的速度代谢酒精','洗冷水澡并喝水'],exp:'唯一可靠的醒酒方式是时间。您的肝脏以每小时约一杯标准饮料的速度代谢酒精（每小时约0.015% BAC），这个速度无法通过咖啡、食物、水、运动或任何其他方法显著改变。这些措施可能使您感觉更清醒，但不会降低您的BAC。唯一安全的选择是不饮酒驾驶，或等到您的BAC真正低于法定限制——这需要足够的时间。'},
  zhTW:{q:'飲酒後，什麼是唯一可靠的方式使您足夠清醒以安全駕駛？',opts:['喝咖啡或吃東西以吸收酒精','劇烈運動以加速新陳代謝','等待時間流逝——身體以每小時約一杯標準酒精飲料的速度代謝酒精','洗冷水澡並喝水'],exp:'唯一可靠的醒酒方式是時間。您的肝臟以每小時約一杯標準飲料的速度代謝酒精（每小時約0.015% BAC），這個速度無法通過咖啡、食物、水、運動或任何其他方法顯著改變。這些措施可能使您感覺更清醒，但不會降低您的BAC。唯一安全的選擇是不飲酒駕駛，或等到您的BAC真正低於法定限制——這需要足夠的時間。'},
  es:{q:'Después de beber alcohol, ¿cuál es la única forma confiable de ponerse lo suficientemente sobrio para conducir con seguridad?',opts:['Tomar café o comer para absorber el alcohol','Hacer ejercicio vigoroso para acelerar el metabolismo','Esperar que pase el tiempo — el cuerpo procesa el alcohol a aproximadamente una bebida estándar por hora','Darse una ducha fría y beber agua'],exp:'La única forma confiable de desintoxicarse es el tiempo. Su hígado procesa el alcohol a aproximadamente una bebida estándar por hora (aproximadamente 0.015% de BAC por hora), y esta tasa no puede ser cambiada significativamente por café, comida, agua, ejercicio u otro método. La única opción segura es no beber y conducir, o esperar hasta que su BAC esté genuinamente por debajo del límite legal.'},
  ans:2
},
{
  id:586, cat:'parking',
  en:{q:'What does a white curb indicate?',opts:['No parking at any time','Parking for government officials only','Stopping only to pick up or drop off passengers — usually limited to a few minutes','Handicapped parking only'],exp:'A white curb means you may stop only briefly to load or unload passengers. You typically cannot park and leave your vehicle at a white curb. White curbs are usually found in front of hotels, airports, transit stops, and other places where passengers need to be quickly dropped off or picked up. Some white curbs also allow for postal vehicle stops. Always check posted signs near white curbs for specific time limits and any passenger load/unload restrictions.'},
  zh:{q:'白色路缘代表什么？',opts:['任何时候禁止停车','仅供政府官员停车','仅短暂停车接送乘客——通常限于几分钟','仅供残疾人停车'],exp:'白色路缘意味着您只能短暂停车接送乘客。通常不能在白色路缘处停车离开。白色路缘通常在酒店、机场、公交站和其他需要快速上下车的地方。一些白色路缘也允许邮政车辆停靠。请始终检查白色路缘附近张贴的标志，了解具体的时间限制和任何乘客上下车限制。'},
  zhTW:{q:'白色路緣代表什麼？',opts:['任何時候禁止停車','僅供政府官員停車','僅短暫停車接送乘客——通常限於幾分鐘','僅供殘疾人停車'],exp:'白色路緣意味著您只能短暫停車接送乘客。通常不能在白色路緣處停車離開。白色路緣通常在酒店、機場、公交站和其他需要快速上下車的地方。一些白色路緣也允許郵政車輛停靠。請始終檢查白色路緣附近張貼的標誌，了解具體的時間限制和任何乘客上下車限制。'},
  es:{q:'¿Qué indica un bordillo blanco?',opts:['No estacionar en ningún momento','Estacionamiento solo para funcionarios del gobierno','Detenerse solo para recoger o dejar pasajeros — generalmente limitado a unos pocos minutos','Solo estacionamiento para discapacitados'],exp:'Un bordillo blanco significa que solo puede detenerse brevemente para cargar o descargar pasajeros. Normalmente no puede estacionar y dejar su vehículo en un bordillo blanco. Los bordillos blancos generalmente se encuentran frente a hoteles, aeropuertos, paradas de tránsito y otros lugares donde los pasajeros necesitan ser recogidos o dejados rápidamente.'},
  ans:2
},
{
  id:587, cat:'highway',
  en:{q:'What does a broken (dashed) yellow center line on a two-lane road mean?',opts:['No passing is allowed in either direction','Passing is allowed when it is safe to do so','You may cross the line to turn left only','The road is under construction'],exp:'A broken (dashed) yellow center line on a two-lane two-way road means passing is permitted when it is safe. You may cross the dashed yellow line to pass a slower vehicle when the road ahead is clear, you can see far enough ahead, and you can complete the pass safely. A solid yellow line on your side means you may not pass. Two solid yellow lines mean passing is not allowed in either direction. Always check for oncoming traffic, road conditions, and signs before passing.'},
  zh:{q:'双车道道路上断裂（虚线）黄色中心线意味着什么？',opts:['两个方向都禁止超车','在安全的情况下允许超车','只能越过此线左转','道路正在施工'],exp:'双车道双向道路上的断裂（虚线）黄色中心线意味着在安全的情况下允许超车。当前方道路畅通、您能看到足够远且能安全完成超车时，您可以越过虚线黄线超越较慢的车辆。您一侧的实黄线意味着不得超车。两条实黄线意味着两个方向都禁止超车。超车前始终检查对向交通、道路状况和标志。'},
  zhTW:{q:'雙車道道路上斷裂（虛線）黃色中心線意味著什麼？',opts:['兩個方向都禁止超車','在安全的情況下允許超車','只能越過此線左轉','道路正在施工'],exp:'雙車道雙向道路上的斷裂（虛線）黃色中心線意味著在安全的情況下允許超車。當前方道路暢通、您能看到足夠遠且能安全完成超車時，您可以越過虛線黃線超越較慢的車輛。您一側的實黃線意味著不得超車。兩條實黃線意味著兩個方向都禁止超車。超車前始終檢查對向交通、道路狀況和標誌。'},
  es:{q:'¿Qué significa una línea central amarilla discontinua (punteada) en una carretera de dos carriles?',opts:['No se permite adelantar en ninguna dirección','Se permite adelantar cuando es seguro hacerlo','Solo puede cruzar la línea para girar a la izquierda','La carretera está en construcción'],exp:'Una línea central amarilla discontinua (punteada) en una carretera de dos carriles y dos sentidos significa que se permite adelantar cuando es seguro. Puede cruzar la línea amarilla discontinua para adelantar a un vehículo más lento cuando la carretera adelante está despejada, puede ver lo suficientemente lejos y puede completar el adelantamiento de forma segura. Una línea amarilla sólida en su lado significa que no puede adelantar.'},
  ans:1
},
{
  id:588, cat:'safety',
  en:{q:'At what distance must you dim your high beams when following another vehicle?',opts:['100 feet','200 feet','300 feet','500 feet'],exp:'You must dim your high beams to low beams when you are following another vehicle within 300 feet. High beams in a driver\'s rear-view mirror can blind and distract the driver ahead, causing a dangerous loss of control. You must also dim your high beams when an oncoming vehicle is within 500 feet. Using high beams improperly is dangerous and illegal. Remember: 300 feet when following, 500 feet for oncoming traffic.'},
  zh:{q:'跟随另一辆车时，您必须在多远处关闭远光灯？',opts:['100英尺','200英尺','300英尺','500英尺'],exp:'跟随另一辆车300英尺以内时，您必须将远光灯切换为近光灯。后视镜中的远光灯可能使前面的驾驶员目眩和分心，导致危险的失控。当对向车辆在500英尺以内时，您也必须关闭远光灯。不当使用远光灯是危险且违法的。记住：跟随时300英尺，对向交通时500英尺。'},
  zhTW:{q:'跟隨另一輛車時，您必須在多遠處關閉遠光燈？',opts:['100英尺','200英尺','300英尺','500英尺'],exp:'跟隨另一輛車300英尺以內時，您必須將遠光燈切換為近光燈。後視鏡中的遠光燈可能使前面的駕駛員目眩和分心，導致危險的失控。當對向車輛在500英尺以內時，您也必須關閉遠光燈。不當使用遠光燈是危險且違法的。記住：跟隨時300英尺，對向交通時500英尺。'},
  es:{q:'¿A qué distancia debe bajar sus luces altas cuando sigue a otro vehículo?',opts:['100 pies','200 pies','300 pies','500 pies'],exp:'Debe bajar sus luces altas a luces bajas cuando está siguiendo a otro vehículo a menos de 300 pies. Las luces altas en el espejo retrovisor de un conductor pueden cegar y distraer al conductor de adelante, causando una pérdida peligrosa de control. También debe bajar sus luces altas cuando un vehículo que viene en sentido contrario está a menos de 500 pies. Recuerde: 300 pies al seguir, 500 pies para el tráfico que viene.'},
  ans:2
},
{
  id:589, cat:'laws',
  en:{q:'What is the "Move Over" law in California?',opts:['A law requiring slower vehicles to keep right','A law requiring drivers to change lanes or slow down when passing stationary emergency or service vehicles on the roadside','A law requiring motorcycles to stay in the center of the lane','A law about merging protocols on freeways'],exp:'California\'s Move Over law requires drivers approaching stationary emergency vehicles, tow trucks, or Caltrans vehicles with lights flashing to change lanes away from the vehicle (if safely possible) OR slow down below the speed limit and proceed with caution. This law protects first responders, tow operators, and road workers who are vulnerable when working on the roadside. Violating the Move Over law can result in significant fines and is considered a serious traffic violation.'},
  zh:{q:'加州的"让行"法是什么？',opts:['要求较慢车辆靠右行驶的法律','要求驾驶员在路边经过静止的紧急或服务车辆时变道或减速的法律','要求摩托车保持在车道中央的法律','关于高速公路合并协议的法律'],exp:'加州的让行法要求驾驶员在接近路边有闪烁灯光的静止紧急车辆、拖车或Caltrans车辆时，（在安全可能的情况下）变道远离该车辆，或减速至低于限速并谨慎通过。这项法律保护在路边工作时容易受到伤害的急救人员、拖车操作员和道路工人。违反让行法可能导致巨额罚款，被视为严重交通违规。'},
  zhTW:{q:'加州的「讓行」法是什麼？',opts:['要求較慢車輛靠右行駛的法律','要求駕駛員在路邊經過靜止的緊急或服務車輛時變道或減速的法律','要求摩托車保持在車道中央的法律','關於高速公路合並協議的法律'],exp:'加州的讓行法要求駕駛員在接近路邊有閃爍燈光的靜止緊急車輛、拖車或Caltrans車輛時，（在安全可能的情況下）變道遠離該車輛，或減速至低於限速並謹慎通過。這項法律保護在路邊工作時容易受到傷害的急救人員、拖車操作員和道路工人。違反讓行法可能導致巨額罰款，被視為嚴重交通違規。'},
  es:{q:'¿Cuál es la ley de "Ceder el Paso" en California?',opts:['Una ley que requiere que los vehículos más lentos se mantengan a la derecha','Una ley que requiere que los conductores cambien de carril o reduzcan la velocidad al pasar vehículos de emergencia o servicio estacionarios en el borde de la carretera','Una ley que requiere que las motocicletas permanezcan en el centro del carril','Una ley sobre los protocolos de fusión en las autopistas'],exp:'La ley de Ceder el Paso de California requiere que los conductores que se acercan a vehículos de emergencia, camiones de remolque o vehículos de Caltrans estacionarios con luces intermitentes cambien de carril alejándose del vehículo (si es posible con seguridad) O reduzcan la velocidad por debajo del límite de velocidad y procedan con precaución.'},
  ans:1
},
{
  id:590, cat:'signs',
  en:{q:'What does a sign showing a car with wavy lines beneath it (skidding car) warn about?',opts:['Road construction and rough pavement ahead','Slippery road when wet — reduce speed in wet conditions','Sharp curves ahead requiring reduced speed','Soft shoulder — do not drive off the pavement'],exp:'A sign showing a car with wavy lines beneath it (or a skidding car symbol) warns of a slippery road when wet. This is a caution sign placed where the road surface becomes particularly slippery during rain — often on bridges, metal surfaces, newly paved roads, or roads with painted markings. Drivers should reduce speed, increase following distance, avoid sudden braking or steering inputs, and be prepared for reduced traction in wet weather in these areas.'},
  zh:{q:'显示车辆下方有波浪线的标志（打滑汽车）警告什么？',opts:['前方道路施工和路面崎岖','潮湿时道路湿滑——潮湿条件下减速','前方急转弯需要减速','松软路肩——不要驶离铺装路面'],exp:'显示车辆下方有波浪线的标志（或打滑汽车符号）警告雨天道路湿滑。这是一个放置在雨天道路表面特别湿滑处的警告标志——通常在桥梁、金属表面、新铺沥青道路或有油漆标记的道路上。驾驶员应该减速，增加跟车距离，避免突然刹车或转向，并在这些区域雨天准备好应对牵引力下降。'},
  zhTW:{q:'顯示車輛下方有波浪線的標誌（打滑汽車）警告什麼？',opts:['前方道路施工和路面崎嶇','潮濕時道路濕滑——潮濕條件下減速','前方急轉彎需要減速','鬆軟路肩——不要駛離鋪裝路面'],exp:'顯示車輛下方有波浪線的標誌（或打滑汽車符號）警告雨天道路濕滑。這是一個放置在雨天道路表面特別濕滑處的警告標誌——通常在橋梁、金屬表面、新鋪瀝青道路或有油漆標記的道路上。駕駛員應該減速，增加跟車距離，避免突然刹車或轉向，並在這些區域雨天準備好應對牽引力下降。'},
